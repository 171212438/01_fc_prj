 ...
 */
#define ADC_UNIT_NUM_CHANNELS               {32U, 32U, 32U, 16U}
 ...
 *
 */
#define ADC_USED_SARADC_UNITS               4U
 ...
 */
#define ADC_PTIMER_NUM_MODULES              3U
 ...
 */
#define PTIMER_BASE_ADDRS                   {PTIMER0_BASE, PTIMER1_BASE, PTIMER2_BASE}
 ...
 */
#define ADC_TMU_SUPPORT_TF                  (STD_OFF)

/**
 * @brief         Whether TMU supports startup counter
 */
#define ADC_TMU_SUPPORT_START_CNT           (STD_OFF)
 ...
 *
 */
#define ADC_SEQUENCE_INJECTION_SUPPORT      (STD_ON)
 ...
 *
 */
#define ADC_ECMP_SUPPORT                    (STD_ON)

/**
 * @brief         Whether the ADC Units have Fast Compare configurations
 *
 */
#define ADC_FCMP_SUPPORT                    (STD_ON)
...
#define AdcConf_AdcChannel_AdcChannel_Adc3V11    0
