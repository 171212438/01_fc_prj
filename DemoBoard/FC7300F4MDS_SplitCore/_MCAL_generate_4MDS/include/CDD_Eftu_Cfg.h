...
#define EFTU_TBU_USED

#define EFTU_GTOM_MUX_USED


#define EFTU_TOM_USED

/* EFTU Reg features*/
#define EFTU_CCM_DMA_REQ_COUNT              (16u)
#define EFTU_CCM_DMA_REQ_REG_COUNT          (8u)
#define EFTU_CCM_CNT_OUTPUT_SUPPORT         (STD_ON)
#define EFTU_CCM_RESn_LOCK_COUNT            (14u)
#define EFTU_CCM_HRPWM_MUX_SUPPORT          (STD_OFF)
