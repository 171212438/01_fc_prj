 ...
 *
 */
#define ADC_GROUPS_ECUCPARTITION_0       (3U)
/**
 * @brief          Total number of groups in partition EcucPartition_1.
 *
 */
#define ADC_GROUPS_ECUCPARTITION_1       (3U)
 ...
 *
 */
#define ADC_SARADC_UNITS_ECUCPARTITION_1     (2U)
...
{
    /**< @brief Hardware Unit ADC0  --  ADC_SE15 */
    {
    ...
    /**< @brief Hardware Unit ADC0  --  ADC_SE14 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(14U),
        /**< @brief Adc channel resolution */
