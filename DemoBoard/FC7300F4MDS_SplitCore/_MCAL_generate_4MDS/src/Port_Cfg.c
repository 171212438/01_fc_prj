...
PORT_DATA_SECTION const uint8 kPortPinsDescription[MAX_PORT_PIN_NUM_U16] =
{
        ...
        /* PTA15 */
        (uint8)( (1 <<  PORT15_ADC1_SE18) | \
        (1 <<  PORT15_GPIO) | \
        (1 <<  PORT15_FCSPI4_PCS2) | \
        ...
        /* PTA17 */
        (uint8)( (1 <<  PORT17_ADC2_SE18) | \
        (1 <<  PORT17_GPIO) | \
        (1 <<  PORT17_FTU5_CH5) | \
        (1 <<  PORT17_FTU_FLT15) | \
        (1 <<  PORT17_FCSPI1_PCS2) | \
        (1 <<  PORT17_FLEXCAN4_TX) | \
        (1 <<  PORT17_FCUART5_RTS) | \
        (1 <<  PORT17_eFTU_GTOM5) ),

        /* PTA18 */
        (uint8)( (1 <<  PORT18_ADC1_SE5_ADC1_DIFF_N1) | \
        (1 <<  PORT18_GPIO) | \
        (1 <<  PORT18_FTU3_CH6) | \
        (1 <<  PORT18_FCUART1_TX) | \
        (1 <<  PORT18_FLEXCAN4_TX) | \
        (1 <<  PORT18_eFTU_GTOM12) ),

        /* PTA19 */
        (uint8)( (1 <<  PORT19_ADC1_SE1_ADC1_DIFF_P1) | \
        (1 <<  PORT19_GPIO) | \
        (1 <<  PORT19_FCUART1_RX) | \
        (1 <<  PORT19_FLEXCAN4_RX) | \
        (1 <<  PORT19_eFTU_GTOM15) ),

        /* PTA20 */
        (uint8)( (1 <<  PORT20_ADC1_SE4_ADC1_DIFF_N0) | \
        (1 <<  PORT20_GPIO) | \
        (1 <<  PORT20_FTU3_CH7) | \
        ...
        (1 <<  PORT23_SSI0_DIG_28_CH2) ),

        /* PTA24 */
        (uint8)( (1 <<  PORT24_ADC0_SE15) | \
        (1 <<  PORT24_GPIO) | \
        (1 <<  PORT24_FTU4_CH0) | \
        (1 <<  PORT24_FCUART3_TX) | \
        ...
        (1 <<  PORT24_SSI0_DIG_14_CH2) ),

        /* PTA25 */
        (uint8)( (1 <<  PORT25_ADC0_SE11) | \
        (1 <<  PORT25_GPIO) | \
        (1 <<  PORT25_FTU4_CH3) | \
        (1 <<  PORT25_SSI0_DIG_14_CH1) | \
        (1 <<  PORT25_FCSPI2_SOUT) | \
        (1 <<  PORT25_ETM_TRACE_D11) | \
        (1 <<  PORT25_eFTU0_OUT_S7) ),

        /* PTA26 */
        (uint8)( (1 <<  PORT26_ADC0_SE7_ADC0_DIFF_N3) | \
        (1 <<  PORT26_GPIO) | \
        (1 <<  PORT26_FTU2_CH2) | \
        ...
        (1 <<  PORT28_FTU5_CH5) | \
        (1 <<  PORT28_FCUART0_RX) | \
        (1 <<  PORT28_ETM_TRACE_D4) | \
        (1 <<  PORT28_FCSPI1_SCK) | \
        (1 <<  PORT28_eFTU0_OUT_S8) | \
        ...
        (1 <<  PORT29_GPIO) | \
        (1 <<  PORT29_FTU5_CH4) | \
        (1 <<  PORT29_FCUART4_RTS) | \
        (1 <<  PORT29_ETM_TRACE_D5) | \
        (1 <<  PORT29_FCSPI1_SIN) | \
        (1 <<  PORT29_eFTU0_OUT_S9) | \
        ...
        (1 <<  PORT31_eFTU0_BLDC0_HALLC) ),

        /* PTB0 */
        (uint8)( (1 <<  PORT32_ADC2_SE7_ADC2_DIFF_N3) | \
        (1 <<  PORT32_GPIO) | \
        ...
        /* PTB1 */
        (uint8)( (1 <<  PORT33_ADC2_SE1_ADC2_DIFF_P1) | \
        (1 <<  PORT33_GPIO) | \
        (1 <<  PORT33_FTU_TCK0) | \
        ...
        (1 <<  PORT35_FTU3_CH7) | \
        (1 <<  PORT35_eFTU0_OUT_S15) ),

        /* PTB4 */
        (uint8)( (1 <<  PORT36_GPIO) | \
        (1 <<  PORT36_FCSPI0_SCK) | \
        (1 <<  PORT36_FTU_FLT4) | \
        (1 <<  PORT36_eFTU0_BLDC1_HALLB) | \
        (1 <<  PORT36_FTU4_CH5) | \
        (1 <<  PORT36_eFTU0_OUT_S2) | \
        (1 <<  PORT36_FCUART3_RTS) ),

        /* PTB5 */
        (uint8)( (1 <<  PORT37_GPIO) | \
        (1 <<  PORT37_FCIIC1_SDA) | \
        (1 <<  PORT37_eFTU0_BLDC0_PWM4) | \
        (1 <<  PORT37_FTU4_CH4) | \
        (1 <<  PORT37_eFTU0_OUT_S1) | \
        (1 <<  PORT37_FCUART3_CTS) ),
        ...
        (1 <<  PORT43_GPIO) | \
        (1 <<  PORT43_eFTU_GTOM0) | \
        (1 <<  PORT43_FCUART7_CTS) ),

        /* PTB12 */
        (uint8)( (1 <<  PORT44_GPIO) | \
        (1 <<  PORT44_SENT0_RXD0) | \
        (1 <<  PORT44_FLEXCAN2_RX) | \
        (1 <<  PORT44_eFTU0_BLDC0_PWM2) | \
        (1 <<  PORT44_eFTU0_OUT_S4) ),

        /* PTB13 */
        (uint8)( (1 <<  PORT45_ADC2_SE23) | \
        (1 <<  PORT45_GPIO) | \
        (1 <<  PORT45_FTU3_CH2) | \
        (1 <<  PORT45_TCR_CLK) | \
        (1 <<  PORT45_FTU5_CH7) | \
        ...
        /* PTB14 */
        (uint8)( (1 <<  PORT46_ADC2_SE22) | \
        (1 <<  PORT46_GPIO) | \
        (1 <<  PORT46_FTU3_CH1) | \
        (1 <<  PORT46_FCUART4_RX) | \
        (1 <<  PORT46_eFTU0_BLDC0_HALLB) | \
        (1 <<  PORT46_FTU5_CH3) | \
        (1 <<  PORT46_eFTU0_OUT_S2) ),

        /* PTB15 */
        (uint8)( (1 <<  PORT47_ADC2_SE21) | \
        (1 <<  PORT47_GPIO) | \
        (1 <<  PORT47_FTU3_CH0) | \
        (1 <<  PORT47_FCUART4_TX) | \
        (1 <<  PORT47_eFTU0_BLDC0_PWM1) | \
        (1 <<  PORT47_FTU5_CH2) | \
        (1 <<  PORT47_eFTU0_OUT_S1) ),

        /* PTB16 */
        (uint8)( (1 <<  PORT48_ADC2_SE20) | \
        (1 <<  PORT48_GPIO) | \
        (1 <<  PORT48_FTU5_CH7) | \
        (1 <<  PORT48_FCUART5_CTS) | \
        (1 <<  PORT48_eFTU0_BLDC0_PWM0) | \
        (1 <<  PORT48_eFTU0_OUT_S0) ),

        /* PTB17 */
        (uint8)( (1 <<  PORT49_ADC2_SE19) | \
        (1 <<  PORT49_GPIO) | \
        (1 <<  PORT49_FTU5_CH6) | \
        (1 <<  PORT49_FTU0_CH1) | \
        (1 <<  PORT49_FCSPI1_PCS3) | \
        (1 <<  PORT49_FLEXCAN4_RX) | \
        (1 <<  PORT49_FCUART5_CTS) | \
        (1 <<  PORT49_eFTU_GTOM10) ),
        ...
        (1 <<  PORT51_eFTU0_BLDC0_PWM3) ),

        /* PTB20 */
        (uint8)( (1 <<  PORT52_ADC3_SE0_ADC3_DIFF_P0) | \
        (1 <<  PORT52_GPIO) | \
        (1 <<  PORT52_FTU1_CH0) | \
        (1 <<  PORT52_FCUART1_TX) | \
        (1 <<  PORT52_FCSPI5_SCK) | \
        (1 <<  PORT52_SSI0_DIG_28_CH0) | \
        (1 <<  PORT52_eFTU_GTOM13) | \
        (1 <<  PORT52_SCG_CLKOUT) ),

        /* PTB21 */
        (uint8)( (1 <<  PORT53_ADC3_SE4_ADC3_DIFF_N0) | \
        (1 <<  PORT53_GPIO) | \
        (1 <<  PORT53_FTU1_CH1) | \
        (1 <<  PORT53_FCUART1_RX) | \
        (1 <<  PORT53_FCSPI5_SIN) | \
        (1 <<  PORT53_SSI0_DIG_14_CH0) | \
        (1 <<  PORT53_eFTU_GTOM14) | \
        (1 <<  PORT53_RTC_CLKOUT) ),
        ...
        (1 <<  PORT54_eFTU0_BLDC1_HALLA) | \
        (1 <<  PORT54_FCSPI3_PCS2) ),

        /* PTB23 */
        (uint8)( (1 <<  PORT55_ADC3_SE33) | \
        (1 <<  PORT55_GPIO) | \
        (1 <<  PORT55_FTU_FLT9) | \
        (1 <<  PORT55_FCSPI2_PCS0) | \
        (1 <<  PORT55_eFTU0_BLDC1_PWM0) | \
        (1 <<  PORT55_FTU2_CH6) | \
        (1 <<  PORT55_TRGSEL_OUT3) | \
        (1 <<  PORT55_eFTU0_OUT_S14) ),

        /* PTB24 */
        (uint8)( (1 <<  PORT56_ADC3_SE1_ADC3_DIFF_P1) | \
        (1 <<  PORT56_GPIO) | \
        (1 <<  PORT56_FTU1_CH2) | \
        (1 <<  PORT56_FCSPI5_SOUT) | \
        (1 <<  PORT56_eFTU0_OUT_S24) | \
        (1 <<  PORT56_eFTU0_BLDC1_PWM2) ),
        ...
        (1 <<  PORT57_FTU3_CH6) | \
        (1 <<  PORT57_eFTU0_OUT_S14) ),

        /* PTB26 */
        (uint8)( (1 <<  PORT58_GPIO) | \
        (1 <<  PORT58_eFTU0_BLDC1_HALLC) | \
        (1 <<  PORT58_FTU_FLT5) | \
        (1 <<  PORT58_eFTU0_IN5) | \
        (1 <<  PORT58_FTU1_CH6) | \
        ...
        (1 <<  PORT60_FTU1_CH5) | \
        (1 <<  PORT60_eFTU0_OUT_S23) ),

        /* PTB29 */
        (uint8)( (1 <<  PORT61_ADC3_SE5_ADC3_DIFF_N1) | \
        (1 <<  PORT61_GPIO) | \
        (1 <<  PORT61_FTU1_CH3) | \
        (1 <<  PORT61_eFTU0_IN0) | \
        (1 <<  PORT61_SSI0_DIG_14_CH0) | \
        (1 <<  PORT61_eFTU0_OUT_S27) | \
        (1 <<  PORT61_eFTU0_BLDC1_PWM3) | \
        (1 <<  PORT61_MSC0_FCLP) ),
        ...
        /* PTB31 */
        (uint8)( (1 <<  PORT63_ADC3_SE24) | \
        (1 <<  PORT63_GPIO) | \
        (1 <<  PORT63_SSI0_DIG_28_CH1) | \
        (1 <<  PORT63_FCSPI2_SCK) | \
        (1 <<  PORT63_eFTU0_IN5) | \
        (1 <<  PORT63_FTU1_CH3) | \
        ...
        (1 <<  PORT64_SSI0_DIG_28_CH3) | \
        (1 <<  PORT64_eFTU0_OUT_S8) | \
        (1 <<  PORT64_FCSPI3_PCS1) ),

        /* PTC1 */
        (uint8)( (1 <<  PORT65_GPIO) | \
        (1 <<  PORT65_SSI0_DIG_14_CH3) | \
        (1 <<  PORT65_eFTU0_IN3) | \
        (1 <<  PORT65_eFTU0_OUT_S5) | \
        (1 <<  PORT65_FTU4_CH7) | \
        (1 <<  PORT65_eFTU_GTOM14) | \
        ...
        /* PTC11 */
        (uint8)( (1 <<  PORT75_ADC2_SE6_ADC2_DIFF_N2) | \
        (1 <<  PORT75_GPIO) | \
        (1 <<  PORT75_FTU3_CH3) | \
        (1 <<  PORT75_eFTU0_IN7) | \
        (1 <<  PORT75_FLEXCAN4_TX) | \
        (1 <<  PORT75_eFTU0_OUT_S20) | \
        (1 <<  PORT75_FCSPI4_SOUT) | \
        (1 <<  PORT75_MSC0_EN0) ),

        /* PTC12 */
        (uint8)( (1 <<  PORT76_ADC3_SE6_ADC3_DIFF_N2) | \
        (1 <<  PORT76_GPIO) | \
        (1 <<  PORT76_FTU1_CH5) | \
        (1 <<  PORT76_eFTU0_IN2) | \
        ...
        /* PTC13 */
        (uint8)( (1 <<  PORT77_ADC3_SE2_ADC3_DIFF_P2) | \
        (1 <<  PORT77_GPIO) | \
        (1 <<  PORT77_FTU1_CH4) | \
        (1 <<  PORT77_eFTU0_IN1) | \
        ...
        (1 <<  PORT79_SCG_CLKOUT) | \
        (1 <<  PORT79_SSI0_DIG_28_CH3) | \
        (1 <<  PORT79_eFTU0_IN4) | \
        (1 <<  PORT79_FCSPI3_PCS3) ),

        /* PTC16 */
        (uint8)( (1 <<  PORT80_ADC3_SE16) | \
        (1 <<  PORT80_GPIO) | \
        (1 <<  PORT80_FTU_FLT7) | \
        (1 <<  PORT80_FCSPI2_SOUT) | \
        (1 <<  PORT80_TRGSEL_OUT7) | \
        (1 <<  PORT80_SSI0_DIG_14_CH2) | \
        (1 <<  PORT80_eFTU0_OUT_S11) | \
        (1 <<  PORT80_FCUART5_RX) ),

        /* PTC17 */
        (uint8)( (1 <<  PORT81_ADC3_SE8) | \
        (1 <<  PORT81_GPIO) | \
        (1 <<  PORT81_FTU_FLT6) | \
        (1 <<  PORT81_FTU0_CH2) | \
        (1 <<  PORT81_TRGSEL_OUT6) | \
        (1 <<  PORT81_SSI0_DIG_28_CH2) | \
        (1 <<  PORT81_eFTU0_OUT_S10) | \
        (1 <<  PORT81_FCUART5_TX) ),

        /* PTC18 */
        (uint8)( (1 <<  PORT82_ADC3_SE32) | \
        (1 <<  PORT82_GPIO) | \
        (1 <<  PORT82_SSI0_DIG_14_CH1) | \
        (1 <<  PORT82_FCSPI2_SIN) | \
        (1 <<  PORT82_eFTU0_IN6) | \
        (1 <<  PORT82_FTU1_CH4) | \
        ...
        /* PTC19 */
        (uint8)( (1 <<  PORT83_ADC3_SE3_ADC3_DIFF_P3) | \
        (1 <<  PORT83_GPIO) | \
        (1 <<  PORT83_FTU1_CH6) | \
        (1 <<  PORT83_eFTU0_IN3) | \
        (1 <<  PORT83_FCSPI5_PCS1) | \
        (1 <<  PORT83_eFTU0_OUT_S7) | \
        (1 <<  PORT83_eFTU_GTOM12) | \
        (1 <<  PORT83_MSC0_EN3) ),

        /* PTC20 */
        (uint8)( (1 <<  PORT84_ADC3_SE7_ADC3_DIFF_N3) | \
        (1 <<  PORT84_GPIO) | \
        (1 <<  PORT84_FTU1_CH7) | \
        (1 <<  PORT84_eFTU0_OUT_S8) | \
        (1 <<  PORT84_FCSPI5_PCS2) | \
        (1 <<  PORT84_eFTU0_BLDC1_PWM4) | \
        (1 <<  PORT84_MSC0_SDI2) ),

        /* PTC21 */
        (uint8)( (1 <<  PORT85_ADC3_SE34) | \
        (1 <<  PORT85_GPIO) | \
        (1 <<  PORT85_FTU3_CH0) | \
        (1 <<  PORT85_eFTU0_OUT_S9) | \
        (1 <<  PORT85_FCSPI5_PCS3) | \
        (1 <<  PORT85_eFTU0_BLDC1_PWM5) | \
        (1 <<  PORT85_MSC0_SDI3) ),

        /* PTC22 */
        (uint8)( (1 <<  PORT86_ADC3_SE35) | \
        (1 <<  PORT86_GPIO) | \
        (1 <<  PORT86_FTU3_CH1) | \
        (1 <<  PORT86_eFTU0_OUT_S16) | \
        (1 <<  PORT86_eFTU0_IN4) | \
        (1 <<  PORT86_ADC3_BFL) | \
        (1 <<  PORT86_FCSPI4_PCS0) | \
        (1 <<  PORT86_MSC0_SDI1) ),

        /* PTC23 */
        (uint8)( (1 <<  PORT87_ADC2_SE0_ADC2_DIFF_P0) | \
        (1 <<  PORT87_GPIO) | \
        (1 <<  PORT87_FTU0_CH0) | \
        (1 <<  PORT87_eFTU0_IN5) | \
        (1 <<  PORT87_FCUART2_RTS) | \
        (1 <<  PORT87_eFTU0_OUT_S18) | \
        (1 <<  PORT87_FTU1_QD_PHB) | \
        (1 <<  PORT87_MSC0_SDI0) ),

        /* PTC24 */
        (uint8)( (1 <<  PORT88_ADC2_SE2_ADC2_DIFF_P2) | \
        (1 <<  PORT88_GPIO) | \
        (1 <<  PORT88_FTU3_CH2) | \
        (1 <<  PORT88_eFTU0_IN6) | \
        ...
        (1 <<  PORT96_GPIO) | \
        (1 <<  PORT96_FTU4_CH2) | \
        (1 <<  PORT96_FCUART4_CTS) | \
        (1 <<  PORT96_eFTU0_OUT_S18) | \
        (1 <<  PORT96_FCUART7_RX) | \
        (1 <<  PORT96_eFTU0_IN6) | \
        ...
        (1 <<  PORT101_FCSPI0_SOUT) | \
        (1 <<  PORT101_FCUART2_CTS) | \
        (1 <<  PORT101_ETM_TRACE_D2) | \
        (1 <<  PORT101_SSI0_DIG_14_CH1) | \
        (1 <<  PORT101_eFTU_GTOM13) | \
        ...
        (1 <<  PORT102_SSI0_DIG_28_CH1) | \
        (1 <<  PORT102_eFTU_GTOM12) | \
        ...
        (1 <<  PORT103_SSI0_DIG_14_CH0) | \
        (1 <<  PORT103_eFTU0_OUT_S7) | \
        (1 <<  PORT103_FCUART3_RX) ),

        /* PTD8 */
        (uint8)( (1 <<  PORT104_GPIO) | \
        (1 <<  PORT104_ETM_TRACE_D5) | \
        (1 <<  PORT104_FCSPI2_PCS2) | \
        (1 <<  PORT104_FTU1_CH6) | \
        (1 <<  PORT104_FTU1_CH0) | \
        (1 <<  PORT104_eFTU_GTOM15) | \
        ...
        (1 <<  PORT105_SSI0_DIG_14_CH3) | \
        (1 <<  PORT105_eFTU0_OUT_S9) | \
        (1 <<  PORT105_FCUART4_TX) ),

        /* PTD10 */
        (uint8)( (1 <<  PORT106_GPIO) | \
        (1 <<  PORT106_FCSPI0_PCS0) | \
        (1 <<  PORT106_FTU2_QD_PHB) | \
        (1 <<  PORT106_FTU2_CH6) | \
        (1 <<  PORT106_FTU1_CH3) | \
        (1 <<  PORT106_FCSPI3_PCS2) | \
        (1 <<  PORT106_eFTU0_OUT_S9) ),

        /* PTD11 */
        (uint8)( (1 <<  PORT107_GPIO) | \
        (1 <<  PORT107_SSI0_DIG_14_CH2) | \
        ...
        (1 <<  PORT108_SSI0_DIG_28_CH2) | \
        (1 <<  PORT108_FCUART2_RTS) | \
        (1 <<  PORT108_ETM_TRACE_D3) | \
        (1 <<  PORT108_FTU1_CH1) | \
        (1 <<  PORT108_eFTU0_OUT_S1) | \
        ...
        (1 <<  PORT115_GPIO) | \
        (1 <<  PORT115_FTU5_CH4) | \
        (1 <<  PORT115_FCUART5_TX) | \
        (1 <<  PORT115_FCIIC1_SCL) | \
        (1 <<  PORT115_eFTU0_BLDC0_HALLC) | \
        ...
        (1 <<  PORT123_SENT1_RXD0) | \
        (1 <<  PORT123_FCUART6_RTS) | \
        (1 <<  PORT123_eFTU0_IN6) | \
        ...
        /* PTE4 */
        (uint8)( (1 <<  PORT132_ADC0_SE3_ADC0_DIFF_P3) | \
        (1 <<  PORT132_GPIO) | \
        (1 <<  PORT132_FTU2_QD_PHB) | \
        (1 <<  PORT132_FTU0_CH1) | \
        (1 <<  PORT132_FCUART7_TX) | \
        (1 <<  PORT132_SENT0_RXD3) | \
        ...
        (1 <<  PORT133_FTU_TCK2) | \
        (1 <<  PORT133_FTU4_CH3) | \
        (1 <<  PORT133_FCUART7_TX) | \
        (1 <<  PORT133_FCSPI2_PCS1) | \
        (1 <<  PORT133_eFTU0_IN5) | \
        (1 <<  PORT133_eFTU0_OUT_S10) ),

        /* PTE6 */
        (uint8)( (1 <<  PORT134_ADC1_SE17) | \
        (1 <<  PORT134_GPIO) | \
        ...
        (1 <<  PORT136_eFTU0_BLDC1_HALLA) | \
        (1 <<  PORT136_eFTU_GTOM8) | \
        (1 <<  PORT136_eFTU0_IN4) | \
        (1 <<  PORT136_FTU2_CH5) | \
        ...
        /* PTE9 */
        (uint8)( (1 <<  PORT137_ADC0_SE22) | \
        (1 <<  PORT137_GPIO) | \
        (1 <<  PORT137_FTU0_CH7) | \
        (1 <<  PORT137_FTU2_CH3) | \
        (1 <<  PORT137_ETM_TRACE_CLKOUT) | \
        (1 <<  PORT137_eFTU0_BLDC0_HALLB) | \
        ...
        (1 <<  PORT138_SSI0_DIG_14_CH0) | \
        (1 <<  PORT138_eFTU0_OUT_S23) | \
        (1 <<  PORT138_FCSPI2_SIN) | \
        (1 <<  PORT138_eFTU0_BLDC0_PWM0) | \
        ...
        (1 <<  PORT139_GPIO) | \
        (1 <<  PORT139_FTU2_CH1) | \
        (1 <<  PORT139_eFTU0_OUT_S22) | \
        (1 <<  PORT139_FCSPI2_PCS0) | \
        (1 <<  PORT139_ETM_TRACE_D8) | \
        ...
        (1 <<  PORT140_eFTU0_IN3) | \
        (1 <<  PORT140_eFTU_GTOM1) ),

        /* PTE13 */
        (uint8)( (1 <<  PORT141_ADC0_SE10) | \
        (1 <<  PORT141_GPIO) | \
        (1 <<  PORT141_FTU2_CH0) | \
        (1 <<  PORT141_SSI0_DIG_28_CH1) | \
        (1 <<  PORT141_eFTU0_OUT_S28) | \
        (1 <<  PORT141_FCSPI2_SCK) | \
        (1 <<  PORT141_ETM_TRACE_D10) | \
        (1 <<  PORT141_eFTU0_BLDC0_PWM1) ),
        ...
        (1 <<  PORT143_FTU2_CH6) | \
        (1 <<  PORT143_SENT0_RXD0) | \
        (1 <<  PORT143_eFTU0_IN2) | \
        (1 <<  PORT143_TRGSEL_OUT6) ),

        /* PTE16 */
        (uint8)( (1 <<  PORT144_ADC1_SE0_ADC1_DIFF_P0) | \
        (1 <<  PORT144_GPIO) | \
        (1 <<  PORT144_FCUART1_RTS) | \
        (1 <<  PORT144_FLEXCAN5_TX) | \
        (1 <<  PORT144_FTU2_CH7) | \
        (1 <<  PORT144_FCUART7_TX) | \
        (1 <<  PORT144_eFTU_GTOM4) | \
        ...
        (1 <<  PORT145_FTU_FLT20) | \
        (1 <<  PORT145_FCUART4_TX) | \
        (1 <<  PORT145_eFTU_GTOM9) ),

        /* PTE18 */
        (uint8)( (1 <<  PORT146_ADC1_SE19) | \
        (1 <<  PORT146_GPIO) | \
        (1 <<  PORT146_FCSPI4_PCS3) | \
        ...
        /* PTE27 */
        (uint8)( (1 <<  PORT155_ADC1_SE8) | \
        (1 <<  PORT155_GPIO) | \
        (1 <<  PORT155_FTU3_CH5) | \
        (1 <<  PORT155_RTC_CLKOUT) | \
        ...
        (1 <<  PORT162_eFTU0_IN4) | \
        (1 <<  PORT162_eFTU0_BLDC0_PWM3) | \
        (1 <<  PORT162_eFTU0_OUT_S28) ),

        /* PTF3 */
        (uint8)( (1 <<  PORT163_GPIO) | \
        ...
        /* PTF9 */
        (uint8)( (1 <<  PORT169_GPIO) | \
        (1 <<  PORT169_FTU0_CH3) | \
        (1 <<  PORT169_SSI0_DIG_28_CH0) | \
        (1 <<  PORT169_eFTU0_OUT_S25) ),

        (uint8)0x00,

        /* PTF11 */
        (uint8)( (1 <<  PORT171_GPIO) | \
        (1 <<  PORT171_FTU0_CH5) | \
        (1 <<  PORT171_MSC0_SDI2) | \
        (1 <<  PORT171_SSI0_DIG_28_CH1) | \
        (1 <<  PORT171_eFTU_GTOM15) ),

        /* PTF12 */
        (uint8)( (1 <<  PORT172_GPIO) | \
        (1 <<  PORT172_eFTU0_BLDC1_HALLA) | \
        (1 <<  PORT172_FTU1_CH3) | \
        (1 <<  PORT172_FCSPI2_PCS1) | \
        (1 <<  PORT172_FCUART5_RX) | \
        (1 <<  PORT172_FTU0_CH6) ),

        /* PTF13 */
        (uint8)( (1 <<  PORT173_GPIO) | \
        (1 <<  PORT173_MSC0_FCLP) | \
        (1 <<  PORT173_FTU1_CH2) | \
        (1 <<  PORT173_FCSPI2_PCS2) | \
        (1 <<  PORT173_eFTU_GTOM9) | \
        (1 <<  PORT173_eFTU0_BLDC1_HALLC) | \
        (1 <<  PORT173_FTU0_CH5) ),

        /* PTF14 */
        (uint8)( (1 <<  PORT174_GPIO) | \
        (1 <<  PORT174_eFTU0_BLDC1_HALLB) | \
        ...
        /* PTF24 */
        (uint8)( (1 <<  PORT184_GPIO) | \
        (1 <<  PORT184_FTU4_CH6) | \
        (1 <<  PORT184_SSI0_DIG_14_CH2) | \
        ...
        (1 <<  PORT200_SSI0_DIG_28_CH1) | \
        (1 <<  PORT200_eFTU_GTOM10) ),

        /* PTG9 */
        (uint8)( (1 <<  PORT201_GPIO) | \
        (1 <<  PORT201_FTU0_CH6) | \
        (1 <<  PORT201_MSC0_SDI3) | \
        (1 <<  PORT201_SSI0_DIG_14_CH1) | \
        (1 <<  PORT201_eFTU_GTOM0) ),

        /* PTG10 */
        (uint8)( (1 <<  PORT202_GPIO) | \
        (1 <<  PORT202_SSI0_DIG_28_CH2) | \
        (1 <<  PORT202_FTU0_CH7) | \
        (1 <<  PORT202_MSC0_SDI3) | \
        ...
        /* PTG11 */
        (uint8)( (1 <<  PORT203_GPIO) | \
        (1 <<  PORT203_SSI0_DIG_14_CH2) | \
        ...
        /* PTI1 */
        (uint8)( (1 <<  PORT257_DISABLED) | \
        (1 <<  PORT257_GPIO) | \
        (1 <<  PORT257_FCUART7_CTS) | \
        (1 <<  PORT257_eFTU_GTOM4) ),

        /* PTI2 */
        (uint8)( (1 <<  PORT258_GPIO) | \
        ...
        /* PTI13 */
        (uint8)( (1 <<  PORT269_GPIO) | \
        (1 <<  PORT269_FTU0_CH4) | \
        (1 <<  PORT269_eFTU0_OUT_S17) | \
        (1 <<  PORT269_SSI0_DIG_28_CH3) | \
        (1 <<  PORT269_MSC0_EN1) | \
        (1 <<  PORT269_eFTU_GTOM1) ),
        ...
        (1 <<  PORT276_FTU_TCK2) | \
        (1 <<  PORT276_FTU_FLT20) | \
        (1 <<  PORT276_eFTU0_OUT_S2) ),

        /* PTI21 */
        (uint8)( (1 <<  PORT277_GPIO) | \
        (1 <<  PORT277_FTU4_CH5) | \
        (1 <<  PORT277_SSI0_DIG_28_CH3) | \
        (1 <<  PORT277_ETM_TRACE_D14) | \
        (1 <<  PORT277_FCSPI2_PCS2) | \
        (1 <<  PORT277_eFTU0_OUT_S3) ),

        /* PTI22 */
        (uint8)( (1 <<  PORT278_GPIO) | \
        (1 <<  PORT278_FTU4_CH4) | \
        (1 <<  PORT278_SSI0_DIG_14_CH3) | \
        (1 <<  PORT278_ETM_TRACE_D15) | \
        (1 <<  PORT278_eFTU0_OUT_S4) ),

        /* PTI23 */
        (uint8)( (1 <<  PORT279_GPIO) | \
        (1 <<  PORT279_FTU4_CH7) | \
        (1 <<  PORT279_SSI0_DIG_28_CH2) | \
        (1 <<  PORT279_eFTU0_IN0) | \
