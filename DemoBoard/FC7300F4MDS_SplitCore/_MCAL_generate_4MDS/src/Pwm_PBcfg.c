...
PWM_DATA_SECTION static const Pwm_Ftu_ModuleConfigType Pwm_FtuConfigModules[PWM_NUM_CONF_FTU_MODULES] =
{
    ...
    /* Ftu Module 1 */
    {
        ...
        (FTU_SC_CLKS(3) | FTU_SC_PS(0) | FTU_SC_CHNOUTEN( ((uint32)1U << (uint32)7U )| ((uint32)1U << (uint32)6U )| ((uint32)1U << (uint32)5U )| ((uint32)1U << (uint32)4U )| ((uint32)1U << (uint32)3U )| ((uint32)1U << (uint32)2U )| ((uint32)1U << (uint32)1U )| ((uint32)1U << (uint32)0U )| ((uint32)0)) | ((uint32)0)),
...
PWM_DATA_SECTION static const Pwm_ChannelType Pwm_FtuHw2LogicChannelMap[PWM_FTU_CHANNELS_NO] =
{
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 2U, 0xFF,
...
{
    0xFF, 0U, 1U, 0xFF, 0xFF, 0xFF, 0U, 1U
};
/**
...
{
    0U, 2U, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 1U, 3U
};
 ...
 *
 */
PWM_DATA_SECTION static const Pwm_Eftu_ConfigType Pwm_EftuChannelConfiguration[4] =
{
    {
 ...
 *
 */
PWM_DATA_SECTION const Pwm_Eftu_TomGlobal_ConfigType Pwm_EftuTomGlobalConfiguration[2] =
{
