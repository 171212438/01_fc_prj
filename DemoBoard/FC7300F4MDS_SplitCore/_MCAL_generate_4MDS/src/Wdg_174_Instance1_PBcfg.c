...
WDG_DATA_SECTION static const Wdg_LLDConfigType Wdg_Wdog_OffModeSettings_Instance1=
{
...
WDG_DATA_SECTION static const Wdg_LLDConfigType Wdg_Wdog_SlowModeSettings_1=
{
...
WDG_DATA_SECTION static const Wdg_LLDConfigType Wdg_Wdog_FastModeSettings_1=
{
    (uint32)( WDOG_CS_ENABLE_MASK | WDOG_CS_DLY_CNT_MSB(WDOG_REACTION_INT_128_CYCLE) | WDOG_CS_CLK_SEL(WDOG_FOSC_CLK) | WDOG_CS_TST(WDOG_TST_DISABLED) | WDOG_CS_PRESCALER_MASK | WDOG_CS_UPDATE_MASK ), /* WDG Control and configuration */
...
/* Reason: The object 'Wdg_Config_WDOG1' will be referenced in other modules and declared where it is used */
WDG_DATA_SECTION const Wdg_ConfigType Wdg_Config_WDOG1 =
{
    WDGIF_SLOW_MODE,
    WDG_HWL_INSTANCE1,
#if (WDG_DIRECT_SERVICE == STD_OFF)
    (Gpt_ChannelType)GptConf_GptChannelConfiguration_GptChannel_WDGInstance1,
    (uint32)750000,
#endif
    { &Wdg_Wdog_OffModeSettings_Instance1, &Wdg_Wdog_SlowModeSettings_1, &Wdg_Wdog_FastModeSettings_1},
