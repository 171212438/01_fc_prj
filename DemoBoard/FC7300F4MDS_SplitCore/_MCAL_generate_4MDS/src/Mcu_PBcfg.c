...
MCU_DATA_SECTION static const SCG_ClockType SCG_ClockConfig0 =
{
    ...
    /* PLL0 Configuration */
    {TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, SCG_PLLPSTDIV1_BY8, FALSE, FALSE, FALSE, SCG_PLL0_MULT_MUX_SEL_TYPICAL,SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY4, 11U, 299U, SCG_PLLSOURCE_FOSC,SCG_PLLPSTDIV_BY2,NULL_PTR}, 
    /* SOSC Configuration */
...
MCU_DATA_SECTION static const PCC_CLKCtrlType PCC_Config0[42U] =
{
    ...
    {(uint32)0x374, (uint32)0x10800000}, /* TRGSEL4 */
    {(uint32)0x378, (uint32)0x10800000}, /* TRGSEL5 */
    {(uint32)0x37C, (uint32)0x10800000}, /* TRGSEL6 */
    {(uint32)0x380, (uint32)0x10800000}, /* TRGSEL7 */
    {(uint32)0x384, (uint32)0x10800000}, /* TRGSEL8 */
    {(uint32)0xEC, (uint32)0x10900000}, /* ADC0 */
    {(uint32)0xF0, (uint32)0x10900000}, /* ADC1 */
    {(uint32)0x318, (uint32)0x10900000}, /* ADC2 */
    {(uint32)0x31C, (uint32)0x10900000}, /* ADC3 */
    {(uint32)0xDC, (uint32)0x10800000}, /* PTIMER0 */
    {(uint32)0xE0, (uint32)0x10800000}, /* PTIMER1 */
    {(uint32)0x308, (uint32)0x10800000}, /* PTIMER2 */
    {(uint32)0x10C, (uint32)0x10800000}, /* TMU0 */
    {(uint32)0x1A8, (uint32)0x10900000}, /* FCUART2 */
    {(uint32)0x428, (uint32)0x10900000}, /* FCUART6 */
    {(uint32)0x3F4, (uint32)0x10900000}, /* FTU4 */
    {(uint32)0x178, (uint32)0x10900000}, /* FTU2 */
    {(uint32)0x3F8, (uint32)0x10900000}, /* FTU5 */
    {(uint32)0x450, (uint32)0x10900003}, /* MSC0 */
    {(uint32)0x20, (uint32)0x10800000}, /* DMA0 */
    {(uint32)0x28, (uint32)0x10800000}, /* DMA_MUX0 */
    {(uint32)0x170, (uint32)0x10800000}, /* FTU0 */
    {(uint32)0x174, (uint32)0x10800000}, /* FTU1 */
    {(uint32)0x17C, (uint32)0x10800000}, /* FTU3 */
    {(uint32)0x190, (uint32)0x10900000}, /* FCSPI2 */
    ...
    {(uint32)0x220, (uint32)0x20900000}, /* FLEXCAN2 */
    {(uint32)0x480, (uint32)0x20900000}, /* FLEXCAN3 */
    {(uint32)0xA8, (uint32)0x10800000}, /* CRC0 */
    {(uint32)0x458, (uint32)0x10800000}, /* EFTU0 */
...
{
    (uint8)42U,          /* Count of PCC peripheral */
