...
#define STCU_SRAM_INI_SEL_SRAM2                     (1 << 2)
#define STCU_SRAM_INI_SEL_ITCM_CPU0                 (1 << 3)
#define STCU_SRAM_INI_SEL_DTCM_CPU0                 (1 << 4)
#define STCU_SRAM_INI_SEL_ITCM_CPU1                 (1 << 5)
#define STCU_SRAM_INI_SEL_DTCM_CPU1                 (1 << 6)


#define STCU_SRAM_INI_SEL_ALL                                     \
  (STCU_SRAM_INI_SEL_SRAM0      | STCU_SRAM_INI_SEL_SRAM1      |  \
   STCU_SRAM_INI_SEL_SRAM2      | STCU_SRAM_INI_SEL_ITCM_CPU0  |  \
   STCU_SRAM_INI_SEL_DTCM_CPU0  | STCU_SRAM_INI_SEL_ITCM_CPU1  |  \
   STCU_SRAM_INI_SEL_DTCM_CPU1)
...
__attribute__((noreturn)) void system_init(void)
{
    ...
    if (0U == u32CoreId)
    {
        /* disable MAM/CPU0/1/ ECC */
        REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET, 0x0AAAAA8A);
        REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET, 0x0000A92A);
        ...
        /* enable MAM/CPU0/1/ ECC after every reset */
        REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET, 0x0FFFFFCF);
        REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET, 0x0000FD3F);
