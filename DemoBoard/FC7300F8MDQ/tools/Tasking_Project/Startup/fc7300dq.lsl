...
#define __SRAM0_SIZE   256k

#define __SRAM1_START  0x21040000
#define __SRAM1_SIZE   256k

#define __SRAM2_START  0x21080000
#define __SRAM2_SIZE   384k

// AMP:
// 2000_0000 -> 2001_FFFF, CPU0
// 2000_0000 -> 2001_FFFF, CPU1
// 2000_0000 -> 2001_FFFF, CPU2/non-split
// 2000_0000 -> 2000_FFFF, CPU2/split
// 2000_0000 -> 2000_FFFF, CPU3/split
// SMP:
// 2000_0000 -> 2001_FFFF, CPU0
// 2002_0000 -> 2003_FFFF, CPU1
// 2004_0000 -> 2005_FFFF, CPU2/non-split
// 2004_0000 -> 2004_FFFF, CPU2/split
// 2006_0000 -> 2006_FFFF, CPU3/split
#define __DTCM_START  0x20000000
#define __DTCM_SIZE   512k

// AMP: 
// 0000_0000 -> 0000_FFFF, CPU0; 
// 0000_0000 -> 0000_FFFF, CPU1; 
// 0000_0000 -> 0000_FFFF, CPU2/non-split; 
// 0000_0000 -> 0000_7FFF, CPU2/split; 
// 0000_0000 -> 0000_7FFF, CPU3/split
// SMP: 
// 0000_0000 -> 0000_FFFF, CPU0; 
// 0001_0000 -> 0001_FFFF, CPU1; 
// 0002_0000 -> 0002_FFFF, CPU2/non-split; 
// 0002_0000 -> 0002_7FFF, CPU2/split; 
// 0003_0000 -> 0003_7FFF, CPU3/split
...
section_setup :cm7_0:linear
{
                                ...
                                )
    {
            ...
            vector ( id = 51, optional, fill = "PMC_IRQHandler");                              //  PMC Low voltage detect interrupt
            ...
            vector ( id = 61, optional, fill = "WDOG3_IRQHandler");                                 //  interrupt request out before wdg reset out
            ...
            vector ( id = 89, optional, fill = "TSTMP4_IRQHandler");                                 //  TimerStamp4 interrupt
            ...
            vector ( id = 100, optional, fill = "Can_IsrCAN0_All");                                 //  CAN0 Interrupt
            vector ( id = 101, optional, fill = "Can_IsrCAN1_All");                                 //  CAN1 Interrupt
            vector ( id = 102, optional, fill = "Can_IsrCAN2_All");                                 //  CAN2 Interrupt
            vector ( id = 103, optional, fill = "Can_IsrCAN3_All");                                 //  CAN3 Interrupt
            vector ( id = 104, optional, fill = "Can_IsrCAN4_All");                                 //  CAN4 Interrupt
            vector ( id = 105, optional, fill = "Can_IsrCAN5_All");                                 //  CAN5 Interrupt
            vector ( id = 106, optional, fill = "Can_IsrCAN6_All");                                 //  CAN6 Interrupt
            vector ( id = 107, optional, fill = "Can_IsrCAN7_All");                                 //  CAN7 Interrupt
            ...
            vector ( id = 130, optional, fill = "Can_IsrCAN12_All");                        //  CAN12 Interrupt
            vector ( id = 131, optional, fill = "Can_IsrCAN13_All");                        //  CAN13 Interrupt
            ...
            vector ( id = 140, optional, fill = "HSADC0_IRQHandler");                                 //  HSADC0 interrupt request
            vector ( id = 141, optional, fill = "HSADC1_IRQHandler");                                 //  HSADC1 interrupt request
            vector ( id = 142, optional, fill = "HSADC2_IRQHandler");                                //  HSADC2 interrupt request
            vector ( id = 143, optional, fill = "HSADC3_IRQHandler");                                //  HSADC3 interrupt request
            vector ( id = 144, optional, fill = "CMP0_IRQHandler");                                 //  CMP0 interrupt request 
            vector ( id = 146, optional, fill = "ADC4_IRQHandler");                                 //  ADC4 interrupt request 
            ...
            vector ( id = 155, optional, fill = "ADC5_IRQHandler");                                //  ADC5 interrupt request
            vector ( id = 156, optional, fill = "MSC0_IRQHandler");                                 //  MSC interrupt
            vector ( id = 157, optional, fill = "MSC1_IRQHandler");                                 //  MSC interrupt
            vector ( id = 158, optional, fill = "Can_IsrCAN8_All");                                 //  CAN8 Interrupt
            vector ( id = 159, optional, fill = "Can_IsrCAN9_All");                                 //  CAN9 Interrupt
            ...
            vector ( id = 164, optional, fill = "Can_IsrCAN10_All");                        //  CAN10 Interrupt
            vector ( id = 165, optional, fill = "Can_IsrCAN11_All");                        //  CAN11 Interrupt
            ...
            vector ( id = 170, optional, fill = "CTI3_IRQHandler");                                 //  CTI Interrupt
            vector ( id = 171, optional, fill = "SSI_IRQHandler");                                 //  SSI0 Interrupt ORed interrupt
            vector ( id = 172, optional, fill = "SDADC0_0_IRQHandler");                                 //  SDADC0 channel 0 Interrupt
            vector ( id = 173, optional, fill = "SDADC0_1_IRQHandler");                                 //  SDADC0 channel 1 Interrupt
            vector ( id = 174, optional, fill = "SDADC0_2_IRQHandler");                                 //  SDADC0 channel 2 Interrupt
            vector ( id = 175, optional, fill = "SDADC1_0_IRQHandler");                                 //  SDADC1 channel 0 Interrupt
            vector ( id = 176, optional, fill = "SDADC1_1_IRQHandler");                                 //  SDADC1 channel 1 Interrupt
            vector ( id = 177, optional, fill = "SDADC1_2_IRQHandler");                                 //  SDADC1 channel 2 Interrupt
            vector ( id = 178, optional, fill = "EFTU0_Error_IRQHandler");                                 //  eFTU0 Error Interrupt
            vector ( id = 179, optional, fill = "EFTU1_Error_IRQHandler");                                 //  eFTU1 Error Interrupt
            vector ( id = 180, optional, fill = "EFTU2_Error_IRQHandler");                                 //  eFTU2 Error Interrupt
            vector ( id = 181, optional, fill = "EFTU0_TIM_0_3_IRQHandler");                                 //  eFTU0 TIM 0-3 source Interrupt
            vector ( id = 182, optional, fill = "EFTU1_TIM_0_3_IRQHandler");                                 //  eFTU1 TIM 0-3 source Interrupt
            vector ( id = 183, optional, fill = "EFTU2_TIM_0_3_IRQHandler");                                 //  eFTU2 TIM 0-3 source Interrupt
            vector ( id = 184, optional, fill = "EFTU0_TIM_4_7_IRQHandler");                                 //  eFTU0 TIM 4-7 source Interrupt
            vector ( id = 185, optional, fill = "EFTU1_TIM_4_7_IRQHandler");                                 //  eFTU1 TIM 4-7 source Interrupt
            vector ( id = 186, optional, fill = "EFTU2_TIM_4_7_IRQHandler");                                 //  eFTU2 TIM 4-7 source Interrupt
            vector ( id = 187, optional, fill = "EFTU0_TOM_0_7_IRQHandler");                                 //  eFTU0 TOM 0-7 source Interrupt
            vector ( id = 188, optional, fill = "EFTU1_TOM_0_7_IRQHandler");                                 //  eFTU1 TOM 0-7 source Interrupt
            vector ( id = 189, optional, fill = "EFTU2_TOM_0_7_IRQHandler");                                 //  eFTU2 TOM 0-7 source Interrupt
            vector ( id = 190, optional, fill = "EFTU0_TOM_8_15_IRQHandler");                                 //  eFTU0 TOM 8-15 source Interrupt
            vector ( id = 191, optional, fill = "EFTU1_TOM_8_15_IRQHandler");                                 //  eFTU1 TOM 8-15 source Interrupt
            vector ( id = 192, optional, fill = "EFTU2_TOM_8_15_IRQHandler");                                 //  eFTU2 TOM 8-15 source Interrupt
            vector ( id = 193, optional, fill = "CAN0_Error_IRQHandler");                                 //  CAN0 error Interrupt
            vector ( id = 194, optional, fill = "CAN1_Error_IRQHandler");                                 //  CAN1 error Interrupt
            vector ( id = 195, optional, fill = "CAN2_Error_IRQHandler");                                 //  CAN2 error Interrupt
            vector ( id = 196, optional, fill = "CAN3_Error_IRQHandler");                                 //  CAN3 error Interrupt
            vector ( id = 197, optional, fill = "CAN4_Error_IRQHandler");                                 //  CAN4 error Interrupt
            vector ( id = 198, optional, fill = "CAN5_Error_IRQHandler");                                 //  CAN5 error Interrupt
            vector ( id = 199, optional, fill = "CAN6_Error_IRQHandler");                                 //  CAN6 error Interrupt
            vector ( id = 200, optional, fill = "CAN7_Error_IRQHandler");                                 //  CAN7 error Interrupt
            vector ( id = 201, optional, fill = "CAN8_Error_IRQHandler");                                 //  CAN8 error Interrupt
            vector ( id = 202, optional, fill = "CAN9_Error_IRQHandler");                                 //  CAN9 error Interrupt
            vector ( id = 203, optional, fill = "CAN10_Error_IRQHandler");                                 //  CAN10 error Interrupt
            vector ( id = 204, optional, fill = "CAN11_Error_IRQHandler");                                 //  CAN11 error Interrupt
            vector ( id = 205, optional, fill = "CAN12_Error_IRQHandler");                                 //  CAN12 error Interrupt
            vector ( id = 206, optional, fill = "CAN13_Error_IRQHandler");                                 //  CAN13 error Interrupt
            vector ( id = 207, optional, fill = "QDT0_IRQHandler");                                 //  QDT0 Interrupt
            vector ( id = 208, optional, fill = "QDT1_IRQHandler");                                 //  QDT1 Interrupt
            vector ( id = 209, optional, fill = "QDT2_IRQHandler");                                 //  QDT2 Interrupt
            vector ( id = 210, optional, fill = "QDT3_IRQHandler");                                 //  QDT3 Interrupt
            vector ( id = 211, optional, fill = "LU0_IRQHandler");                                 //  LU0 Interrupt
            vector ( id = 212, optional, fill = "LU1_IRQHandler");                                 //  LU1 Interrupt
            vector ( id = 213, optional, fill = "TPU0_CH0_7_IRQHandler");                                 //  TPU0 CH0-7 interrupt
            vector ( id = 214, optional, fill = "TPU0_CH8_15_IRQHandler");                                 //  TPU0 CH8-15 interrupt
            vector ( id = 215, optional, fill = "TPU0_CH16_23_IRQHandler");                                 //  TPU0 CH16-23 interrupt
            vector ( id = 216, optional, fill = "TPU0_CH24_31_IRQHandler");                                 //  TPU0 CH24-31 interrupt
            vector ( id = 217, optional, fill = "HSM0_CRYPTO_IRQHandler");                                 //  HSM crypto interrupt
    }
}
