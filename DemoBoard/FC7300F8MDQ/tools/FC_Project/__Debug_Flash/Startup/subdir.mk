...
S_UPPER_SRCS += \
../Startup/startup_FC7300.S 

OBJS += \
./Startup/startup_FC7300.o \
...
Startup/%.o: ../Startup/%.S Startup/subdir.mk
	...
	arm-none-eabi-gcc -mcpu=cortex-m7 -mthumb -mfloat-abi=soft -mfpu=fpv5-sp-d16 -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wunused -Wuninitialized -Wall -Wextra -Wpointer-arith -Wshadow -Wlogical-op -Waggregate-return -Wfloat-equal -Wno-unused-parameter -Wno-unused-function -Wno-unused-variable -Wformat=0  -g3 -x assembler-with-cpp -DDEBUG -DSTART_FROM_FLASH -DAUTOSAR_OS_NOT_USED -D_LINARO_C_FCxx_ -c -o "$@" "$<"
