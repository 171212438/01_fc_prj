...
for %%F in (../../../../MCAL/Src/Qdt/include/*.h)                   do ECHO ..\..\..\..\MCAL\Src\Qdt\include\%%F >> _SubProjects\%Project_Name%.gpj
for %%F in (../../../../MCAL/Src/Qdt/src/*.c)                       do ECHO ..\..\..\..\MCAL\Src\Qdt\src\%%F >> _SubProjects\%Project_Name%.gpj
