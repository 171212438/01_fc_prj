...
#define SCM_CPUVTOR_CPU_INIT_VECTOR(x) (((uint32)(((uint32)(x)) << SCM_CPUVTOR_CPU_INIT_VECTOR_SHIFT)) & SCM_CPUVTOR_CPU_INIT_VECTOR_MASK)
...
#define RGM_C1_RST_C1_OUT_OF_RST(x)    (((uint32)(((uint32)(x)) << RGM_C1_RST_C1_OUT_OF_RST_SHIFT)) & RGM_C1_RST_C1_OUT_OF_RST_MASK)
#define RGM_C1_RST_C1_SWRST_MASK       0x1u
#define RGM_C1_RST_C1_SWRST_SHIFT      0u
#define RGM_C1_RST_C1_SWRST_WIDTH      1u
#define RGM_C1_RST_C1_SWRST(x)         (((uint32)(((uint32)(x)) << RGM_C1_RST_C1_SWRST_SHIFT)) & RGM_C1_RST_C1_SWRST_MASK)
/* C2_RST Bit Fields */
...
#define RGM_C2_RST_C2_OUT_OF_RST(x)    (((uint32)(((uint32)(x)) << RGM_C2_RST_C2_OUT_OF_RST_SHIFT)) & RGM_C2_RST_C2_OUT_OF_RST_MASK)
#define RGM_C2_RST_C2_SWRST_MASK       0x1u
#define RGM_C2_RST_C2_SWRST_SHIFT      0u
#define RGM_C2_RST_C2_SWRST_WIDTH      1u
#define RGM_C2_RST_C2_SWRST(x)         (((uint32)(((uint32)(x)) << RGM_C2_RST_C2_SWRST_SHIFT)) & RGM_C2_RST_C2_SWRST_MASK)
