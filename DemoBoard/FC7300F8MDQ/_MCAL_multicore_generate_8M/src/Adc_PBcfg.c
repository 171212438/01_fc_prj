 ...
 *
 */
#define ADC_GROUPS_ECUCPARTITION_0       (2U)
 ...
 *
 */
#define ADC_SARADC_UNITS_ECUCPARTITION_0     (0U)
/**
 * @brief          Total number of HSADC units in partition EcucPartition_0.
 *
 */
#define ADC_HSADC_UNITS_ECUCPARTITION_0      (2U)
...
/**
 * @brief          Group 0 Assignments on ADC Hardware unit HSADC2.
 *
 */
...
/**
 * @brief          Group 1 Assignments on ADC Hardware unit HSADC0.
 *
 */
ADC_DATA_SECTION static const Adc_ChannelType Adc_Group1_Assignment_1[ADC_CFGSET_GROUP_1_CHANNELS] =
{
    0U,
    1U
};
 ...
 * @details        Array of Adc channels defined on HSADC2
 */
ADC_DATA_SECTION static const Adc_ChannelConfigurationType Adc_ChannelsCfg_HSADC2[] =
{
    /**< @brief Hardware Unit HSADC2  --  HSADC_SE2 */
    {
    ...
    /**< @brief Hardware Unit HSADC2  --  HSADC_SE3 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(3U),
        /**< @brief Adc channel resolution */
...
{
    /**< @brief Hardware Unit HSADC0  --  HSADC_SE2 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(2U),
        /**< @brief Adc channel resolution */
    ...
    /**< @brief Hardware Unit HSADC0  --  HSADC_SE3 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(3U),
        /**< @brief Adc channel resolution */
...
/**
 * @brief          Definition of ADC groups in HSADC2
 */
ADC_DATA_SECTION static const Adc_GroupType Adc_HwGroupsCfg_0[] =
{
    0
};

/**
 * @brief          Definition of ADC groups in HSADC0
 */
ADC_DATA_SECTION static const Adc_GroupType Adc_HwGroupsCfg_1[] =
{
    1
};
...
{
    /**< @brief Group0 -- Hardware Unit HSADC2 */
    {
        /**< @brief Adc group id */
        (Adc_GroupType)0,
        /**< @brief Hardware unit logical Id */
    ...
    /**< @brief Group1 -- Hardware Unit HSADC0 */
    {
        /**< @brief Adc group id */
        (Adc_GroupType)1,
        /**< @brief Hardware unit logical Id */
...
{
    /* ADC0 is not used in partition EcucPartition_0 */
    ADC_UNIT_INVALID,
    /* ADC1 is not used in partition EcucPartition_0 */
    ADC_UNIT_INVALID,
...
{
    /* HSADC0 parameters are defined at Adc_HwUnitCfg[1] */
    1U,
    /* HSADC1 is not used in partition EcucPartition_0 */
    ADC_UNIT_INVALID,
    /* HSADC2 parameters are defined at Adc_HwUnitCfg[0] */
    0U,
