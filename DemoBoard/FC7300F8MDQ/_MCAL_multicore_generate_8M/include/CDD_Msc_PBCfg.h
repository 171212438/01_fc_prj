 ...
 * @brief   Switches the Development Error Detection and Notification ON or OFF.
 */
#define MSC_MULTICORE_SUPPORT (STD_ON)
 ...
 * @details
 */
#define MSC_DISABLE_DEM_REPORT_ERROR_STATUS (STD_OFF)
/**
...
#define MSC_E_TIMEOUT_VALUE DemConf_DemEventParameter_DemEventParameter_MscTimeout
#endif /* MSC_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF */

#define MSC_POLLING_USED (STD_OFF)
#define MSC_0_ISR_USED
#define MSC_1_ISR_USED
