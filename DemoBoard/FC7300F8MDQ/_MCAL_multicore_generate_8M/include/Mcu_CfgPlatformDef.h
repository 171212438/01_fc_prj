 ...
 */
#define MCU_CFG_SCG_SLEEP_WDG_SUPPORT (STD_OFF)
 ...
 */
#define MCU_CFG_SCG_PLL_CLK1_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_SMC_CORELP_SUPPORT (STD_ON)

/**
 * @brief    SMC Init API Support
 */
#define MCU_CFG_SMC_INIT_API_SUPPORT (STD_ON)

/**
 * @brief    SMC Power Good Support
 */
#define MCU_CFG_SMC_LP_GOOD_SUPPORT (STD_ON)

/**
 * @brief    SMC CMP0 LpWakeup Support
 */
#define MCU_CFG_SMC_CMP0_LPWAKEUP_SUPPORT (STD_ON)

/**
 * @brief    SMC ADC2 LpWakeup Support
 */
#define MCU_CFG_SMC_ADC2_LPWAKEUP_SUPPORT (STD_ON)

/**
 * @brief    SMC SRAM2 Retention Mode Support
 */
#define MCU_CFG_SMC_SRAM2_RENTENTION_MODE_SUPPORT (STD_ON)

/********************** CMU Related Defines **********************/
/**
 * @brief    CMU LP Support
 */
#define MCU_CFG_CMU_LP_SUPPORT (STD_OFF)
 ...
 */
#define MCU_CFG_CSC0_WAKEUP_PAD_SUPPORT (STD_OFF)

/**
 * @brief    CSC0 Init API Support
 */
#define MCU_CFG_CSC0_INIT_API_SUPPORT (STD_OFF)
 ...
 */
#define MCU_CFG_CSC0_REG_7300GT_SUPPORT (STD_ON)

/**
 * @brief    CSC0 register 7240 Support
 */
#define MCU_CFG_CSC0_REG_7240_SUPPORT (STD_OFF)

/********************** SCM Related Defines **********************/
/**
 * @brief    SCM FC7300GT Support
 */
#define MCU_CFG_SCM_7300GT_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_SCM_SUBSYSTEM_SUPPORT (STD_OFF)

/**
 * @brief    SCM HSADC Bias Force enable Support
 */
#define MCU_CFG_SCM_HSADC_BIAS_FORCE_SUPPORT (STD_ON)

/********************** PCC Related Defines **********************/
/**
 * @brief    PCC DWP Support
 */
#define MCU_CFG_PCC_DWP_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_RGM_MULTICORE_SUPPORT (STD_ON)

/**
 * @brief    RGM Core3 Support
 */
#define MCU_CFG_RGM_C3_SUPPORT (STD_ON)

/**
 * @brief    RGM pin and watchdog reset interrupt Support
 */
#define MCU_CFG_RGM_PIN_WDG1_RESET_INT_SUPPORT (STD_OFF)

/**
 * @brief    RGM pin reset interrupt Support
 */
#define MCU_CFG_RGM_PIN_RESET_INT_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_WKU_REG_7300GT_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_WKU_REG_7240_SUPPORT (STD_OFF)
 ...
 */
#define MCU_CFG_PMC_REG_7300GT_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_PMC_REG_7240_SUPPORT (STD_OFF)
