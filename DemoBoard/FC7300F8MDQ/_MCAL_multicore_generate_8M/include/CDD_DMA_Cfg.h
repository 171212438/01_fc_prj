...
*/
#define DMA_MAX_CORE_USED_U8                     (4U)
...
#define DMA_0_CHANNEL2_ERROR_IRQ     STD_ON

#define DMA_0_CHANNEL3_USED    STD_ON

#define DMA_0_CHANNEL3_IRQ     STD_ON

#define DMA_0_CHANNEL3_ERROR_IRQ     STD_ON
...
#define DMA_MASTERCORE_INSTANCE1   (2U)

#define DMA_SLAVECORE_INSTANCE1    (3U)


/**
* @brief define the max partition numbers
*/
#define DMA_ECUC_PARTITIONS_MAX     (4U)
