...
#define CDD_PWM_WAVE_DTM_SHUTOFF_CONFIG_BYTE                                   \
  (EFTU_DTM_CTRL2_SHUTOFF_SEL_0(4U) | EFTU_DTM_CTRL2_UPD_MODE_0(3U))
#define CDD_PWM_WAVE_DTM_SHUTOFF_WRITE_BYTE                                    \
  (CDD_PWM_WAVE_DTM_SHUTOFF_CONFIG_BYTE | EFTU_DTM_CTRL2_WR_EN_0(1U))
...
#define CDD_PWM_WAVE_DTM_RUNTIME_CTRL_MASK                                    \
  (EFTU_DTM_CTRL_CLK_SEL_MASK | EFTU_DTM_CTRL_DTM_SEL_MASK |                  \
   EFTU_DTM_CTRL_UPD_MODE_MASK |                                               \
   EFTU_DTM_CTRL_CH_SHUTOFF_EN_MASK | EFTU_DTM_CTRL_SR_UPD_EN_MASK)
#define CDD_PWM_WAVE_DTM_RUNTIME_CTRL                                         \
  (EFTU_DTM_CTRL_CH_SHUTOFF_EN(1U))
#define CDD_PWM_WAVE_REG32(u32Address)                                        \
  (*((volatile uint32 *)(u32Address)))
...
#define CDD_PWM_WAVE_CH3_7_ENABLE_COMMAND                                        \
  (EFTU_TOM_TGC_ENDIS_CTRL_ENDIS_CTRL3(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_CTRL_ENDIS_CTRL4(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_CTRL_ENDIS_CTRL5(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_CTRL_ENDIS_CTRL6(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_CTRL_ENDIS_CTRL7(2U))
...
#define CDD_PWM_WAVE_OUT3_7_ENABLE_COMMAND                                       \
  (EFTU_TOM_TGC_OUTEN_CTRL_OUTEN_CTRL3(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_CTRL_OUTEN_CTRL4(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_CTRL_OUTEN_CTRL5(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_CTRL_OUTEN_CTRL6(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_CTRL_OUTEN_CTRL7(2U))
...
#define CDD_PWM_WAVE_CH3_7_IMMEDIATE_ENABLE                                      \
  (EFTU_TOM_TGC_ENDIS_STAT_ENDIS_STAT3(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_STAT_ENDIS_STAT4(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_STAT_ENDIS_STAT5(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_STAT_ENDIS_STAT6(2U) |                                    \
   EFTU_TOM_TGC_ENDIS_STAT_ENDIS_STAT7(2U))
...
#define CDD_PWM_WAVE_OUT3_7_IMMEDIATE_ENABLE                                     \
  (EFTU_TOM_TGC_OUTEN_STAT_OUTEN_STAT3(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_STAT_OUTEN_STAT4(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_STAT_OUTEN_STAT5(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_STAT_OUTEN_STAT6(2U) |                                    \
   EFTU_TOM_TGC_OUTEN_STAT_OUTEN_STAT7(2U))
...
_Static_assert(CDD_PWM_WAVE_CH3_7_ENABLE_COMMAND == 0x0000AA80U,
               "Unexpected CH3-CH7 enable encoding");
_Static_assert(CDD_PWM_WAVE_DTM_SHUTOFF_CONFIG_BYTE == 0x34U,
               "Unexpected DTM AUX0 asynchronous-release encoding");
_Static_assert(CDD_PWM_WAVE_DTM_SHUTOFF_WRITE_BYTE == 0xB4U,
               "Unexpected DTM CTRL2 write-enable encoding");
_Static_assert(TRGSEL0_TARGET_LU0_INPUT0A == 0U,
               "Unexpected LU0 run-request target encoding");
_Static_assert(TRGSEL0_TARGET_TRGSEL0_OUTPUT2 == 18U,
               "Unexpected TRGSEL0 OUT2 target encoding");
_Static_assert(TRGSEL2_TARGET_eFTU1_FLT0 == 82U,
               "Unexpected eFTU1 FLT0 target encoding");
_Static_assert(TRGSEL0_SRC_eFTU1_TOM0 == 106U,
               "Unexpected eFTU1 TOM0 source encoding");
_Static_assert(TRGSEL0_SRC_LU0_OUT0B == 48U,
               "Unexpected LU0 OUT0B source encoding");
_Static_assert(TRGSEL2_SRC_TRGSEL0_OUT2 == 4U,
               "Unexpected TRGSEL0 OUT2 source encoding");
...
static uint32 Cdd_PwmWave_ReadTrgSelSource(uint32 u32BaseAddress,
                                          uint32 u32LocalOutput)
{
  uint32 u32Register = CDD_PWM_WAVE_REG32(
      u32BaseAddress + (4U * (u32LocalOutput / 4U)));
...
static boolean Cdd_PwmWave_IsLuClockEnabled(void)
{
  ...
  return (((u32PccLu0 & CDD_PWM_WAVE_PCC_CGC_MASK) != 0U) &&
          ((u32PccLu0 & CDD_PWM_WAVE_PCC_SWR_MASK) == 0U))
             ? TRUE
             : FALSE;
}
...
{
  return ((Cdd_PwmWave_ReadTrgSelSource(TRGSEL0_BASEADDR, 1U) ==
           (uint32)TRGSEL0_SRC_eFTU1_TOM0) &&
          (Cdd_PwmWave_ReadTrgSelSource(TRGSEL0_BASEADDR, 18U) ==
           (uint32)TRGSEL0_SRC_LU0_OUT0B) &&
          (Cdd_PwmWave_ReadTrgSelSource(TRGSEL2_BASEADDR, 34U) ==
           (uint32)TRGSEL2_SRC_TRGSEL0_OUT2))
             ? TRUE
             : FALSE;
}
...
{
  TrgSel_SourceType u32Source =
      (TRUE == bRun) ? (TrgSel_SourceType)TRGSEL0_SRC_VDD
                     : (TrgSel_SourceType)TRGSEL0_SRC_VSS;

  TrgSel_ConfigInput(TRGSEL0_TARGET_LU0_INPUT0A, u32Source);
  MCAL_DATA_SYNC_BARRIER();

  return (Cdd_PwmWave_ReadTrgSelSource(TRGSEL0_BASEADDR, 0U) == u32Source)
             ? TRUE
             : FALSE;
}
...
{
  uint32 u32ExpectedSource =
      (TRUE == bRun) ? (uint32)TRGSEL0_SRC_VDD : (uint32)TRGSEL0_SRC_VSS;

  return (Cdd_PwmWave_ReadTrgSelSource(TRGSEL0_BASEADDR, 0U) ==
          u32ExpectedSource)
             ? TRUE
             : FALSE;
}
...
{
  uint32 u32LgCtrl =
      CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_LG_CTRL0_ADDRESS) &
      CDD_PWM_WAVE_LU0_LG_CTRL0_MASK;

  return ((TRUE == Cdd_PwmWave_IsLuClockEnabled()) &&
          (TRUE == Cdd_PwmWave_IsStaticStopRouteValid()) &&
          (CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_CTRL_ADDRESS) == 0U) &&
          (CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_CFG_ADDRESS) == 0U) &&
          (CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_LG_CFG0_ADDRESS) ==
           CDD_PWM_WAVE_LU0_LG_CFG0_DFF) &&
          (CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_LG_FILT0_ADDRESS) == 0U) &&
          ((u32LgCtrl == CDD_PWM_WAVE_LU0_LG_CTRL0_DFF_RUN) ||
           (u32LgCtrl == CDD_PWM_WAVE_LU0_LG_CTRL0_DFF_INIT)))
             ? TRUE
             : FALSE;
}
...
{
  if ((FALSE == Cdd_PwmWave_IsLuClockEnabled()) ||
      (FALSE == Cdd_PwmWave_IsStaticStopRouteValid()) ||
      (FALSE == Cdd_PwmWave_SetRunRequest(FALSE)) ||
      (CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_CTRL_ADDRESS) != 0U) ||
      (CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_CFG_ADDRESS) != 0U)) {
    return FALSE;
  }
  ...
  CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_LG_CFG0_ADDRESS) =
      CDD_PWM_WAVE_LU0_LG_CFG0_DFF;
  CDD_PWM_WAVE_REG32(CDD_PWM_WAVE_LU0_LG_CTRL0_ADDRESS) =
      CDD_PWM_WAVE_LU0_LG_CTRL0_DFF_INIT;
  MCAL_DATA_SYNC_BARRIER();

  return ((TRUE == Cdd_PwmWave_IsRunRequestSelected(FALSE)) &&
          (TRUE == Cdd_PwmWave_IsLuStopSynchronizerConfigValid()))
             ? TRUE
             : FALSE;
}
...
static void Cdd_PwmWave_ConfigureDtmShutoff(void)
{
   ...
   */
  EFTU1_DTM0->CH_CTRL2_SR =
      (EFTU1_DTM0->CH_CTRL2_SR & (~CDD_PWM_WAVE_DTM0_CH3_BYTE_MASK)) |
      CDD_PWM_WAVE_DTM0_CH3_ALL_LOW;
...
static boolean Cdd_PwmWave_IsDtmShutoffConfigValid(void)
{
  ...
  if (((EFTU1_DTM0->CTRL & CDD_PWM_WAVE_DTM_RUNTIME_CTRL_MASK) !=
       CDD_PWM_WAVE_DTM_RUNTIME_CTRL) ||
      ((EFTU1_DTM1->CTRL & CDD_PWM_WAVE_DTM_RUNTIME_CTRL_MASK) !=
       CDD_PWM_WAVE_DTM_RUNTIME_CTRL) ||
      ((EFTU1_DTM0->CTRL2 & 0x7F000000U) !=
       CDD_PWM_WAVE_DTM0_CTRL2_CONFIG) ||
      ((EFTU1_DTM1->CTRL2 & 0x7F7F7F7FU) !=
       CDD_PWM_WAVE_DTM1_CTRL2_CONFIG) ||
      ((EFTU1_DTM0->CH_CTRL2_SR & CDD_PWM_WAVE_DTM0_CH3_BYTE_MASK) !=
       CDD_PWM_WAVE_DTM0_CH3_ALL_LOW) ||
      (EFTU1_DTM1->CH_CTRL2_SR != CDD_PWM_WAVE_DTM_ALL_LOW) ||
      (EFTU1_DTM0->CH_CTRL2 != s_u32Dtm0RunCtrl2) ||
      (EFTU1_DTM1->CH_CTRL2 != s_u32DtmRunCtrl2) ||
      (EFTU1_DTM0->CH_CTRL1 != 0U) || (EFTU1_DTM0->CH_CTRL3 != 0U) ||
  ...
  for (u8Index = 0U; u8Index < CDD_PWM_WAVE_WINDOW_COUNT; u8Index++) {
    if ((EFTU1_DTM1->CHn_DTV[u8Index] &
         (EFTU_DTM_CHn_DTV_RELRISE_MASK |
          EFTU_DTM_CHn_DTV_RELFALL_MASK)) != CDD_PWM_WAVE_DTM_EXPECTED_DTV) {
      return FALSE;
    }
  }
...
{
  return (((EFTU1_DTM0->CH_CTRL2_SR & CDD_PWM_WAVE_DTM0_CH3_BYTE_MASK) ==
           CDD_PWM_WAVE_DTM0_CH3_ALL_LOW) &&
          ((EFTU1_DTM0->CH_CTRL2 & CDD_PWM_WAVE_DTM0_CH3_BYTE_MASK) ==
           CDD_PWM_WAVE_DTM0_CH3_ALL_LOW) &&
          (EFTU1_DTM1->CH_CTRL2_SR == CDD_PWM_WAVE_DTM_ALL_LOW) &&
...
static boolean Cdd_PwmWave_IsInitialDtmConfigValid(uint32 u32Dtm0RunCtrl2,
...
static boolean Cdd_PwmWave_IsHardwareConfigValid(uint32 u32Dtm0RunCtrl2,
                                                 uint32 u32Dtm1RunCtrl2)
{
  return ((TRUE == Cdd_PwmWave_IsTomTopologyValid()) &&
          (TRUE == Cdd_PwmWave_IsInitialDtmConfigValid(u32Dtm0RunCtrl2,
                                                       u32Dtm1RunCtrl2)))
             ? TRUE
             : FALSE;
}
...
static boolean Cdd_PwmWave_IsRuntimeTopologyValid(boolean bRunRequest)
{
  return ((TRUE == Cdd_PwmWave_IsTomTopologyValid()) &&
          (TRUE == Cdd_PwmWave_IsLuStopSynchronizerConfigValid()) &&
          (TRUE == Cdd_PwmWave_IsDtmShutoffConfigValid()) &&
          (TRUE == Cdd_PwmWave_IsCarrierBoundaryTriggerSelected()) &&
          (TRUE == Cdd_PwmWave_AreAllOutputsEnabled()) &&
          (TRUE == Cdd_PwmWave_IsRunRequestSelected(bRunRequest)))
             ? TRUE
             : FALSE;
}
...
static boolean Cdd_PwmWave_AreTomSafeSignalLevels(void)
{
  ...
  for (u8Channel = CDD_PWM_WAVE_FIRST_OUTPUT_CHANNEL;
       u8Channel <= CDD_PWM_WAVE_LAST_OUTPUT_CHANNEL;
       u8Channel++) {
    if (((EFTU_TOM_1_0->Channel[u8Channel].CH_CTRL &
          EFTU_TOM_CHn_CTRL_SL_MASK) != EFTU_TOM_CHn_CTRL_SL(1U)) ||
        ((EFTU_TOM_1_0->Channel[u8Channel].CH_CTRL_SR &
          EFTU_TOM_CHn_CTRL_SR_SL_SR_MASK) !=
         EFTU_TOM_CHn_CTRL_SR_SL_SR(1U))) {
      return FALSE;
...
{
  return ((((PORTC->PCR[7U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(7U)) &&
           ((PORTC->PCR[23U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(6U)) &&
           ((PORTC->PCR[25U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(7U)) &&
           ((PORTD->PCR[4U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(7U)) &&
           ((PORTD->PCR[21U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(7U)) &&
           ((PORTE->PCR[10U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(6U)) &&
           ((PORTE->PCR[11U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(6U)) &&
           ((PORTE->PCR[13U] & PORT_PCR_MUX_MASK) == PORT_PCR_MUX(6U)) &&
...
{
  return ((((GPIOC->PIDR & CDD_PWM_WAVE_GPIOC_OUTPUT_MASK) == 0U) &&
           ((GPIOD->PIDR & CDD_PWM_WAVE_GPIOD_OUTPUT_MASK) == 0U) &&
           ((GPIOE->PIDR & CDD_PWM_WAVE_GPIOE_OUTPUT_MASK) == 0U) &&
           ((GPIOH->PIDR & CDD_PWM_WAVE_GPIOH_OUTPUT_MASK) == 0U) &&
           ((GPIOC->PDIR & CDD_PWM_WAVE_GPIOC_OUTPUT_MASK) == 0U) &&
           ((GPIOD->PDIR & CDD_PWM_WAVE_GPIOD_OUTPUT_MASK) == 0U) &&
           ((GPIOE->PDIR & CDD_PWM_WAVE_GPIOE_OUTPUT_MASK) == 0U) &&
           ((GPIOH->PDIR & CDD_PWM_WAVE_GPIOH_OUTPUT_MASK) == 0U)))
              ? TRUE
              : FALSE;
}
...
static uint8 Cdd_PwmWave_GetDtmOutputActivityMask(void)
{
  ...
  if (((u32GpioE & 0x00000800U) != 0U) ||
      ((u32GpioC & 0x00800000U) != 0U)) { /* CH5: PTE11/S5, PTC23/S21 */
    u8ActivityMask |= 0x02U;
  }
  if (((u32GpioE & 0x00000400U) != 0U) ||
      ((u32GpioD & 0x00200000U) != 0U)) { /* CH6: PTE10/S6, PTD21/S22 */
    u8ActivityMask |= 0x04U;
  }
  if (((u32GpioE & 0x00002000U) != 0U) ||
      ((u32GpioD & 0x00000010U) != 0U)) { /* CH7: PTE13/S7, PTD4/S23 */
...
static boolean Cdd_PwmWave_WaitForDtmOutputActivity(uint8 u8RequiredWraps)
{
  ...
  while (u32PollCount > 0U) {
    ...
    if (u32CurrentCounter < u32PreviousCounter) {
      u8BoundaryWraps++;
      if ((u8BoundaryWraps == CDD_PWM_WAVE_REQUEST_SETTLE_WRAPS) &&
          (u8RequiredWraps > CDD_PWM_WAVE_REQUEST_SETTLE_WRAPS)) {
        /* Discard settle-time observations; verify only the next complete cycle. */
        u8ActivityObserved = 0U;
      }
      if (u8BoundaryWraps >= u8RequiredWraps) {
        return ((u8ActivityObserved & CDD_PWM_WAVE_DTM_ACTIVITY_ALL_GROUPS) ==
                CDD_PWM_WAVE_DTM_ACTIVITY_ALL_GROUPS)
                   ? TRUE
                   : FALSE;
      }
    }
...
{
  return ((TRUE == Cdd_PwmWave_AreOutputPinModesValid()) &&
          (TRUE == Cdd_PwmWave_AreOutputPadsLow()))
             ? TRUE
             : FALSE;
}
...
static boolean Cdd_PwmWave_ForceSafeHardware(void)
{
  ...
  return ((TRUE == bRunRequestLow) &&
          (TRUE == Cdd_PwmWave_AreDtmChannelsForcedLow()) &&
          (TRUE == Cdd_PwmWave_AreAllOutputsDisabled()) &&
          (TRUE == Cdd_PwmWave_AreTomSafeSignalLevels()) &&
          ((FALSE == s_bOutputPadsConfirmed) ||
...
Cdd_PwmWave_ResultType Cdd_PwmWave_Init(void)
{
  ...
  if (FALSE == s_bDtmRunConfigCaptured) {
    ...
    if (TRUE == Cdd_PwmWave_IsInitialDtmConfigValid(u32Dtm0RunCtrl2,
                                                    u32Dtm1RunCtrl2)) {
  ...
  if (TRUE == s_bDtmRunConfigCaptured) {
    ...
    bHardwareConfigValid =
        Cdd_PwmWave_IsHardwareConfigValid(s_u32Dtm0RunCtrl2,
                                          s_u32DtmRunCtrl2);
  }
  ...
  if (TRUE == bHardwareConfigValid) {
    ...
    bHardwareConfigValid =
        ((TRUE == Cdd_PwmWave_IsLuStopSynchronizerConfigValid()) &&
         (TRUE == Cdd_PwmWave_IsDtmShutoffConfigValid()) &&
         (TRUE == Cdd_PwmWave_IsCarrierBoundaryTriggerSelected()) &&
         (TRUE == Cdd_PwmWave_IsRunRequestSelected(FALSE)))
            ? TRUE
            : FALSE;
  }
  SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_19();
  ...
  if (TRUE == bHardwareConfigValid) {
    ...
    bStopTimingElapsed = Cdd_PwmWave_WaitForCarrierWraps(
        CDD_PWM_WAVE_REQUEST_SETTLE_WRAPS);
  }
  ...
  if (FALSE == bHardwareConfigValid) {
    ...
    s_u32FaultFlags = CDD_PWM_WAVE_FAULT_HW_CONFIG;
  } else if ((FALSE == bOutputsEnabled) ||
             (FALSE == bStopTimingElapsed)) {
...
Cdd_PwmWave_ResultType Cdd_PwmWave_ConfirmArmedLow(void)
{
  ...
  if (TRUE == s_bFaultLatched) {
    eResult = CDD_PWM_WAVE_E_FAULT_ACTIVE;
             ...
             (TRUE == s_bStartPending) ||
             (TRUE == s_bPendingFrameValid)) {
    eResult = CDD_PWM_WAVE_E_STATE;
  } else if ((FALSE == Cdd_PwmWave_IsRuntimeTopologyValid(FALSE)) ||
             (FALSE == Cdd_PwmWave_IsPhysicalArmedLowValid())) {
...
Cdd_PwmWave_ResultType Cdd_PwmWave_Start(void)
{
  ...
  if (CDD_PWM_WAVE_OK == eResult) {
    ...
    bDtmOutputActivity = Cdd_PwmWave_WaitForDtmOutputActivity(
        CDD_PWM_WAVE_START_VERIFY_WRAPS);

    SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_19();
    if (TRUE == s_bFaultLatched) {
      eResult = CDD_PWM_WAVE_E_FAULT_ACTIVE;
    } else if ((FALSE == s_bStartPending) ||
               (CDD_PWM_WAVE_STATE_ARMED_LOW != s_eState)) {
      eResult = CDD_PWM_WAVE_E_STATE;
    } else if ((FALSE == Cdd_PwmWave_IsRuntimeTopologyValid(TRUE)) ||
               (FALSE == Cdd_PwmWave_IsFrameApplied(&s_tActiveFrame, TRUE)) ||
               (FALSE == Cdd_PwmWave_AreOutputPinModesValid()) ||
               (FALSE == Cdd_PwmWave_AreOutputPadInputsEnabled())) {
      Cdd_PwmWave_EnterFault(CDD_PWM_WAVE_FAULT_HW_CONFIG);
      eResult = CDD_PWM_WAVE_E_HW_CONFIG;
...
Cdd_PwmWave_ResultType Cdd_PwmWave_Stop(void)
{
  ...
  if (CDD_PWM_WAVE_OK == eResult) {
    bBoundaryTimingElapsed = Cdd_PwmWave_WaitForCarrierWraps(
        CDD_PWM_WAVE_REQUEST_SETTLE_WRAPS);
...
Cdd_PwmWave_ResultType Cdd_PwmWave_ClearFault(void)
{
  ...
  if (CDD_PWM_WAVE_OK == eResult) {
    if ((FALSE == s_bClearPending) || (FALSE == s_bFaultLatched)) {
      ...
      s_u32FaultFlags |= CDD_PWM_WAVE_FAULT_HW_TIMEOUT;
      eResult = CDD_PWM_WAVE_E_HW_TIMEOUT;
    } else if ((FALSE == Cdd_PwmWave_IsLuStopSynchronizerConfigValid()) ||
               (FALSE == Cdd_PwmWave_IsDtmShutoffConfigValid()) ||
               (FALSE == Cdd_PwmWave_IsCarrierBoundaryTriggerSelected()) ||
               (FALSE == Cdd_PwmWave_IsRunRequestSelected(FALSE)) ||
               (FALSE == Cdd_PwmWave_AreAllOutputsDisabled())) {
      s_u32FaultFlags |= CDD_PWM_WAVE_FAULT_HW_CONFIG;
      eResult = CDD_PWM_WAVE_E_HW_CONFIG;
    } else {
  ...
  if ((CDD_PWM_WAVE_OK == eResult) && (TRUE == bEnableIssued)) {
    if ((FALSE == s_bClearPending) || (FALSE == s_bFaultLatched)) {
      eResult = CDD_PWM_WAVE_E_FAULT_ACTIVE;
    } else if ((TRUE == bOutputsEnabled) &&
               (TRUE == Cdd_PwmWave_IsRuntimeTopologyValid(FALSE)) &&
               (TRUE == s_bOutputPadsConfirmed) &&
               (TRUE == Cdd_PwmWave_IsPhysicalArmedLowValid())) {
      s_bPendingFrameValid = FALSE;
      s_bPendingUsesRunSignalLevels = FALSE;
      s_bActiveFrameValid = FALSE;
