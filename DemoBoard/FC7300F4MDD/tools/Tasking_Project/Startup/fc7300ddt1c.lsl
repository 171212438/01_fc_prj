...
// CPU0 Remap Only: 64 KB (0x2100_0000 to 0x2100_FFFF)
// CPU1 Remap Only: 64 KB (0x2101_0000 to 0x2101_FFFF)
// Both Remap: 128 KB (2100_0000 - 2101_FFFF)
...
// AMP:
// 2000_0000 -> 2001_FFFF, CPU0, if CPU0_DTCM_REMAP is 0
// 2000_0000 -> 2000_FFFF, CPU0, if CPU0_DTCM_REMAP is 1
// 2000_0000 -> 2001_FFFF, CPU1, if CPU1_DTCM_REMAP is 0
// 2000_0000 -> 2000_FFFF, CPU1, if CPU1_DTCM_REMAP is 1
// SMP:
// 2000_0000 -> 2001_FFFF, CPU0, if CPU0_DTCM_REMAP is 0
// 2000_0000 -> 2000_FFFF, CPU0, if CPU0_DTCM_REMAP is 1
// 2002_0000 -> 2003_FFFF, CPU1, if CPU1_DTCM_REMAP is 0
// 2002_0000 -> 2002_FFFF, CPU1, if CPU1_DTCM_REMAP is 1
#define __DTCM_START  0x20000000
#define __DTCM_SIZE   256k

// AMP: 0000_0000 -> 0000_FFFF, CPU0; 0000_0000 -> 0000_FFFF, CPU1
// SMP: 0000_0000 -> 0000_FFFF, CPU0; 0001_0000 -> 0001_FFFF, CPU1
...
section_setup :cm7_0:linear
{
                                ...
                                )
    {
            ...
            vector ( id = 48, optional, fill = "DMA0_Error_IRQHandler");                           //  DMA error interrupt channels 0-63
            vector ( id = 49, optional, fill = "CPM0_IRQHandler");                                 //  FPU etc. interrupt
            vector ( id = 50, optional, fill = "FC0_IRQHandler");                                  //  Flash Controller Command complete, time out etc. interrupt*/
            vector ( id = 51, optional, fill = "PMC0_IRQHandler");                                 //   HVD/LVD etc. interrupt
            ...
            vector ( id = 58, optional, fill = "ERM0_IRQHandler");                                 //  ERM single or double bit error interrupt
            ...
            vector ( id = 61, optional, fill = "CTI0_IRQHandler");                                 //  CTI Interrupt
            vector ( id = 62, optional, fill = "CTI1_IRQHandler");                                 //  CTI Interrupt
            vector ( id = 63, optional, fill = "RGM0_Pre_IRQHandler");                             //  RGM pre-reset Interrupt
            vector ( id = 64, optional, fill = "RGM0_Exit_IRQHandler");                            //  RGM other cpu exit reset Interrupt
            vector ( id = 65, optional, fill = "INTM0_IRQHandler");                                //  INTM timeout interrupt
            vector ( id = 66, optional, fill = "ISM0_IRQHandler");                                 //  ISM0 interrupt
            vector ( id = 67, optional, fill = "MB0_IRQHandler");                                  //  Mail Box interrupt
            vector ( id = 68, optional, fill = "SCG0_IRQHandler");                                 //  SCG bus interrupt request
            ...
            vector ( id = 76, optional, fill = "CMU4_IRQHandler");                                 //  CMU4 interrupt
            vector ( id = 77, optional, fill = "CORDIC0_IRQHandler");                              //  CORDIC Accelerator interrupt
            vector ( id = 78, optional, fill = "HSM0_Error_IRQHandler");                           //  HSM error interrupt
            vector ( id = 79, optional, fill = "FCPIT0_IRQHandler");                               //  FCPIT0 interrupt
            vector ( id = 81, optional, fill = "RTC0_IRQHandler");                                 //  RTC alarm or seconds interrupt 
            vector ( id = 82, optional, fill = "ENET_Tx0_IRQHandler");                             //  ENET TX Channel 0 Interrupt
            vector ( id = 83, optional, fill = "ENET_Tx1_IRQHandler");                             //  ENET TX Channel 1 Interrupt
            vector ( id = 84, optional, fill = "ENET_Rx0_IRQHandler");                             //  ENET RX Channel 0 Interrupt
            vector ( id = 85, optional, fill = "ENET_Rx1_IRQHandler");                             //  ENET RX Channel 1 Interrupt
            ...
            vector ( id = 124, optional, fill = "FTU0_IRQHandler");                                //  FTU0 all source interrupt
            vector ( id = 125, optional, fill = "FTU1_IRQHandler");                                //  FTU1 all source interrupt
            vector ( id = 126, optional, fill = "FTU2_IRQHandler");                                //  FTU2 all source interrupt
            vector ( id = 127, optional, fill = "FTU3_IRQHandler");                                //  FTU3 all source interrupt
            vector ( id = 128, optional, fill = "FTU4_IRQHandler");                                //  FTU4 all source interrupt
            vector ( id = 129, optional, fill = "FTU5_IRQHandler");                                //  FTU5 all source interrupt
            vector ( id = 130, optional, fill = "FTU6_IRQHandler");                                //  FTU6 all source interrupt
            vector ( id = 131, optional, fill = "FTU7_IRQHandler");                                //  FTU7 all source interrupt
            vector ( id = 132, optional, fill = "CMP0_IRQHandler");                                //  CMP0 interrupt request 
            vector ( id = 133, optional, fill = "ADC0_IRQHandler");                                //  ADC0 interrupt request.
            vector ( id = 134, optional, fill = "ADC1_IRQHandler");                                //  ADC1 interrupt request.
            vector ( id = 135, optional, fill = "ADC2_IRQHandler");                                //  ADC2 interrupt request.
            vector ( id = 136, optional, fill = "ADC3_IRQHandler");                                //  ADC3 interrupt request.
            vector ( id = 137, optional, fill = "PTIMER0_IRQHandler");                             //  PTIMER0 interrupt
            vector ( id = 138, optional, fill = "PTIMER1_IRQHandler");                             //  PTIMER1 interrupt
            vector ( id = 139, optional, fill = "PTIMER2_IRQHandler");                             //  PTIMER2 interrupt
            vector ( id = 140, optional, fill = "PTIMER3_IRQHandler");                             //  PTIMER3 interrupt
            vector ( id = 141, optional, fill = "MSC0_IRQHandler");                                //  MSC interrupt
            vector ( id = 144, optional, fill = "SENT0_IRQHandler");                               //  SENT all interrupt (fast or slow)
            vector ( id = 145, optional, fill = "SENT1_IRQHandler");                               //  SENT all interrupt (fast or slow)
            vector ( id = 146, optional, fill = "SSI0_IRQHandler");                                //  SSI interrupt OR Interrupt
            vector ( id = 147, optional, fill = "SDADC0_0_IRQHandler");                            //  SDADC channel 0 Interrupt
            vector ( id = 148, optional, fill = "SDADC0_1_IRQHandler");                            //  SDADC channel 1 Interrupt
            vector ( id = 149, optional, fill = "LU0_IRQHandler");                                 //  LU interrupt
            vector ( id = 150, optional, fill = "LU1_IRQHandler");                                 //  LU interrupt
            vector ( id = 151, optional, fill = "HSM0_Crypto_IRQHandler");                         //  Crypto interrupt
            vector ( id = 152, optional, fill = "EFTU0_Error_IRQHandler");                         //  eFTU all error source interrupt
            vector ( id = 153, optional, fill = "EFTU0_TIM_0_3_IRQHandler");                       //  eFTU TIM 0-3 source interrupt
            vector ( id = 154, optional, fill = "EFTU0_TIM_4_7_IRQHandler");                       //  eFTU TIM 4-7 source interrupt
            vector ( id = 155, optional, fill = "EFTU0_TOM_0_7_IRQHandler");                       //  eFTU TOM 0-7 source interrupt
            vector ( id = 156, optional, fill = "EFTU0_TOM_8_15_IRQHandler");                      //  eFTU TOM 8-15 source interrupt
            vector ( id = 157, optional, fill = "CAN0_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 158, optional, fill = "CAN1_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 159, optional, fill = "CAN2_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 160, optional, fill = "CAN3_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 161, optional, fill = "CAN4_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 162, optional, fill = "CAN5_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 163, optional, fill = "CAN6_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 164, optional, fill = "CAN7_Error_IRQHandler");                          //  FLEXCAN Error interrupt
            vector ( id = 165, optional, fill = "CRM0_IRQHandler");                                //  RESERVED
            vector ( id = 166, optional, fill = "LDI0_IRQHandler");                                //  LED Driver Interface
    }
}
