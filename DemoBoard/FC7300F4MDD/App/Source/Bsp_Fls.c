...
typedef struct
{
    ...
    uint32 (*ecc_injection)(FLASH_API_ECC_CHECK_CFG_TYPE *flash_api_cfg);
...
static void Open_Inject_Ecc_Error(void)
{
    ...
    flash_api_cfg.data1 = 0x87654021;
    flash_api_cfg.data2 = 0x12345678;
    flash_api_cfg.data3 = 0x01000012;
    flash_api_cfg.data4 = 0x40060000;
    flash_api_cfg.data5 = 0;
    ...
    *(volatile uint32 *)0x4001E004 = 0;
    ...
    s_pFlashDriver_RomApiHeader->ecc_injection(&flash_api_cfg);
}
