...
CAN_DATA_SECTION static const Can_MBConfigObjectType CanCfg_MessageBufferConfigs0_PB[CAN_MAXMBCOUNT_PB] =
{
    ...
    /* CanController0_Transmit0 Message Buffer of Can Controller ID = 0U, array index=9 */
    {
    ...
    /* CanController1_Transmit0 Message Buffer of Can Controller ID = 1U, array index=10 */
    {
        ...
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0xfU, /* Hardware Object ID */
    ...
    /* CanController1_Transmit0 Message Buffer of Can Controller ID = 1U, array index=11 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)1U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
    ...
    /* CanController1_Transmit0 Message Buffer of Can Controller ID = 1U, array index=12 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)1U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
    ...
    /* CanController2_Transmit0 Message Buffer of Can Controller ID = 2U, array index=13 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)2U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
        ...
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x10U, /* Hardware Object ID */
    ...
    /* CanController3_Transmit0 Message Buffer of Can Controller ID = 3U, array index=14 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)3U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
        ...
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x11U, /* Hardware Object ID */
    ...
    /* CanController4_Transmit0 Message Buffer of Can Controller ID = 4U, array index=15 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)4U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
        ...
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x12U, /* Hardware Object ID */
    ...
    /* CanController5_Transmit0 Message Buffer of Can Controller ID = 5U, array index=16 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)5U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
        ...
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x13U, /* Hardware Object ID */
