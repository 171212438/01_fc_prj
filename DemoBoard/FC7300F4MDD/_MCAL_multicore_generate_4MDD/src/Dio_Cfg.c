...
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_LED1_CoreInfo[3] = {0x0,0x0,0x1};
/**
* @brief          CoreConfiguration of channel in configuration LED3.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_LED3_CoreInfo[3] = {0x0,0x0,0x1};
/**
* @brief          CoreConfiguration of channel in configuration DioChannel_B12.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_DioChannel_B12_CoreInfo[3] = {0x0,0x1,0x1};
/**
* @brief          CoreConfiguration of channel in configuration ETH_PMYMODECFG0.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_ETH_PMYMODECFG0_CoreInfo[3] = {0x0,0x0,0x1};
/**
* @brief          CoreConfiguration of channel in configuration ETH_MDIOSEL.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_ETH_MDIOSEL_CoreInfo[3] = {0x0,0x0,0x1};
/**
* @brief          CoreConfiguration of channel in configuration ETH_PMYMODECFG2.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_ETH_PMYMODECFG2_CoreInfo[3] = {0x0,0x0,0x1};
/**
* @brief          CoreConfiguration of channel in configuration LED2.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_LED2_CoreInfo[3] = {0x0,0x0,0x1};
/**
* @brief          CoreConfiguration of channel in configuration ETH_PHYRESET.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_ETH_PHYRESET_CoreInfo[3] = {0x0,0x0,0x1};
/**
...
DIO_DATA_SECTION const Dio_CoreConfigInfoType Dio_CoreConfigInfo[DioConf_DioChannel_CoreConfigInfo_NUM] = {
    ...
    {DioConf_DioPort_PTA, DioConf_DioChannel_LED3, DioConf_DioChannel_LED3_CoreInfo},
    {DioConf_DioPort_PTB, DioConf_DioChannel_DioChannel_B12, DioConf_DioChannel_DioChannel_B12_CoreInfo},
    {DioConf_DioPort_PTC, DioConf_DioChannel_ETH_PMYMODECFG0, DioConf_DioChannel_ETH_PMYMODECFG0_CoreInfo},
    {DioConf_DioPort_PTC, DioConf_DioChannel_ETH_MDIOSEL, DioConf_DioChannel_ETH_MDIOSEL_CoreInfo},
    {DioConf_DioPort_PTC, DioConf_DioChannel_ETH_PMYMODECFG2, DioConf_DioChannel_ETH_PMYMODECFG2_CoreInfo},
