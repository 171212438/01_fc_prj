...
*/
#define  IcuConf_IcuChannel_IcuChannel_KEY1          ((Icu_ChannelType)0U)
#define  IcuConf_IcuChannel_IcuChannel_KEY2          ((Icu_ChannelType)1U)
#define  IcuConf_IcuChannel_IcuChannel_KEY3          ((Icu_ChannelType)2U)
...
*/
#define ICU_TOTAL_EFTU_NUMBER             (1U)
...
*/
#define ISM_FPC_TOTAL_CHANNEL             (32U)
...
*/
#define ICU_SUPPORT_TPU          (STD_OFF)
