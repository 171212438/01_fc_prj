...
#define DIO_SUPPORT_MULTICORE     (STD_ON)
...
#define DioConf_DioChannel_CoreConfigInfo_NUM  (8u) 
...
*
*/
#define  DioConf_DioChannel_LED3 ((uint16)0x000eU)
...
/**
* @brief          Symbolic name for the channel ETH_PMYMODECFG0.
*
*/
#define  DioConf_DioChannel_ETH_PMYMODECFG0 ((uint16)0x0040U)
...
/**
* @brief          Symbolic name for the channel ETH_PMYMODECFG2.
*
*/
#define  DioConf_DioChannel_ETH_PMYMODECFG2 ((uint16)0x004fU)
...
#define DIO_PORT_A_14_USED

#define DIO_PORT_B_12_USED

#define DIO_PORT_C_0_USED
#define DIO_PORT_C_14_USED
#define DIO_PORT_C_15_USED
