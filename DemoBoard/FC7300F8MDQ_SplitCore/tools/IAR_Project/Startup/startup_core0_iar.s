        MODULE  ?cstartup_core0

        ;; Forward declaration of sections.
        SECTION CSTACK_CORE0:DATA:NOROOT(3)

        SECTION .isr_vector_Core0:CODE:ROOT(2)
        ...
        EXTERN  DefaultISR
        PUBLIC  __vector_table_Core0
        PUBLIC  __Vectors_Core0
        PUBLIC  __Vectors_End_Core0
        PUBLIC  __Vectors_Size_Core0

        DATA
__iar_init$$done:               ; The vector table is not needed
                                ; until after copy initialization is done
__vector_table:
__vector_table_Core0:
        DCD   sfe(CSTACK_CORE0)                                 /* Top of Stack */
        DCD   Reset_Handler_Core0                               /* Reset Handler */
...
__Vectors_Core0       EQU   __vector_table_Core0
__Vectors_Size_Core0 	EQU   __Vectors_End_Core0 - __Vectors_Core0
        THUMB

        PUBWEAK Reset_Handler_Core0
