        MODULE  ?cstartup_Core2

        ;; Forward declaration of sections.
        SECTION CSTACK_CORE2:DATA:NOROOT(3)

        SECTION .isr_vector_Core2:CODE:ROOT(2)
        ...
        EXTERN  DefaultISR
        PUBLIC  __vector_table_Core2
        PUBLIC  __Vectors_Core2
        PUBLIC  __Vectors_End_Core2
        PUBLIC  __Vectors_Size_Core2

        DATA
__iar_init$$done:               ; The vector table is not needed
                                ; until after copy initialization is done

__vector_table_Core2:
        DCD   sfe(CSTACK_CORE2)                                 /* Top of Stack */
        DCD   Reset_Handler_Core2                               /* Reset Handler */
...
__Vectors_Core2       EQU   __vector_table_Core2
__Vectors_Size_Core2 	EQU   __Vectors_End_Core2 - __Vectors_Core2
        THUMB

        PUBWEAK Reset_Handler_Core2
