        MODULE  ?cstartup_Core1

        ;; Forward declaration of sections.
        SECTION CSTACK_CORE1:DATA:NOROOT(3)

        SECTION .isr_vector_Core1:CODE:ROOT(2)
        ...
        EXTERN  DefaultISR
        PUBLIC  __vector_table_Core1
        PUBLIC  __Vectors_Core1
        PUBLIC  __Vectors_End_Core1
        PUBLIC  __Vectors_Size_Core1

        DATA
__iar_init$$done:               ; The vector table is not needed
                                ; until after copy initialization is done

__vector_table_Core1:
        DCD   sfe(CSTACK_CORE1)                                 /* Top of Stack */
...
__Vectors_Core1       EQU   __vector_table_Core1
__Vectors_Size_Core1 	EQU   __Vectors_End_Core1 - __Vectors_Core1
        THUMB
