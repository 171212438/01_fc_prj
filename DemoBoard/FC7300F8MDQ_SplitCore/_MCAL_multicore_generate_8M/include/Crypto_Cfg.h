...
#define CRYPTO_SHE_SUPPORT (STD_OFF)
...
* @details
*/
#define CRYPTO_MAXKEY_CONFIGURED   (66UL)
#define CRYPTO_MAXPrimitive_CONFIGURED   (89UL)
...
* @details
*/
#define CRYPTO_MAXKEYELEMENT_CONFIGURED   (68UL)
