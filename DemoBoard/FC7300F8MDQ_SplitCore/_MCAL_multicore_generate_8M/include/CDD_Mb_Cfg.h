...
*
*/
#define MB_MESSAGE_QUEUE_API (STD_ON)
 ...
 */
#define MB_MAX_HW_CHANNEL                   (16U)

/**
 *   @brief Maximum number of Mailbox hardware interrupt channel
 */
#define MB_MAX_HW_INTR_CHANNEL              (5U)
 ...
 */
#define MB_FREE_CHANNEL_COUNT               (6U)

/**
 *   @brief Number of Mailbox channels configured as message queue
 */
#define MB_MESSAGE_QUEUE_COUNT              (2U)

/**
* @brief MbMulticoreSupport switch
*
*/
#define MB_SUPPORT_MULTICORE               (STD_ON)
...
*
*/
#define MB_USED_CHANNEL_MASK        ((uint32)(255U))

/**
 *   @brief The max number of core used by mailbox
 */
#define MB_CORE_COUNT                       (3U)  

/**
* @brief Symbolic Names for configured channels - legacy
*/

#define  MbConf_MbChannel_MbChannel_0          (0U)

#define  MbConf_MbChannel_MbChannel_1          (1U)

#define  MbConf_MbChannel_MbChannel_2          (2U)

#define  MbConf_MbChannel_MbChannel_3          (3U)

#define  MbConf_MbChannel_MbChannel_HSM_Core0_Cmd          (4U)

#define  MbConf_MbChannel_MbChannel_HSM_Core0_Cancel          (5U)

#define  MbConf_MbChannel_MbChannel_HSM_Core1_Cmd          (6U)

#define  MbConf_MbChannel_MbChannel_HSM_Core1_Cancel          (7U)
