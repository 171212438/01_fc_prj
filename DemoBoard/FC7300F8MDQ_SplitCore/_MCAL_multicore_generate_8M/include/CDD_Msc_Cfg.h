...
#define MSC_UNINIT_ARRAY  {MSC_UNINIT, MSC_UNINIT, MSC_UNINIT, MSC_UNINIT}

#define MSC_CFG_PTR_INIT_ARRAY  {NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR}

#define MSC_RXBUSY_AVAILABLE (STD_ON)
