 ...
 */
#define MCU_MAX_COREID_FORMAT                 4U


/**
 * @brief    Init variable of driver initialize status
 */
#define MCU_DRIVER_STATUS_UNINIT_ARRAY  {MCU_UNINITIALIZED, MCU_UNINITIALIZED, MCU_UNINITIALIZED, MCU_UNINITIALIZED}

/**
 * @brief    Init variable of  driver clocksetting status
 */
#define MCU_DRIVER_CLOCK_SETTING_ARRAY  {0U, 0U, 0U, 0U}

/**
 * @brief    Init pointer of  driver initialize status
 */
#define MCU_DRIVER_INIT_PTR_ARRAY  {NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR}
