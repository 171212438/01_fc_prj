...
#define  IcuConf_IcuChannel_IcuChannel_Eftu_DutyCycle_Measurement          ((Icu_ChannelType)3U)
 ...
 */
#define ICU_MULTICORE_SUPPORT                       (STD_ON)
...
/**
 * @brief The partition number.
 *
 */
#define ICU_PARTITIONS_NB                    (2U)


/**
 * @brief Enable/disable support for Icu time stamp dma feature.
*/
#define ICU_TIMESTAMP_DMA                    (STD_OFF)
...
*/
#define ICU_TOTAL_PORT_NUMBER             (9U)

/**
 * @brief Hardware FCPIT Instance.
*/
#define ICU_TOTAL_FCPIT_NUMBER             (2U)

/**
 * @brief Hardware EFTU Instance.
*/
#define ICU_TOTAL_EFTU_NUMBER             (3U)

/**
 * @brief Hardware Cmp Instance.
*/
#define ICU_TOTAL_CMP_NUMBER            (1U)
 ...
 * @brief Hardware Fpc channel .
*/
#define ISM_LAM_TOTAL_CHANNEL             (8U)
...
*/
#define ICU_SUPPORT_EFTU          (STD_ON)
...
#define ICU_PORT_A_11_USED
#define ICU_PORT_A_ISR_USED
#define ICU_PORT_D_20_USED
#define ICU_PORT_D_26_USED
...
/**
 * @brief ICU Eftu Tim driver interrupt used
 * 
 */
#define ICU_EFTU_TIM_ISR_USED
#define ICU_EFTU_0_TIM0_3_ISR_USED
