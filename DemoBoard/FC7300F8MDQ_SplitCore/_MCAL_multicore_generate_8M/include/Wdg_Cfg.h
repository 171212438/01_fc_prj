...
*/
#define WdgConf_WdgGeneral_WdgIndex1_U8 ((uint8)1U)

/**
* @brief  This variable will indicate the index of instance 2
*/
#define WdgConf_WdgGeneral_WdgIndex2_U8 ((uint8)2U)

/**
* @brief  This variable will indicate the index of instance 2
*/
#define WdgConf_WdgGeneral_WdgIndex3_U8 ((uint8)3U)


/**
* @brief  The initial value of s_WdgStatus
*/
#define WDG_VARIABLE_STATUS_VALUE      {WDG_UNINIT,WDG_UNINIT,WDG_UNINIT,WDG_UNINIT}

/**
* @brief  The initial value of s_WdgTimeout
*/
#define WDG_VARIABLE_TIMEOUT_VALUE      {(uint32)0U,(uint32)0U,(uint32)0U,(uint32)0U}

/**
* @brief  The initial value of s_WdgGptPeriod
*/
#define WDG_VARIABLE_PERIOD_VALUE      {(uint32)0U,(uint32)0U,(uint32)0U,(uint32)0U}
...
/**
* @brief  These variables will indicate the Wdg Initial Timeout parameters in miliseconds for Wdg module 1
*/
#define WDG_INSTANCE1_INITIAL_TIMEOUT_U32 ((uint32)40U)
/**
* @brief  These variables will indicate the Wdg Initial Timeout parameters in miliseconds for Wdg module 2
*/
#define WDG_INSTANCE2_INITIAL_TIMEOUT_U32 ((uint32)50U)
/**
* @brief  These variables will indicate the Wdg Initial Timeout parameters in miliseconds for Wdg module 3
*/
#define WDG_INSTANCE3_INITIAL_TIMEOUT_U32 ((uint32)60U)

/**
* @brief  Wdg Initial Timeout parameters of s_WdgInitialTimeout
*/
#define WDG_INTIAL_TIMEOUT      {WDG_INSTANCE0_INITIAL_TIMEOUT_U32,WDG_INSTANCE1_INITIAL_TIMEOUT_U32,WDG_INSTANCE2_INITIAL_TIMEOUT_U32,WDG_INSTANCE3_INITIAL_TIMEOUT_U32}
...
/**
* @brief  These variables will indicate the Wdg Max Timeout parameters in miliseconds for Wdg module 1
*/
#define WDG_INSTANCE1_MAX_TIMEOUT_VALUE ((uint16)100U)
/**
* @brief  These variables will indicate the Wdg Max Timeout parameters in miliseconds for Wdg module 2
*/
#define WDG_INSTANCE2_MAX_TIMEOUT_VALUE ((uint16)100U)
/**
* @brief  These variables will indicate the Wdg Max Timeout parameters in miliseconds for Wdg module 3
*/
#define WDG_INSTANCE3_MAX_TIMEOUT_VALUE ((uint16)100U)

/**
* @brief  Wdg max Timeout parameters of s_WdgMaxTimeout
*/
#define WDG_MAX_TIMEOUT      {WDG_INSTANCE0_MAX_TIMEOUT_VALUE,WDG_INSTANCE1_MAX_TIMEOUT_VALUE,WDG_INSTANCE2_MAX_TIMEOUT_VALUE,WDG_INSTANCE3_MAX_TIMEOUT_VALUE}
...
/**
* @brief  These variables will indicate the number of executions of the loop waiting for the unlock or reconfigure flag for Wdg module 1
*/
#define WDG_INSTANCE1_FLAG_LOOP_VALUE ((uint32)0xffffffU)
/**
* @brief  These variables will indicate the number of executions of the loop waiting for the unlock or reconfigure flag for Wdg module 2
*/
#define WDG_INSTANCE2_FLAG_LOOP_VALUE ((uint32)0xffffffU)
/**
* @brief  These variables will indicate the number of executions of the loop waiting for the unlock or reconfigure flag for Wdg module 3
*/
#define WDG_INSTANCE3_FLAG_LOOP_VALUE ((uint32)0xffffffU)

/**
* @brief  Wdg flag loop times parameters of s_WdgunlockAndReconfigLoopTimes
*/
#define WDG_FLAG_LOOP_TIMES      {WDG_INSTANCE0_FLAG_LOOP_VALUE,WDG_INSTANCE1_FLAG_LOOP_VALUE,WDG_INSTANCE2_FLAG_LOOP_VALUE,WDG_INSTANCE3_FLAG_LOOP_VALUE}
...
*/
#define WDG_MULTICORE_ENABLED   (STD_ON)

/**
* @brief  This macro indicate if use the fast configuration way to configure wdg.
*/
#define WDG_FAST_CONFIGURATION_ENABLED   (STD_OFF)
