...
*/
#define GPT_CFG_TSTMP0_SIRC1M_CHANGE_SUPPORT    (STD_OFF)
...
*/
            ...
            #define GptConf_GptChannelConfiguration_GptChannel_WDGInstance2 (4U)
            

            #define GptConf_GptChannelConfiguration_GptChannel_WDGInstance2Condition (5U)
            

            #define GptConf_GptChannelConfiguration_GptChannel_WDGInstance3 (6U)
            

            #define GptConf_GptChannelConfiguration_GptChannel_WDGInstance3Condition (7U)
...
#define GPT_EFTU_ISR_USED
#define GPT_EFTU_0_TOM_1_ISR_USED
#define GPT_EFTU_1_TOM_0_ISR_USED



#define GPT_PRECOMPILE_SUPPORT  (STD_OFF)

#define MAX_CONFIGURED_CHANNELS_U8           ((Gpt_ChannelType)8U)

#define GPT_FCPIT_MODULES_NUM                (2U)

#define GPT_FCPIT_CHANNEL_NUM                (4U)

#define GPT_TSTMP_MODULES_NUM                (5U)
...
#define GPT_EFTU_MODULES_NUM                 (6U)
...
*/
#define MAX_GPT_CHANNEL_NUM    (178U)
