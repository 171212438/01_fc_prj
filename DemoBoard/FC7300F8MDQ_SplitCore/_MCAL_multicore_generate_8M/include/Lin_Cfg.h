...
*/
#define LIN_FCUART_MAX_MODULES 14U
...
#define LIN_PARTIONS_NB     ((uint32)4U)

/**
 * @brief    Init variable driver status
 */
#define LIN_DRIVER_STATUS_UNINIT_ARRAY  {LIN_UNINIT, LIN_UNINIT, LIN_UNINIT, LIN_UNINIT}

/**
 * @brief    Init variable Lin_ConfigPtr
 */
#define LIN_CONFIGPTR_UNINIT_ARRAY {NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR}
...
*/
#define LIN_CHMAP_UNINT_ARRAY {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
...
#define LIN_FCUART_ECUCPARTITION_2_CORE_ID ((uint32)2U)
...
#define LIN_FCUART_8_ISR_USED
#define LIN_FCUART_7_ISR_USED
...
#define LinConf_LinChannel_LinChannel_2         2
#define LinConf_LinChannel_LinChannel_3         3
...
LIN_DATA_SECTION extern const Lin_ChannelType Lin_LinChannel_2_PC;

LIN_DATA_SECTION extern const Lin_ChannelType Lin_LinChannel_3_PC;
...
LIN_DATA_SECTION extern const Lin_ConfigType Lin_Config_EcucPartition_2;
