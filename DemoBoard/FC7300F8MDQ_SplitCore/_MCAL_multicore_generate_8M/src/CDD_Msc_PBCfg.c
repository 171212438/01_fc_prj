...
*
*/
CDD_MSC_TEXT_SECTION extern void Msc_ReceiveNotification1(void);
...
#define MSC_ECUCPARTITION_1_CORE_ID     ((uint32)1U)

/**
* @brief        All CoreIDs are supported by Msc driver.
*/
#define Msc_MAX_PARTITIONS     ((uint32)4U)
...
/**
* @brief          Configuration for Msc Channel 1 - Variant elements
*/
CDD_MSC_DATA_SECTION static const Msc_ChannelConfigType Msc_MscChannel_1_EcucPartition_1=
{
    /* Partition core id of channel */
    MSC_ECUCPARTITION_1_CORE_ID,
    /**@details MSC Channel is allocated partition or not.*/
    TRUE,
    /**@details MSC Hw channel ID. */
    1U,
...
CDD_MSC_DATA_SECTION static const Msc_ConfigType Msc_Config_EcucPartition_0 =
{
    MSC_ECUCPARTITION_0_CORE_ID,            /** Core Id */
    {
        ...
        */
        ...
        /**
        * @brief   Configuration for Msc Channel 1.
        */
        &Msc_MscChannel_1_EcucPartition_1,
    }
};

CDD_MSC_DATA_SECTION static const Msc_ConfigType Msc_Config_EcucPartition_1 =
{
    MSC_ECUCPARTITION_1_CORE_ID,            /** Core Id */
    {
        /**
        * @brief   Configuration for Msc Channel 0.
        */
