...
extern void Gpt_WdgInstance1Condition_Notification(void);
extern void Wdg_Cbk_GptNotification2(void);
extern void Gpt_WdgInstance2Condition_Notification(void);
extern void Wdg_Cbk_GptNotification3(void);
extern void Gpt_WdgInstance3Condition_Notification(void);
/** @} */
...
GPT_DATA_SECTION static const Gpt_ConfigChannelType Gpt_InitChannelPB[MAX_CONFIGURED_CHANNELS_U8] =
{
...

    {
        .tGptChannelCommonConfig = {
            .u8GptChannel = (uint8)(GPT_FTU_CH_0), /* GPT physical channel no. */
            .eGptModule = (Gpt_ModuleType)(GPT_MODULE_FTU_5), /* hardware module ID */
            .eGptChannelMode = (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
            .u32GptChannelTickValueMax = (Gpt_ValueType)(65535U), /* Maximum ticks value*/
            .bGptDebugModeEnable = (boolean)(FALSE), /* Debug Mode Enable/Disable */
            .u32GptWakeupSource = (uint32)0U, /* Wakeup source information */
            .bGptEnableWakeup = (boolean)FALSE, /* Wakeup capability */
            .pGptNotification = &Wdg_Cbk_GptNotification1,/* Channel notification */
            .eGtbEn = GPT_GTB_Dis,/* Global time fuction(Only for FTU/TPU/EFTU channel) */
        },
...

    {
        .tGptChannelCommonConfig = {
            ...
            .u32GptWakeupSource = (uint32)0U, /* Wakeup source information */
            .bGptEnableWakeup = (boolean)FALSE, /* Wakeup capability */
            .pGptNotification = &Gpt_WdgInstance1Condition_Notification,/* Channel notification */
            .eGtbEn = GPT_GTB_Dis,/* Global time fuction(Only for FTU/TPU/EFTU channel) */
        },
    ...
    {
        .tGptChannelCommonConfig = {
            .u8GptChannel = (uint8)(EFTU_TOM_CH_0), /* GPT physical channel no. */
            .eGptModule = (Gpt_ModuleType)(GPT_MODULE_EFTU_0_TOM_1), /* hardware module ID */
            .eGptChannelMode = (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
            .u32GptChannelTickValueMax = (Gpt_ValueType)(16777215U), /* Maximum ticks value*/
            .bGptDebugModeEnable = (boolean)(FALSE), /* Debug Mode Enable/Disable */
            .u32GptWakeupSource = (uint32)0U, /* Wakeup source information */
            .bGptEnableWakeup = (boolean)FALSE, /* Wakeup capability */
            .pGptNotification = &Wdg_Cbk_GptNotification2,/* Channel notification */
            .eGtbEn = GPT_GTB_Dis,/* Global time fuction(Only for FTU/TPU/EFTU channel) */
        },
        
        .tGptChannelHwSpecificConfig = {

            .tGptEftuTomChannelConfig = {
                .eEftuTomClkSrc = GPT_EFTU_CMU_CLK_RES_0
            }
        }
    ...
    {
        .tGptChannelCommonConfig = {
            .u8GptChannel = (uint8)(EFTU_TOM_CH_1), /* GPT physical channel no. */
            .eGptModule = (Gpt_ModuleType)(GPT_MODULE_EFTU_0_TOM_1), /* hardware module ID */
            .eGptChannelMode = (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
            .u32GptChannelTickValueMax = (Gpt_ValueType)(16777215U), /* Maximum ticks value*/
            .bGptDebugModeEnable = (boolean)(FALSE), /* Debug Mode Enable/Disable */
            .u32GptWakeupSource = (uint32)0U, /* Wakeup source information */
            .bGptEnableWakeup = (boolean)FALSE, /* Wakeup capability */
            .pGptNotification = &Gpt_WdgInstance2Condition_Notification,/* Channel notification */
            .eGtbEn = GPT_GTB_Dis,/* Global time fuction(Only for FTU/TPU/EFTU channel) */
        },
...

    {
        .tGptChannelCommonConfig = {
            .u8GptChannel = (uint8)(EFTU_TOM_CH_0), /* GPT physical channel no. */
            .eGptModule = (Gpt_ModuleType)(GPT_MODULE_EFTU_1_TOM_0), /* hardware module ID */
            .eGptChannelMode = (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
            .u32GptChannelTickValueMax = (Gpt_ValueType)(16777215U), /* Maximum ticks value*/
            .bGptDebugModeEnable = (boolean)(FALSE), /* Debug Mode Enable/Disable */
            .u32GptWakeupSource = (uint32)0U, /* Wakeup source information */
            .bGptEnableWakeup = (boolean)FALSE, /* Wakeup capability */
            .pGptNotification = &Wdg_Cbk_GptNotification3,/* Channel notification */
            .eGtbEn = GPT_GTB_Dis,/* Global time fuction(Only for FTU/TPU/EFTU channel) */
        },
...

    {
        .tGptChannelCommonConfig = {
            ...
            .u32GptWakeupSource = (uint32)0U, /* Wakeup source information */
            .bGptEnableWakeup = (boolean)FALSE, /* Wakeup capability */
            .pGptNotification = &Gpt_WdgInstance3Condition_Notification,/* Channel notification */
            .eGtbEn = GPT_GTB_Dis,/* Global time fuction(Only for FTU/TPU/EFTU channel) */
        },
...
GPT_DATA_SECTION static const Gpt_ChannelType GPT_HW2ChannelMap[MAX_GPT_CHANNEL_NUM] =
{
        ...
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance1, /*mapping of FTU_5_CH_0*/
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance1Condition, /*mapping of FTU_5_CH_1*/
        ...
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_6_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_7_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_8*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_9*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_10*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_11*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_12*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_13*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_14*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_15*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_16*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_17*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_18*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_19*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_20*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_21*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_22*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_23*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_24*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_25*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_26*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_27*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_28*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_29*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_30*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TPU_0_CH_31*/
        ...
        GPT_HW_CHANNEL_UNUSED, /*mapping of FCPIT_1_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FCPIT_1_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FCPIT_1_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FCPIT_1_CH_3*/
        ...
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_3_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_3_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_3_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_3_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_4_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_4_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_4_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of TSTMP_4_CH_3*/
        ...
        GPT_HW_CHANNEL_UNUSED, /*mapping of PTIMER_3_CH_0*/
        ...
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance2, /*mapping of EFTU_0_TOM_1_CH_0*/
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance2Condition, /*mapping of EFTU_0_TOM_1_CH_1*/
        ...
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance3, /*mapping of EFTU_1_TOM_0_CH_0*/
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance3Condition, /*mapping of EFTU_1_TOM_0_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_0_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_0_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_0_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_0_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_0_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_0_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_1_TOM_1_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_0_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_1_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_1_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_1_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_1_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_1_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_1_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of EFTU_2_TOM_1_CH_6*/
        GPT_HW_CHANNEL_UNUSED /*mapping of EFTU_2_TOM_1_CH_7*/
};



GPT_DATA_SECTION static const Gpt_ChannelType GptChannelPartitionMapping[MAX_CONFIGURED_CHANNELS_U8] =
{
        0U,
        0U,
        1U,
