...
MCU_DATA_SECTION static const SCG_ClockType SCG_ClockConfig0 =
{
    ...
    /* PLL0 Configuration */
    {TRUE, FALSE, FALSE, TRUE, FALSE, FALSE, SCG_PLLPSTDIV1_BY4, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY4, 11U, 299U, SCG_PLLSOURCE_FOSC,SCG_PLLPSTDIV_BY2,NULL_PTR}, 
    /* PLL1 Configuration */
    {TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, SCG_PLLPSTDIV1_BY4, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY4, 11U, 249U, SCG_PLLSOURCE_FOSC,SCG_PLLPSTDIV_BY2,NULL_PTR}, 
    /* SOSC Configuration */
...
MCU_DATA_SECTION static const CLOCK_SMC_ConfigType CLOCK_SMC_Config0 =
{
    ...
    {SMC_AON32K_SIRC32K_CLK, SMC_RTC_SIRCDIV_32K_CLK, SMC_AON_SIRC32K_CLK}, 
    ...
    {
        SMC_SRAM2_RETENTION_96KB, 
        {FALSE, SMC_PG_LOCK_PTE1, SMC_PG_ACTIVE_POL_HIGH, 1000U } 
    } 
};
...
MCU_DATA_SECTION static const PCC_CLKCtrlType PCC_Config0[75U] =
{
    ...
    {(uint32)0x1B4, (uint32)0x10800000}, /* FCUART5 */
