...
SSI_DATA_SECTION static const Ssi_SubinstanceConfigType SsiSubinstanceConfig_0_0 =
{
        ...
        1U,    /* Hardware Ssi Subinstance ID */
        0U,    /* The general PWM timeout counter */
        (boolean)TRUE,    /* Sub-instance enable flag  */
        (boolean)FALSE,    /* Read message With Interrupt Type. */
        (boolean)TRUE,    /* Filter enable flag  */
        (boolean)TRUE,    /* Internal comparison enable flag  */
        ...
        SSI_INTERNAL_CMP,    /* Channel selection mode */
...
SSI_DATA_SECTION static const Ssi_InstanceConfigType SsiInstanceConfig_0 =
{
    ...
    5U,    /* divider clock setting  */
    0U,    /* PWM Reference Pulse Width  */
    0U, /* AK Protocol Interval Error Threshold Configuration */
    0U, /* AK Protocol Period Error Threshold Configuration */
...
/*==================================================================================================*/
/**
* @brief       Ssi Driver Cores mapping (indexed by partition number)
* @details     List of all Cores defined in EcuC, with Ssi driver association info
*/
SSI_DATA_SECTION static const boolean SsiCoresMapping[SSI_ECUC_CORES_NUM] =
{
...
/*==================================================================================================*/
/**
* @brief       Ssi Controller Core mapping (indexed by controller number)
* @details     List of all configured controllers, with partition association
*/

SSI_DATA_SECTION static const uint32 SsiCtrlCoresMapping[SSI_CTRL_CONFIGURED] =
{
...
SSI_DATA_SECTION const Ssi_ConfigType SsiConfig =
{
        ...
        (boolean*)SsiCoresMapping,
        (uint32*)SsiCtrlCoresMapping
