...
CRYPTO_DATA_SECTION STATIC const Crypto_AlgorithmInfoType Crypto_SignGenerateCapabilities[8] =
{
    /* family, secondFamily, keyLength, mode */
...
CRYPTO_DATA_SECTION const uint32 Crypto_NbAlgoSupported[CRYPTO_MAX_SERVICES] =
{
    ...
    0,
    0,
    8,   /* CryptoPrimitives_HSM_SIGN_Gen_Algo_Number */
...
#define N_KEYS                       (66UL)
#define N_KEY_TYPES                  (66UL)
#define N_KEY_Elements                  (70UL)
