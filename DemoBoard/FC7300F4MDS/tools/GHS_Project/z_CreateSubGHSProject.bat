...
set Project_Name=_MCAL_generate_4MDS
...
rem for %%F in (../../../../MCAL/Src/Eth/include/*.h)                   do ECHO ..\..\..\..\MCAL\Src\Eth\include\%%F >> _SubProjects\%Project_Name%.gpj
rem for %%F in (../../../../MCAL/Src/Eth/src/*.c)                       do ECHO ..\..\..\..\MCAL\Src\Eth\src\%%F >> _SubProjects\%Project_Name%.gpj

rem for %%F in (../../../../MCAL/Src/EthIf/include/*.h)                 do ECHO ..\..\..\..\MCAL\Src\EthIf\include\%%F >> _SubProjects\%Project_Name%.gpj
rem for %%F in (../../../../MCAL/Src/EthIf/src/*.c)                     do ECHO ..\..\..\..\MCAL\Src\EthIf\src\%%F >> _SubProjects\%Project_Name%.gpj

rem for %%F in (../../../../MCAL/Src/EthTrcv/include/*.h)               do ECHO ..\..\..\..\MCAL\Src\EthTrcv\include\%%F >> _SubProjects\%Project_Name%.gpj
rem for %%F in (../../../../MCAL/Src/EthTrcv/src/*.c)                   do ECHO ..\..\..\..\MCAL\Src\EthTrcv\src\%%F >> _SubProjects\%Project_Name%.gpj
...
rem for %%F in (../../../../MCAL/Src/Os/include/*.h)                    do ECHO ..\..\..\..\MCAL\Src\Os\include\%%F >> _SubProjects\%Project_Name%.gpj
rem for %%F in (../../../../MCAL/Src/Os/src/*.c)                        do ECHO ..\..\..\..\MCAL\Src\Os\src\%%F >> _SubProjects\%Project_Name%.gpj
