...
TRGSEL_DATA_SECTION const TrgSel_OutputRegType TrgSel5_Config[TRGSEL5_NUM_REGS] =
    {
        ...
        (
        (TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL5_SRC_SSI0_TRGIGOUT0 << TRGSEL_SEL0_SHIFT_U32))|
        (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL5_SRC_TRGSEL8_OUT0 << TRGSEL_SEL1_SHIFT_U32))|
        (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL5_SRC_FTU0_MATCH_TRG << TRGSEL_SEL2_SHIFT_U32))
        |
        (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        ),
        (
        (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL5_SRC_LU0_OUT2A << TRGSEL_SEL1_SHIFT_U32))|
        (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL5_SRC_FTU3_RELOAD_TRG << TRGSEL_SEL2_SHIFT_U32))|
        (TRGSEL_SEL3_MASK_U32 & ((uint32)TRGSEL5_SRC_FTU4_RELOAD_TRG << TRGSEL_SEL3_SHIFT_U32))
        |
        (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        ),
        (
        (TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL5_SRC_TRGSEL0_OUT6 << TRGSEL_SEL0_SHIFT_U32))|
        (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL5_SRC_TRGSEL0_OUT7 << TRGSEL_SEL1_SHIFT_U32))|
        (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL5_SRC_LU0_OUT2A << TRGSEL_SEL2_SHIFT_U32))|
        (TRGSEL_SEL3_MASK_U32 & ((uint32)TRGSEL5_SRC_LU0_OUT2A << TRGSEL_SEL3_SHIFT_U32))
        |
        (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        ),
        (
        (TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL5_SRC_TRGSEL6_OUT9 << TRGSEL_SEL0_SHIFT_U32))|
        (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL5_SRC_SSI0_TRGIGOUT1 << TRGSEL_SEL1_SHIFT_U32))|
        (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL5_SRC_TRGSEL0_OUT5 << TRGSEL_SEL2_SHIFT_U32))|
        (TRGSEL_SEL3_MASK_U32 & ((uint32)TRGSEL5_SRC_FTU0_RELOAD_TRG << TRGSEL_SEL3_SHIFT_U32))
        |
        (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        ),
        (
        (TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL5_SRC_VDD << TRGSEL_SEL0_SHIFT_U32))|
        (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL5_SRC_FTU1_MATCH_TRG << TRGSEL_SEL1_SHIFT_U32))|
        (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL5_SRC_TRGSEL0_OUT7 << TRGSEL_SEL2_SHIFT_U32))
        |
        (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        ),
        (
        (TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL5_SRC_ADC3_CMP0 << TRGSEL_SEL0_SHIFT_U32))|
        (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL5_SRC_FTU2_RELOAD_TRG << TRGSEL_SEL1_SHIFT_U32))|
        (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL5_SRC_TRGSEL0_OUT3 << TRGSEL_SEL2_SHIFT_U32))|
        (TRGSEL_SEL3_MASK_U32 & ((uint32)TRGSEL5_SRC_FTU1_RELOAD_TRG << TRGSEL_SEL3_SHIFT_U32))
        |
        (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        )
    };
