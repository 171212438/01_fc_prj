 ...
 *
 */
#define ADC_GROUPS                       (6U)


/**
 * @brief          Total number of ADC units in Config.
 *
 */
#define ADC_SARADC_UNITS                     (4U)
/**
 * @brief          Total number of HSADC units in Config.
 *
 */
#define ADC_HSADC_UNITS                      (0U)
 ...
 *
 */
ADC_TEXT_SECTION extern void IoHwAb_Adc_Notification_5(void); /**< @brief for Group - 5 */
...
/**
 * @brief          Group 4 Assignments on ADC Hardware unit ADC3.
 *
 */
...
/**
 * @brief          Group 5 Assignments on ADC Hardware unit ADC3.
 *
 */
ADC_DATA_SECTION static const Adc_ChannelType Adc_Group5_Assignment_3[ADC_CFGSET_GROUP_5_CHANNELS] =
{
    0U
};
...
{
    /**< @brief Hardware Unit ADC0  --  ADC_SE4 */
    {
    ...
    /**< @brief Hardware Unit ADC0  --  ADC_SE0 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(0U),
        /**< @brief Adc channel resolution */
...
{
    /**< @brief Hardware Unit ADC1  --  V11_SE32 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(32U),
        /**< @brief Adc channel resolution */
    ...
    /**< @brief Hardware Unit ADC1  --  V15_SE35 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(35U),
        /**< @brief Adc channel resolution */
...
{
    /**< @brief Hardware Unit ADC2  --  VDDA1_SE34 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(34U),
        /**< @brief Adc channel resolution */
...
/**
 * @brief          Definition of channels on ADC Hardware unit for configuration.
 * @details        Array of Adc channels defined on ADC3
 */
ADC_DATA_SECTION static const Adc_ChannelConfigurationType Adc_ChannelsCfg_ADC3[] =
{
    /**< @brief Hardware Unit ADC3  --  V11_SE36 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(36U),
        /**< @brief Adc channel resolution */
...
/**
 * @brief          Definition of ADC groups in ADC3
 */
ADC_DATA_SECTION static const Adc_GroupType Adc_HwGroupsCfg_3[] =
{
    4,
    5
};
...
ADC_DATA_SECTION static const Adc_HwUnitConfigurationType Adc_HwUnitCfg[] =
{
    ...
    /**< @brief Hardware Unit ADC3 */
    {
        ...
        ADC_CFG1_ALIGN(0U) |
        ADC_CFG1_TRIGMODE(ADC_TRIGMODE_RISING_EDGE) |
        ADC_CFG1_TRIGSRC(ADC_TRIGSRC_LATCH_UNIT) |
        ADC_CFG1_WAIT(FALSE) |
        ADC_CFG1_AUTO_DIS(FALSE) |
        ADC_CFG1_SEQ_MOD(ADC_SEQMODE_SINGLE) |
        ADC_CFG1_SEQ_LEN(0U) |
#if (STD_ON == ADC_ENABLE_HWGROUP_SUPPORT)
        ADC_CFG1_SEQGP_EN(TRUE) |
#endif
        /* Old data is preserved when overrun occurs */
        ADC_CFG1_OVRMOD(FALSE),
        /** Main configuration of CFG2 registers */
 ...
 * @brief          Definition of ADC Hw units for configuration.
 */
ADC_DATA_SECTION static const Adc_HwUnitConfigurationType *const Adc_SarAdcCfgPtr[] =
{
    /**< @brief Hardware Unit ADC0 */
    &Adc_HwUnitCfg[0],
    /**< @brief Hardware Unit ADC1 */
...
ADC_DATA_SECTION static const Adc_GroupConfigurationType Adc_GroupsCfg[] =
{
    ...
    /**< @brief Group4 -- Hardware Unit ADC3 */
    {
        /**< @brief Adc group id */
        (Adc_GroupType)4,
        /**< @brief Hardware unit logical Id */
    ...
    /**< @brief Group5 -- Hardware Unit ADC3 */
    {
        /**< @brief Adc group id */
        (Adc_GroupType)5,
        /**< @brief Hardware unit logical Id */
        ...
        (Adc_StreamNumSampleType)(1),
        /**< @brief Channels assigned to the group*/
        Adc_Group5_Assignment_3,
        /**< @brief Channel Delays assigned to the group*/
        NULL_PTR,
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_GROUP_5_CHANNELS,
        /**< @brief Enables or Disables the ADC Back to Back configuration for Group channels */
        (boolean)TRUE
#if ((STD_ON == ADC_ENABLE_DIFF_CHANNEL_SUPPORT) && (STD_OFF == ADC_MIXED_DIFF_CHANNEL_SUPPORT))
        ,
 ...
 * @brief          Definition of all ADC groups for configuration.
 */
ADC_DATA_SECTION static const Adc_GroupConfigurationType *const Adc_GroupCfgPtr[] =
{
    /**< @brief Group0 -- Hardware Unit ADC0 */
    &Adc_GroupsCfg[0],
    /**< @brief Group1 -- Hardware Unit ADC0 */
...
/**
 * @brief          Definition of TMU Hw units for configuration.
 */
ADC_DATA_SECTION static const Adc_TmuUnitConfigurationType Adc_TmuUnitCfg[] =
{
...
/**
 * @brief          ADC Hardware Unit index to logical unit mapping configuration.
 */
ADC_DATA_SECTION static const Adc_HwUnitType Adc_SarAdcIndexCfg[] =
{
    ...
    2U,
    /* ADC3 parameters are defined at Adc_HwUnitCfg[3] */
    3U
};
 ...
 */
ADC_DATA_SECTION const Adc_ConfigType Adc_Config =
{
    ...
    (Adc_HwUnitType)ADC_SARADC_UNITS,
