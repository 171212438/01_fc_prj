...
#define CanController0_EFifo0             7U
#define CanController1_EFifo0             8U
#define CanController2_EFifo0             9U
#define CanController3_EFifo0             10U
#define CanController0_Transmit0             11U
#define CanController1_Transmit0             12U
#define CanController2_Transmit0             13U
#define CanController3_Transmit0             14U
...
#define CAN_MAXMBCOUNT_0  13U
#define CAN_HTH_START_ID  11U
#define CAN_HTH_CNT       4U
...
#define FLEXCAN3_BASEADDR      0x40480000U
#define FLEXCAN4_BASEADDR      0x40484000U
#define FLEXCAN5_BASEADDR      0x40488000U
...
#define CAN_MAXCONTROLLERCOUNT_0  4U

#define CAN_MAXCTRL_CONFIGURED 4U


#define CAN_MAXFILTERCOUNT_0  7U

#define CAN_CFGSET0_MAX_BAUDRATE_FC_0_0    2U
...
#define CAN_ENHANCED_FIFO_MAX_TABLEID_0  8U


#define CAN_ENHANCED_RXFIFO_ENABLE (STD_ON)

#define CAN_ENHANCED_RXFIFO_ERFFEL_LIST {78,78,78,78,78,78}
#define CAN_ENHANCED_RXFIFO_ERFFEL_LIST_LEN 6
#define CAN_ENHANCED_RXFIFO_DEPTH_LIST {20,20,20,20,20,20}
#define CAN_ENHANCED_RXFIFO_DEPTH_LIST_LEN 6
#define CAN_HW_RAM_INIT_REGION_COUNT 12U
#define CAN_HW_RAM_INIT_WORD_CONFIG_LEN 6U
#define CAN_HW_RAM_INIT_WORD_CONFIG_LIST {{{384,96,8,4,4,4,4,18,18,18,400,78}},{{384,96,8,4,4,4,4,18,18,18,400,78}},{{384,96,8,4,4,4,4,18,18,18,400,78}},{{384,96,8,4,4,4,4,18,18,18,400,78}},{{384,96,8,4,4,4,4,18,18,18,400,78}},{{384,96,8,4,4,4,4,18,18,18,400,78}}}
...
#define CAN_3_TXINT_SUPPORTED             (STD_OFF)
#define CAN_3_RXINT_SUPPORTED             (STD_OFF)
...
#define CAN_MAX_OBJECT_ID ((uint32)15U)
...
#define CAN_CONTROLLER_REFERENCE_COUNTER 6

#define CAN_CTRL_CONFIGURED (4U)
