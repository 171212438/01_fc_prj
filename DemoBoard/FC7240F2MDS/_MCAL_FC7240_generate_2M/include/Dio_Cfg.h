...
* @api
*/
#define DIO_NUM_PORTS_U16               ((uint16)5)
...
#define DioConf_DioChannel_CoreConfigInfo_NUM  (3u) 
...
*
*/
#define  DioConf_DioChannel_LED2 ((uint16)0x000bU)

/**
* @brief          Symbolic name for the channel LED3.
*
*/
#define  DioConf_DioChannel_LED3 ((uint16)0x000fU)
...
#define DIO_PORT_A_8_USED
#define DIO_PORT_A_11_USED
#define DIO_PORT_A_15_USED
