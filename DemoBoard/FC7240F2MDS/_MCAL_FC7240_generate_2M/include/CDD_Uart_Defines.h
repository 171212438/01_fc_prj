...
#define UART_NUMBER_OF_INSTANCES             (8U)

/* @brief UART Hardware instances mapping initialize value */
#define UART_HW_CHANNELS_MAPPING_FOR_INIT       {-1, -1, -1, -1, -1, -1, -1, -1}
...
#define UART_ENABLE_INTERNAL_LOOPBACK  (STD_OFF)
    ...
    #define UART_ENABLE_INTERNAL_LOOPBACK_PER_INSTANCE  {(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE }
#endif
...
#define UART_ENABLE_FLOWCONTROL  (STD_OFF)
    ...
    #define UART_ENABLE_FLOWCONTROL_PER_INSTANCE  {(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE }
#endif
...
#define UART_ENABLE_TIMEOUT_INTERRUPT  (STD_ON)
    ...
    #define UART_ENABLE_TIMEOUT_INTERRUPT_PER_INSTANCE  {(boolean) FALSE,(boolean) FALSE,(boolean) TRUE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE,(boolean) FALSE }
#endif
