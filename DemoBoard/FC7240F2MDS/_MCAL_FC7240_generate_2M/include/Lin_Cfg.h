...
*/
#define LIN_FCUART_4_ISR_USED
#define LIN_FCUART_5_ISR_USED
...
*/
#define LIN_HAS_SLAVE_NODE     (STD_OFF) 
...
LIN_DATA_SECTION extern const Lin_ConfigType Lin_ConfigSingle_Core;
