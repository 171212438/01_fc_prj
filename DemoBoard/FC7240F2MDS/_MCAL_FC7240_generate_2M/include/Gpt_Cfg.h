...
*
*/
#define GPT_WAKEUP_FUNCTION_API (STD_OFF)
 ...
 *
 */
#define GPT_MULTICORE_SUPPORT                     (STD_OFF)
...
#define MAX_CONFIGURED_CHANNELS_U8           ((Gpt_ChannelType)2U)

#define GPT_FCPIT_MODULES_NUM                (1U)

#define GPT_FCPIT_CHANNEL_NUM                (4U)

#define GPT_TSTMP_MODULES_NUM                (2U)
...
#define GPT_PTIMER_MODULES_NUM               (2U)
...
*/
#define MAX_GPT_CHANNEL_NUM    (112U)
