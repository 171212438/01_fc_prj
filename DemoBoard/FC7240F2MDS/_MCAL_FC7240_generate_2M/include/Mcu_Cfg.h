 ...
 */
#define MCU_MAX_COREID_FORMAT                  1U  


/**
 * @brief    Init variable of driver initialize status
 */
#define MCU_DRIVER_STATUS_UNINIT_ARRAY  {MCU_UNINITIALIZED}

/**
 * @brief    Init variable of  driver clocksetting status
 */
#define MCU_DRIVER_CLOCK_SETTING_ARRAY  {0U}

/**
 * @brief    Init pointer of  driver initialize status
 */
#define MCU_DRIVER_INIT_PTR_ARRAY  {NULL_PTR}
...
*/
#define MCU_MAX_MODECONFIGS   ((uint32)7U)
...
#define MCU_RAW_RESET_ALLBIT       (((uint32)0xE01FF9FFU))
...
/**   This is the corresponding bit of Watchdog 1 Error reset in the returned value of Mcu_GetResetRawReason(exist in FC7240) */
#define MCU_RAW_WATCHDOG1          ((uint32)0x00001000U)
...
#define McuConf_McuResetReasonConf_MCU_WATCHDOG1_RESET   ((uint8)12U)
...
#define McuConf_McuResetReason2Reg_Map {\
                                   ...
                                   McuConf_McuResetReasonConf_MCU_WATCHDOG1_RESET,\
...
typedef enum
{
    ...
    MCU_WATCHDOG1_RESET              = McuConf_McuResetReasonConf_MCU_WATCHDOG1_RESET,                /**<   WDOG1 Reset . RGM_SRS[WDOG1]. exist in FC7240 */
