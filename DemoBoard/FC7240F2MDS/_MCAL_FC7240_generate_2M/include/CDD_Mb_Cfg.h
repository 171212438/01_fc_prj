...
*
*/
#define MB_USED_CHANNEL_MASK        ((uint32)(15U))
...
#define  MbConf_MbChannel_MbChannel_Host2Flexcore          (0U)

#define  MbConf_MbChannel_MbChannel_Flexcore2Host          (1U)

#define  MbConf_MbChannel_MbChannel_HsmCmd          (2U)

#define  MbConf_MbChannel_MbChannel_HsmCancel          (3U)
