...
#define SpiConf_SpiChannel_SpiChannel_3    ((Spi_ChannelType)3)
/**
...
*/
#define SPI_CHANNEL_MAX_COUNT  (4u)


#define SpiConf_SpiJob_SpiJob_0_Flash_Read_ID   ((Spi_JobType)0)
#define SpiConf_SpiJob_SpiJob_1_Spi2   ((Spi_JobType)1)
#define SpiConf_SpiJob_SpiJob_2_Spi5   ((Spi_JobType)2)
...
*     for all the driver configurations.
*/
#define SPI_JOB_MAX_COUNT     (3u)


#define SpiConf_SpiSequence_SpiSequence_0_Spi_Flash   ((Spi_SequenceType)0)
#define SpiConf_SpiSequence_SpiSequence_1_Spi2_Master   ((Spi_SequenceType)1)
#define SpiConf_SpiSequence_SpiSequence_2_Spi5_Slave   ((Spi_SequenceType)2)
...
*     for all the driver configurations.
*/
#define SPI_SEQUENCE_MAX_COUNT  (3u)
 ...
 */
#define FCSPI3_BASEADDR                            (0x4043F000U)

/**
 * @brief        Peripheral SPI4 base address
 */
#define FCSPI4_BASEADDR                            (0x40440000U)

/**
 * @brief        Peripheral SPI5 base address
 */
#define FCSPI5_BASEADDR                            (0x40441000U)
...
#define FCSPI_1_ENABLED  (STD_ON)
#define FCSPI_2_ENABLED  (STD_ON)
#define FCSPI_3_ENABLED  (STD_OFF)
...
#define FCSPI_1_MODE   SPI_MODE_SYNC
#define FCSPI_2_MODE   SPI_MODE_ASYNC_FIFO
#define FCSPI_5_MODE   SPI_MODE_ASYNC_DMA

#define SPI_SLAVE_MODE_SUPPORT  ((STD_ON))


#define FCSPI_1_OFFSET  1u
...
*/
#define SPI_Spi_Flash_GD25Q32  ((Spi_ExternalDeviceType)0u)
#define SPI_SpiExternalDevice_0_Spi2  ((Spi_ExternalDeviceType)1u)
#define SPI_SpiExternalDevice_1_Spi5  ((Spi_ExternalDeviceType)2u)
...
#define SPI_TIMEOUT_COUNTER       ((sint32)((12000000u) / SPI_WAIT_LOOP_TICKS))
