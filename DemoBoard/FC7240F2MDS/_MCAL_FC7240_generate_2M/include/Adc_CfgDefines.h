 ...
 */
#define ADC_UNIT_NUM_CHANNELS               {32U, 32U}
 ...
 *
 */
#define ADC_USED_HW_UNITS                   1U

/**
 * @brief        Max number of used ADC units
 *
 */
#define ADC_USED_SARADC_UNITS               1U
 ...
 */
#define ADC_PTIMER_NUM_MODULES              2U
 ...
 */
#define AdcChannel_VR1                       0
#define AdcChannel_VR2                       1
#define AdcChannel_VBG                       2
#define AdcChannel_V25                       3
#define AdcChannel_TMU                       4

/**
 * @brief         Symbolic names of channels - TPS_ECUC_02108 compliant.
 */
#define AdcConf_AdcChannel_AdcChannel_VR1    0
#define AdcConf_AdcChannel_AdcChannel_VR2    1
#define AdcConf_AdcChannel_AdcChannel_VBG    2
#define AdcConf_AdcChannel_AdcChannel_V25    3
#define AdcConf_AdcChannel_AdcChannel_TMU    4
