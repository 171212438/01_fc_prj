...
#define MSC_UNALLOCATEDPAR_CORE_ID ((uint32)0x0U)
/**
...
* @brief        All CoreIDs are supported by Msc driver.
*/
#define Msc_MAX_PARTITIONS     ((uint32)1U)
...
*/
CDD_MSC_DATA_SECTION static const Msc_ChannelConfigType Msc_MscChannel_0_UnAllocatedPar=
{
    /* Partition core id of channel */
    MSC_UNALLOCATEDPAR_CORE_ID,
...
CDD_MSC_DATA_SECTION static const Msc_ConfigType Msc_Config =
{
    MSC_UNALLOCATEDPAR_CORE_ID,            /** Core Id */
    {
        /**
        * @brief   Configuration for Msc Channel 0.
        */
        &Msc_MscChannel_0_UnAllocatedPar,
    }
};
