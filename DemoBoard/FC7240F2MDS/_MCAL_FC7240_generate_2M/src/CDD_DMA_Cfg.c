...
DMA_DATA_SECTION static const Dma_ChannelConfigType DMA_Instance0_ChConfigData[] =
{
  ...
  DmaEnableChannelErrorInterrupt,DmaChannelFlowCtrl,DmaChannelTransferCompleteISRCallout,DmaChannelErrorISRCallout,u8DmaISRRouter,bInnerChannelSelfChain*/
    ...
    {0, 1, 1, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCSPI5_TX, SPI_FCSPI5_DMATxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 2, 2, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCSPI5_RX, SPI_FCSPI5_DMARxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 3, 3, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCIIC1_TX, FCIIC1_DMATxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 4, 4, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCIIC1_RX, FCIIC1_DMARxIsr, NULL_PTR, 0, (boolean)FALSE}
};
