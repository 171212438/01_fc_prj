...
{
    (Dio_PortLevelType)0xFFBFFFDFUL,
    (Dio_PortLevelType)0xFFFFFFFBUL,
    (Dio_PortLevelType)0xFFFFFFFFUL,
    (Dio_PortLevelType)0xFFFFBFFFUL,
    (Dio_PortLevelType)0x2FFFFFFFUL
};
...
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_LED1_CoreInfo[3] = {0x0,0x0,0x0};
/**
* @brief          CoreConfiguration of channel in configuration LED2.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_LED2_CoreInfo[3] = {0x0,0x0,0x0};
/**
* @brief          CoreConfiguration of channel in configuration LED3.
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_LED3_CoreInfo[3] = {0x0,0x0,0x0};
/**
...
DIO_DATA_SECTION const Dio_CoreConfigInfoType Dio_CoreConfigInfo[DioConf_DioChannel_CoreConfigInfo_NUM] = {
    ...
    {DioConf_DioPort_PTA, DioConf_DioChannel_LED2, DioConf_DioChannel_LED2_CoreInfo},
