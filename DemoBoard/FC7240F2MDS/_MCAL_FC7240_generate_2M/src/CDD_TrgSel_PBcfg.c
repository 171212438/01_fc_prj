...
TRGSEL_DATA_SECTION const TrgSel_OutputRegType TrgSel3_Config[TRGSEL3_NUM_REGS] =
    {
        ...
        ((TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL0_SHIFT_U32))|
         (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL3_SRC_TRGSEL_OUT0 << TRGSEL_SEL1_SHIFT_U32))|
        ...
        ((TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL3_SRC_TPU_CH6 << TRGSEL_SEL0_SHIFT_U32))|
         (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL3_SRC_TPU_CH1 << TRGSEL_SEL1_SHIFT_U32))|
         (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL2_SHIFT_U32))|
         (TRGSEL_SEL3_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL3_SHIFT_U32))|
         (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        ),
        ...
        ((TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL0_SHIFT_U32))|
         (TRGSEL_SEL1_MASK_U32 & ((uint32)TRGSEL3_SRC_TRGSEL_OUT3 << TRGSEL_SEL1_SHIFT_U32))|
         (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL2_SHIFT_U32))|
         (TRGSEL_SEL3_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL3_SHIFT_U32))|
         (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        ),
        ...
        ((TRGSEL_SEL0_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL0_SHIFT_U32))|
         ...
         (TRGSEL_SEL2_MASK_U32 & ((uint32)TRGSEL3_SRC_VSS << TRGSEL_SEL2_SHIFT_U32))|
         (TRGSEL_SEL3_MASK_U32 & ((uint32)TRGSEL3_SRC_FTU_IN3 << TRGSEL_SEL3_SHIFT_U32))|
         (TRGSEL_LK_BIT_MASK_U32 & (TRGSEL_LOCK_DIS_U32))
        )
    };
