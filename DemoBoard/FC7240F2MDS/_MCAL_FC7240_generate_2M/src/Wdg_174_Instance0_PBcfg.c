...
WDG_DATA_SECTION static const Wdg_LLDConfigType Wdg_Wdog_OffModeSettings_Instance0=
{
...
WDG_DATA_SECTION static const Wdg_LLDConfigType Wdg_Wdog_SlowModeSettings_0=
{
...
WDG_DATA_SECTION static const Wdg_LLDConfigType Wdg_Wdog_FastModeSettings_0=
{
    (uint32)( WDOG_CS_ENABLE_MASK | WDOG_CS_DLY_CNT_MSB(WDOG_REACTION_INT_128_CYCLE) | WDOG_CS_CLK_SEL(WDOG_FOSC_CLK) | WDOG_CS_TST(WDOG_TST_DISABLED) | WDOG_CS_PRESCALER_MASK | WDOG_CS_UPDATE_MASK ), /* WDG Control and configuration */
...
/* Reason: The object 'Wdg_Config_WDOG0' will be referenced in other modules and declared where it is used */
WDG_DATA_SECTION const Wdg_ConfigType Wdg_Config_WDOG0 =
{
    WDGIF_SLOW_MODE,
    WDG_HWL_INSTANCE0,
