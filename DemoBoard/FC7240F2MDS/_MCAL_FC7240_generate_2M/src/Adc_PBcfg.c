 ...
 *
 */
ADC_DATA_SECTION static const uint16 Adc_Group0_Delays_0[ADC_CFGSET_GROUP_0_CHANNELS] =
{
    0U,
    500U
};
...
ADC_DATA_SECTION static const Adc_ChannelConfigurationType Adc_ChannelsCfg_ADC0[] =
{
    ...
    /**< @brief Hardware Unit ADC0  --  ADC_SE10 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(10U),
        /**< @brief Adc channel resolution */
    ...
    /**< @brief Hardware Unit ADC0  --  V25_SE33 */
    {
        /**< @brief Adc physical channel */
        (Adc_ChannelType)(33U),
        /**< @brief Adc channel resolution */
