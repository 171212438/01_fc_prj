...
PWM_DATA_SECTION static const Pwm_Ftu_ModuleConfigType Pwm_FtuConfigModules[PWM_NUM_CONF_FTU_MODULES] =
{
    /* Ftu Module 0 */
    {
        ...
        (FTU_SC_CLKS(1) | FTU_SC_PS(0) | FTU_SC_CHNOUTEN( ((uint32)1U << (uint32)6U )| ((uint32)1U << (uint32)4U )| ((uint32)1U << (uint32)0U )| ((uint32)0)) | ((uint32)0)),
        ...
        (FTU_CHCTRL_SYNCEN3_MASK | FTU_CHCTRL_SYNCEN2_MASK | FTU_CHCTRL_SYNCEN0_MASK | ((uint32) 0)),

        /** @brief Default period value: 10000HZ*/
        ((Pwm_PeriodType) 12000),
    ...
    /* Ftu Module 1 */
    {
        ...
        /** @brief FTU_0_SC register */
        (FTU_SC_CLKS(1) | FTU_SC_PS(0) | FTU_SC_CHNOUTEN( ((uint32)1U << (uint32)6U )| ((uint32)1U << (uint32)2U )| ((uint32)1U << (uint32)0U )| ((uint32)0)) | ((uint32)0)),

        /** @brief External clock value */
        3U,

        /** @brief FTU_0_SYNC register */
        (FTU_SYNC_CNTMIN_MASK | ((uint32) 0)),

        /** @brief Configure fault operation mode and channel initialization status */
        ((uint32)0),

        /** @brief FTU_0_DEADTIME register */
        (FTU_DEADTIME_DTPS(1U) | ((uint32) 0U)),

        /** @brief  Edge alignment for the current channel  */
        ( PWM_EDGE_ALIGNED ),

        /** @brief FTU_0_COMBINE register */
        (FTU_CHCTRL_SYNCEN3_MASK | FTU_CHCTRL_SYNCEN1_MASK | FTU_CHCTRL_SYNCEN0_MASK | ((uint32) 0)),

        /** @brief Default period value: 10000HZ*/
        ((Pwm_PeriodType) 12000),

        /** @brief FTU_0_FLTCTRL register */
        ((uint32) 0),

        /** @brief FTU_0_FLTPOL register */
        ((uint32) 0),

        /** @brief FTU_0_PWMLOAD register */
        (uint32) (FTU_PWMLOAD_LDOK_MASK),

        /** @brief Fault notification callbacks */
        { NULL_PTR, NULL_PTR},

        /** @brief FTU_0_EXTTRIG register */
        ((uint32) 0U)
    },
    /* Ftu Module 2 */
    {
...
PWM_DATA_SECTION static const Pwm_ChannelType Pwm_FtuHw2LogicChannelMap[PWM_FTU_CHANNELS_NO] =
{
    ...
    3U, 0xFF, 4U, 0xFF, 0xFF, 0xFF, 5U, 0xFF,
    ...
    0U, 0xFF, 0xFF, 0xFF, 1U, 0xFF, 2U, 0xFF,
...
{
    1U, 0xFF, 0xFF, 0U, 0xFF, 0xFF, 0xFF, 2U
};
/**
