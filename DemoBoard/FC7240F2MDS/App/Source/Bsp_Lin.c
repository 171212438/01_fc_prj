...
#ifdef LIN_FCUART_4_ISR_USED
extern void Lin_IsrTxRx_FCUART_4(void);
void FCUART4_RxTx_IRQHandler(void)
{
    Lin_IsrTxRx_FCUART_4();
}
#endif

#ifdef LIN_FCUART_5_ISR_USED
extern void Lin_IsrTxRx_FCUART_5(void);
void FCUART5_RxTx_IRQHandler(void)
{
    Lin_IsrTxRx_FCUART_5();
}
#endif
...
void Bsp_Lin_Init(void)
{
    ...
    IntMgr_SetPriority(FCUART4_IRQn, 4);
    IntMgr_EnableInterrupt(FCUART4_IRQn);
    IntMgr_SetPriority(FCUART5_IRQn, 4);
    IntMgr_EnableInterrupt(FCUART5_IRQn);
}
