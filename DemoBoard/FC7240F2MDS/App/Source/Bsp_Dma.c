...
void Tlib_Dma_Channel0_Init(void)
{
    ...
    if (2 == Cpm_HWA_GetCoreId())
    {
        ...
        ret = Dma_ConfigChannel(DMA_INSTANCE_0, DMA_TEST_SW_CHANNEL_ID_CORE2, &TlibChannelConfig);
        #endif
    }
    else
#endif
...
#endif /* (DMA_TEST_TYPE==CIRCULARBUFFER)&&(DMA_TEST_SWITCH == DMA_TEST_SWITCH_ON) */
    if (ret == E_NOT_OK)
    {
...
static void Tlib_Dma_Channel6_Init(void)
{
    ...
    (void)Dma_ConfigChannel(DMA_INSTANCE_0, DMA_TEST_SW_CHANNEL_ID6, &TlibChannelConfig6);
}
#endif
void Bsp_Dma_Init(void)
{
    ...
    #elif (DMA_PRECOMPILE_SUPPORT == STD_OFF)
    Dma_Init(&Dma_Config);
    #endif
    ...
    /*Dma_EnableHwRequest(DMA_TEST_SW_CHANNEL_ID6);*/
