...
#define STCU_SRAM_INI_SEL_SRAM                      (1 << 0)
#define STCU_SRAM_INI_SEL_ITCM_CPU0                 (1 << 1)
#define STCU_SRAM_INI_SEL_DTCM0_CPU0                (1 << 2)
#define STCU_SRAM_INI_SEL_DTCM1_CPU0                (1 << 3)

#define STCU_SRAM_INI_SEL_ALL                                     \
  (STCU_SRAM_INI_SEL_SRAM       | STCU_SRAM_INI_SEL_ITCM_CPU0  |  \
   STCU_SRAM_INI_SEL_DTCM0_CPU0 | STCU_SRAM_INI_SEL_DTCM1_CPU0)

/* STCU_SRAM_INI_DONE_STATUS Fields */
#define STCU_SRAM_INI_DONE_STATUS_SRAM              (1 << 0)
#define STCU_SRAM_INI_DONE_STATUS_ITCM_CPU0         (1 << 1)
#define STCU_SRAM_INI_DONE_STATUS_DTCM0_CPU0        (1 << 2)
#define STCU_SRAM_INI_DONE_STATUS_DTCM1_CPU0        (1 << 3)
...
#define RGM_SRS_WDOG1                               (1 << 12) /* Bit 11:  Watchdog 1 Reset */
...
__attribute__((noreturn)) void system_init(void)
{
    ...
    REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET, 0x02AA8A2A);
    REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET, 0x00002922);
    ...
    REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET, 0x03FFCF3F);
    REG_WRITE32(SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET, 0x00003D33);
