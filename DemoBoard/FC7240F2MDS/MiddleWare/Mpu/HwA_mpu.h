 ...
 */
typedef struct {
    __I  uint32 MPU_TYPE; /* TYPE, offset: 0x0 */
    __IO uint32 MPU_CTRL; /* CTRL, offset: 0x4 */
    __IO uint32 MPU_RNR;  /* RNR,  offset: 0x8 */
    __IO uint32 MPU_RBAR; /* RBAR, offset: 0xC */
    __IO uint32 MPU_RASR; /* RASR, offset: 0x10 */
...
#define CORTEX_MPU_TYPE_IREGION(x)     (((uint32)(((uint32)(x))<<CORTEX_MPU_TYPE_IREGION_SHIFT))&CORTEX_MPU_TYPE_IREGION_MASK)
...
#define CORTEX_MPU_TYPE_DREGION(x)     (((uint32)(((uint32)(x))<<CORTEX_MPU_TYPE_DREGION_SHIFT))&CORTEX_MPU_TYPE_DREGION_MASK)
...
#define CORTEX_MPU_TYPE_SEPARATE(x)    (((uint32)(((uint32)(x))<<CORTEX_MPU_TYPE_SEPARATE_SHIFT))&CORTEX_MPU_TYPE_SEPARATE_MASK)
...
#define CORTEX_MPU_CTRL_RPRIVDEFENA(x) (((uint32)(((uint32)(x))<<CORTEX_MPU_CTRL_RPRIVDEFENA_SHIFT))&CORTEX_MPU_CTRL_RPRIVDEFENA_MASK)
...
#define CORTEX_MPU_CTRL_HFNMIENA(x)    (((uint32)(((uint32)(x))<<CORTEX_MPU_CTRL_HFNMIENA_SHIFT))&CORTEX_MPU_CTRL_HFNMIENA_MASK)
...
#define CORTEX_MPU_CTRL_ENABLE(x)      (((uint32)(((uint32)(x))<<CORTEX_MPU_CTRL_ENABLE_SHIFT))&CORTEX_MPU_CTRL_ENABLE_MASK)
...
#define CORTEX_MPU_RNR_REGION(x)       (((uint32)(((uint32)(x))<<CORTEX_MPU_RNR_REGION_SHIFT))&CORTEX_MPU_RNR_REGION_MASK)
...
#define CORTEX_MPU_RBAR_ADDR(x)        (((uint32)(((uint32)(x))<<CORTEX_MPU_RBAR_ADDR_SHIFT))&CORTEX_MPU_RBAR_ADDR_MASK)
...
#define CORTEX_MPU_RBAR_VALID(x)       (((uint32)(((uint32)(x))<<CORTEX_MPU_RBAR_VALID_SHIFT))&CORTEX_MPU_RBAR_VALID_MASK)
...
#define CORTEX_MPU_RBAR_REGION(x)      (((uint32)(((uint32)(x))<<CORTEX_MPU_RBAR_REGION_SHIFT))&CORTEX_MPU_RBAR_REGION_MASK)
...
#define CORTEX_MPU_RASR_ATTRS(x)       (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_ATTRS_SHIFT))&CORTEX_MPU_RASR_ATTRS_MASK)
...
#define CORTEX_MPU_RASR_XN(x)         (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_XN_SHIFT))&CORTEX_MPU_RASR_XN_MASK)
...
#define CORTEX_MPU_RASR_AP(x)         (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_AP_SHIFT))&CORTEX_MPU_RASR_AP_MASK)
...
#define CORTEX_MPU_RASR_TEX(x)         (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_TEX_SHIFT))&CORTEX_MPU_RASR_TEX_MASK)
...
#define CORTEX_MPU_RASR_S(x)         (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_S_SHIFT))&CORTEX_MPU_RASR_S_MASK)
...
#define CORTEX_MPU_RASR_C(x)         (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_C_SHIFT))&CORTEX_MPU_RASR_C_MASK)
...
#define CORTEX_MPU_RASR_B(x)         (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_B_SHIFT))&CORTEX_MPU_RASR_B_MASK)
...
#define CORTEX_MPU_RASR_SRD(x)         (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_SRD_SHIFT))&CORTEX_MPU_RASR_SRD_MASK)
...
#define CORTEX_MPU_RASR_SIZE(x)        (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_SIZE_SHIFT))&CORTEX_MPU_RASR_SIZE_MASK)
...
#define CORTEX_MPU_RASR_ENABLE(x)      (((uint32)(((uint32)(x))<<CORTEX_MPU_RASR_ENABLE_SHIFT))&CORTEX_MPU_RASR_ENABLE_MASK)
...
#define MPU_EN_MASK_U32 ((uint32)(CORTEX_MPU_CTRL_HFNMIENA_MASK | CORTEX_MPU_CTRL_RPRIVDEFENA_MASK))


#define MPU_REGION_MASK_U32  ((uint32)0xFF)
 ...
 * @return type value
 */
LOCAL_INLINE uint32  MPU_HWA_Get_Type(void)
{
...
{
    FC7XXX_SCB->SHCSR &= ~((uint32)FC7XXX_SCB_SHCSR_MEMFAULTENA_MASK);
}
 ...
 * @return LOCAL_INLINE 
 */
LOCAL_INLINE void  MPU_HWA_Set_CR(uint32 u32RegValue)
{
 ...
 * @return LOCAL_INLINE 
 */
LOCAL_INLINE void  MPU_HWA_Set_NR(uint8 u32RegValue)
{
 ...
 * @return LOCAL_INLINE 
 */
LOCAL_INLINE void  MPU_HWA_Set_BAR(uint32 u32RegValue)
{
 ...
 * @return LOCAL_INLINE 
 */
LOCAL_INLINE void  MPU_HWA_Set_ASR(uint32 u32RegValue)
{
