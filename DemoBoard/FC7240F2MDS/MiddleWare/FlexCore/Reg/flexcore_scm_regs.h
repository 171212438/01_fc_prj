#ifndef _FLEXCORE_SCM_REGS_H_
#define _FLEXCORE_SCM_REGS_H_
#ifdef __cplusplus
 extern "C" {
#endif
...
typedef struct {
  ...
  __IO uint32_t HSM_FLXC_PCC                  ; /* HSM_FLEXCORE_PCC Register, offset: 0x110 */
...
/* HSM_FLXC_PCC Bit Fields */

#define SCM_HSM_FLXC_PCC_WPB_LOCK_MASK 0x80000000u

#define SCM_HSM_FLXC_PCC_WPB_LOCK_SHIFT 31u

#define SCM_HSM_FLXC_PCC_WPB_LOCK_WIDTH 1u

#define SCM_HSM_FLXC_PCC_WPB_LOCK(x)   (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_WPB_LOCK_SHIFT))&SCM_HSM_FLXC_PCC_WPB_LOCK_MASK)

#define SCM_HSM_FLXC_PCC_WPB_MASK      0x70000000u

#define SCM_HSM_FLXC_PCC_WPB_SHIFT     28u

#define SCM_HSM_FLXC_PCC_WPB_WIDTH     3u

#define SCM_HSM_FLXC_PCC_WPB(x)        (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_WPB_SHIFT))&SCM_HSM_FLXC_PCC_WPB_MASK)

#define SCM_HSM_FLXC_PCC_CLKEN_TPU_MASK 0x2000000u

#define SCM_HSM_FLXC_PCC_CLKEN_TPU_SHIFT 25u

#define SCM_HSM_FLXC_PCC_CLKEN_TPU_WIDTH 1u

#define SCM_HSM_FLXC_PCC_CLKEN_TPU(x)  (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_CLKEN_TPU_SHIFT))&SCM_HSM_FLXC_PCC_CLKEN_TPU_MASK)

#define SCM_HSM_FLXC_PCC_CLKEN_HSM_ENGINE_MASK 0x1000000u

#define SCM_HSM_FLXC_PCC_CLKEN_HSM_ENGINE_SHIFT 24u

#define SCM_HSM_FLXC_PCC_CLKEN_HSM_ENGINE_WIDTH 1u

#define SCM_HSM_FLXC_PCC_CLKEN_HSM_ENGINE(x) (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_CLKEN_HSM_ENGINE_SHIFT))&SCM_HSM_FLXC_PCC_CLKEN_HSM_ENGINE_MASK)

#define SCM_HSM_FLXC_PCC_CLKEN_SUBSYS_MASK 0x800000u

#define SCM_HSM_FLXC_PCC_CLKEN_SUBSYS_SHIFT 23u

#define SCM_HSM_FLXC_PCC_CLKEN_SUBSYS_WIDTH 1u

#define SCM_HSM_FLXC_PCC_CLKEN_SUBSYS(x) (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_CLKEN_SUBSYS_SHIFT))&SCM_HSM_FLXC_PCC_CLKEN_SUBSYS_MASK)

#define SCM_HSM_FLXC_PCC_SWRST_MASK    0x10000u

#define SCM_HSM_FLXC_PCC_SWRST_SHIFT   16u

#define SCM_HSM_FLXC_PCC_SWRST_WIDTH   1u

#define SCM_HSM_FLXC_PCC_SWRST(x)      (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_SWRST_SHIFT))&SCM_HSM_FLXC_PCC_SWRST_MASK)

#define SCM_HSM_FLXC_PCC_WDG_RSTEN_MASK 0x10u

#define SCM_HSM_FLXC_PCC_WDG_RSTEN_SHIFT 4u

#define SCM_HSM_FLXC_PCC_WDG_RSTEN_WIDTH 1u

#define SCM_HSM_FLXC_PCC_WDG_RSTEN(x)  (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_WDG_RSTEN_SHIFT))&SCM_HSM_FLXC_PCC_WDG_RSTEN_MASK)

#define SCM_HSM_FLXC_PCC_STOP_REQ_MASK 0x1u

#define SCM_HSM_FLXC_PCC_STOP_REQ_SHIFT 0u

#define SCM_HSM_FLXC_PCC_STOP_REQ_WIDTH 1u

#define SCM_HSM_FLXC_PCC_STOP_REQ(x)   (((uint32_t)(((uint32_t)(x))<<SCM_HSM_FLXC_PCC_STOP_REQ_SHIFT))&SCM_HSM_FLXC_PCC_STOP_REQ_MASK)

/* HSM_FLXC_PCC Reg Mask */

#define SCM_HSM_FLXC_PCC_MASK          0xF3810011u



/* HSM_STATUS Bit Fields */

#define SCM_HSM_STATUS_HSM_SYS_ERR_MASK 0xFFFF0000u

#define SCM_HSM_STATUS_HSM_SYS_ERR_SHIFT 16u

#define SCM_HSM_STATUS_HSM_SYS_ERR_WIDTH 16u

#define SCM_HSM_STATUS_HSM_SYS_ERR(x)  (((uint32_t)(((uint32_t)(x))<<SCM_HSM_STATUS_HSM_SYS_ERR_SHIFT))&SCM_HSM_STATUS_HSM_SYS_ERR_MASK)
...
#define SCM_HSM_STATUS_TPU_CLK_EN_MASK 0x80u

#define SCM_HSM_STATUS_TPU_CLK_EN_SHIFT 7u

#define SCM_HSM_STATUS_TPU_CLK_EN_WIDTH 1u

#define SCM_HSM_STATUS_TPU_CLK_EN(x)   (((uint32_t)(((uint32_t)(x))<<SCM_HSM_STATUS_TPU_CLK_EN_SHIFT))&SCM_HSM_STATUS_TPU_CLK_EN_MASK)
...
#define SCM_HSM_STATUS_MASK            0xFFFF03FFu
