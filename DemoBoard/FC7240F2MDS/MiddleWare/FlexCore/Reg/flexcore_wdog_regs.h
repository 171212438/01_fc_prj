/**
 * @file flexcore_wdog_regs.h
 * @author Flagchip
 * @brief include wdog registers file
 * @version 0.1.0
 * @date 2023-12-28
 *
 ...
 *
 */
#ifndef _FLEXCORE_WDOG_REGS_H_
#define _FLEXCORE_WDOG_REGS_H_
#ifdef __cplusplus
 extern "C" {
#endif
...
typedef struct {
  ...
  __IO uint32_t CS                            ; /* CS, offset: 0x0 */

  __IO uint32_t COUNTER                       ; /* COUNTER, offset: 0x4 */

  __IO uint32_t TIMEOUT                       ; /* TIMEOUT, offset: 0x8 */

  __IO uint32_t WINDOW                        ; /* WINDOW, offset: 0xC */
...
#define WDOG_COUNTER                   0x0000FFFFu
...
#define WDOG_TIMEOUT                   0x0000FFFFu
...
#define WDOG_WINDOW                    0x0000FFFFu
...
#endif
#endif  /* #ifndef _FLEXCORE_WDOG_REGS_H_ */
