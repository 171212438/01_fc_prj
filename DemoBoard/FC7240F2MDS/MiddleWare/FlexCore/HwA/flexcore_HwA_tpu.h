/**
 * @file flexcore_HwA_tpu.h
 * @author Flagchip
 * @brief FC7xxx TPU hardware access layer
 * @version 0.1.0
 * @date 2024-1-12
 *
...
#ifndef _FLEXCORE_HWA_TPU_H_
#define _FLEXCORE_HWA_TPU_H_

#include "flexcore_device_header.h"
#include "flexcore_tpu_regs.h"
...
/**
 * @brief Set TCR1 cnt value.
 *
 */
LOCAL_INLINE void TPU_E_HWA_SetTCR1CntVal(TPU_E_Type *const pTPUE, uint32_t u32Val)
{
    pTPUE->TBR_T1R = (u32Val & TPU_E_TBR_T1R_TCR1_MASK);
}
...
/**
 * @brief Set TCR2 cnt value.
 *
 */
LOCAL_INLINE void TPU_E_HWA_SetTCR2CntVal(TPU_E_Type *const pTPUE, uint32_t u32Val)
{
    pTPUE->TBR_T2R = (u32Val & TPU_E_TBR_T2R_TCR2_MASK);
}
