#ifndef _FC7240_TPU_E_REGS_H_
#define _FC7240_TPU_E_REGS_H_
#ifdef __cplusplus
 extern "C" {
#endif
...
typedef struct {
  ...
  __IO uint32_t TBR_T2MR                      ; /* Time Base Region - TCR2 Maximum Register, offset: 0x114 */

  __IO uint32_t TBR_TRR                       ; /* Time Base Region - Tick Rate Register, offset: 0x118 */

  __IO uint32_t TBR_T1MR                      ; /* Time Base Region - TCR1 Maximum Register, offset: 0x11C */
