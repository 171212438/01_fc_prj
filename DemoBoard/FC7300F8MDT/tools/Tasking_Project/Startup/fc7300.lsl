...
derivative fc7xxx
{
    ...
    bus local_bus
    {
        mau = 8;
        width = 32;
        map (size=0x20000000-64k, src_offset=64k, dest_offset=64k, dest=bus:cm7_0:local_bus);
        map (size=0xe0000000-128k, src_offset=0x20000000+128k, dest_offset=0x20000000+128k, dest=bus:cm7_0:local_bus);
    }
