...
set Project_Name=_MCAL_multicore_generate_8M
...
for %%F in (../../../../MCAL/Src/Ospi/include/*.h)                  do ECHO ..\..\..\..\MCAL\Src\Ospi\include\%%F >> _SubProjects\%Project_Name%.gpj
for %%F in (../../../../MCAL/Src/Ospi/src/*.c)                      do ECHO ..\..\..\..\MCAL\Src\Ospi\src\%%F >> _SubProjects\%Project_Name%.gpj
