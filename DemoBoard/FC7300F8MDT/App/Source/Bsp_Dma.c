...
#define DMA_START_SEC_VAR_INIT_32_NO_CACHEABLE
...
DMA_DATA_SECTION uint32 TlibSrcBuf[6] = {0x1122, 0x3344, 0x5566, 0x7788, 0x99AA, 0xBBCC};
DMA_DATA_SECTION uint32 TlibSrcBuf1[6] = {0x1122, 0x3344, 0x5566, 0x7788, 0x99AA, 0xBBCC};
DMA_DATA_SECTION uint32 TlibSrcBuf2[6] = {0x1122, 0x3344, 0x5566, 0x7788, 0x99AA, 0xBBCC};
#ifdef DMA_TEST_CHTOCH
uint32 TlibSrcBuf6[6] = {0x1122, 0x3344, 0x5566, 0x7788, 0x99AA, 0xBBCC};
#endif
#define DMA_STOP_SEC_VAR_INIT_32_NO_CACHEABLE
#include "Dma_MemMap.h"

#define DMA_START_SEC_VAR_NO_INIT_32_NO_CACHEABLE
#include "Dma_MemMap.h"
DMA_DATA_SECTION uint32 TlibDesBuf[30] __attribute__((aligned(128)));
DMA_DATA_SECTION uint32 TlibDesBuf1[30] __attribute__((aligned(128)));
DMA_DATA_SECTION uint32 TlibDesBuf2[30] __attribute__((aligned(128)));
#ifdef DMA_TEST_CHTOCH
uint32 TlibDesBuf6[30];
#endif
#define DMA_STOP_SEC_VAR_NO_INIT_32_NO_CACHEABLE
#include "Dma_MemMap.h"
...
void Tlib_Dma_Channel0_Init(void)
{
    ...
    if (2 == Cpm_HWA_GetCoreId())
    {
        ...
        ret = Dma_ConfigChannel(DMA_TEST_SW_CHANNEL_ID_CORE2, &TlibChannelConfig);
        #endif
    }
    else if (1 == Cpm_HWA_GetCoreId())
    {
...
void Bsp_Dma_Init(void)
{
    ...
    if (0 == Cpm_HWA_GetCoreId())
    {
        ...
        IntMgr_EnableInterrupt(DMA5_IRQn);
        IntMgr_EnableInterrupt(DMA6_IRQn);
        IntMgr_EnableInterrupt(DMA7_IRQn);
        IntMgr_EnableInterrupt(DMA8_IRQn);
