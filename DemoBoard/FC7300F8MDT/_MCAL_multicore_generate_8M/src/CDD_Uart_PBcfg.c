...
UART_DATA_SECTION uint8 g_UartBufferIntelnal_0[UART_INTERNAL_BUFFER_SIZE_0] __attribute__ ((aligned (1024)));
UART_DATA_SECTION uint8 g_UartBufferToUser_0[UART_TO_USER_BUFFER_SIZE_0] __attribute__ ((aligned (1024)));
...
#if (UART_HAS_DMA_ENABLED == STD_ON)
    /* DMA instance number for DMA-based rx */
    DMA_INSTANCE_0,
    /* DMA channel number for DMA-based rx. */
    7U,
    /* DMA instance number for DMA-based tx */
    DMA_INSTANCE_0,
