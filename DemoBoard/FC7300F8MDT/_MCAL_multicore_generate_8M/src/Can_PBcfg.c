...
CAN_DATA_SECTION static const Can_MBConfigObjectType CanCfg_MessageBufferConfigs0_PB[CAN_MAXMBCOUNT_PB] =
{
    ...
    /* CanController6_Transmit0 Message Buffer of Can Controller ID = 6U, array index=21 */
    {
        ...
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x1cU, /* Hardware Object ID */
    ...
    /* CanController7_Transmit0 Message Buffer of Can Controller ID = 7U, array index=22 */
    {
        ...
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x1dU, /* Hardware Object ID */
    ...
    /* CanController8_Transmit0 Message Buffer of Can Controller ID = 8U, array index=23 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)8U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
        (Can_HwObjType)CAN_TRANSMIT, /* Receive/Transmit MB configuration */
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x1eU, /* Hardware Object ID */
        (Can_HwHandleType)0x17U, /* array index */
        #if (CAN_FD_MODE_ENABLE == STD_ON)
        (uint8)0U,
        #endif
        /* Read/Write period reference used when POLLING mode is selected for the controller */
    ...
    /* CanController9_Transmit0 Message Buffer of Can Controller ID = 9U, array index=24 */
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* u16IdMaskIndex */
        (uint8)9U, /* ControllerId  - based on the order from CanController list */
        (Can_IdTypeType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
        (Can_HwObjType)CAN_TRANSMIT, /* Receive/Transmit MB configuration */
        (Can_IdType)0x0U, /* MessageId */
        (uint8)0x0U, /* Local priority bits used for arbitration */
        (Can_HwHandleType)0x1fU, /* Hardware Object ID */
        (Can_HwHandleType)0x18U, /* array index */
        #if (CAN_FD_MODE_ENABLE == STD_ON)
        (uint8)0U,
        #endif
        /* Read/Write period reference used when POLLING mode is selected for the controller */
...
/* Compiler_Warning: this warning due to behavior of compiler depend on configs. */
CAN_DATA_SECTION static const Can_ControllerBaudrateConfigType CanHal_ControllerBaudrateCfgSet0_PB_8[CAN_CFGSET0_MAX_BAUDRATE_FC_8_8] =
{
    
    /* Configuration for CanController ID8 == FlexCAN_8 */
    {
        /* ===== Normal bit rate ENCBT register ===== */
        (uint32)(
                    (uint32)(((uint32)3U + ((uint32)7U) )<< FLEXCAN_ENCBT_NTSEG1_OFFSET_U8) |   /* time segment 1 */
...
/* Compiler_Warning: this warning due to behavior of compiler depend on configs. */
CAN_DATA_SECTION static const Can_ControllerBaudrateConfigType CanHal_ControllerBaudrateCfgSet0_PB_9[CAN_CFGSET0_MAX_BAUDRATE_FC_9_9] =
{
    
    /* Configuration for CanController ID9 == FlexCAN_9 */
    {
        /* ===== Normal bit rate ENCBT register ===== */
        (uint32)(
                    (uint32)(((uint32)3U + ((uint32)7U) )<< FLEXCAN_ENCBT_NTSEG1_OFFSET_U8) |   /* time segment 1 */
...
CAN_DATA_SECTION static const CanHal_ControlerInstanceType CanHal_ControlerConfig0_PB[CAN_MAXCONTROLLERCOUNT_0] =
{
    ...
    }, /* ControlerDescriptors CanController_7 end */

    /* ControlerDescriptor of CanController_8 */
    {
        /* ID source Wakeup of EcuM  */
        #if (CAN_ENABLE_WAKEUP_SUPPORT == STD_ON)
        (uint32)0U,
    ...
    }, /* ControlerDescriptors CanController_8 end */

    /* ControlerDescriptor of CanController_9 */
    {
        /* ID source Wakeup of EcuM  */
        #if (CAN_ENABLE_WAKEUP_SUPPORT == STD_ON)
        (uint32)0U,
...
CAN_DATA_SECTION static const uint16 CanCfg_CanController_8_Fifo_HrhObjIdList[1] = {
    (uint16)20U
};
#endif
...
CAN_DATA_SECTION static const uint16 CanCfg_CanController_9_Fifo_HrhObjIdList[1] = {
    (uint16)21U
};
#endif
/*================================================================================================*/
...
CAN_DATA_SECTION static const Can_ControlerInstanceType CanCfg_DriverConfig0_PB[CAN_MAXCONTROLLERCOUNT_0] =
{
    ...
    }, /* CanCfg_DriverConfig CanController_7 end */

    /* ControlerDescriptor of CanController_8*/
    {
        /* No. of Message Buffers for current controller - u8MaxMBCount */
        (uint8)1U, /* No. of Message Buffers for current controller - u8MaxMBCount */
        ...
        /* pControllerBaudrateConfigsPtr - pControllerBaudrateConfigsPtr*/
        CanHal_ControllerBaudrateCfgSet0_PB_8,
        
        #if (CAN_ENHANCED_RXFIFO_ENABLE == STD_ON) || ((CAN_LEGACY_RXFIFO_ENABLE == STD_ON))
        /* Fifo RX HRH index value */
        
        (uint16*)CanCfg_CanController_8_Fifo_HrhObjIdList,
        (uint8)1U,
        #endif
    ...
    }, /* CanCfg_DriverConfig CanController_8 end */
    ...
    /* ControlerDescriptor of CanController_9*/
    {
        ...
        /* pControllerBaudrateConfigsPtr - pControllerBaudrateConfigsPtr*/
        CanHal_ControllerBaudrateCfgSet0_PB_9,
        
        #if (CAN_ENHANCED_RXFIFO_ENABLE == STD_ON) || ((CAN_LEGACY_RXFIFO_ENABLE == STD_ON))
        /* Fifo RX HRH index value */
        
        (uint16*)CanCfg_CanController_9_Fifo_HrhObjIdList,
        (uint8)1U,
        #endif
