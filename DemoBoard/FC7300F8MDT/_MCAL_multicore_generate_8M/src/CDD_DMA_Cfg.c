...
DMA_TEXT_SECTION extern void FCIIC1_DMARxIsr(void);

DMA_TEXT_SECTION extern void SPI_FCSPI4_DMARxIsr(void);

DMA_TEXT_SECTION extern void FCIIC1_DMATxIsr(void);

DMA_TEXT_SECTION extern void SPI_FCSPI4_DMATxIsr(void);

DMA_TEXT_SECTION extern void OSPI_DMARxIsr(void);

DMA_TEXT_SECTION extern void SPI_FCSPI5_DMARxIsr(void);

DMA_TEXT_SECTION extern void OSPI_DMATxIsr(void);

DMA_TEXT_SECTION extern void SPI_FCSPI5_DMATxIsr(void);

DMA_TEXT_SECTION extern void FCIIC1_DMARxIsr(void);

DMA_TEXT_SECTION extern void FCIIC1_DMATxIsr(void);

DMA_TEXT_SECTION extern void FCUart_DMARxIsr(void);

DMA_TEXT_SECTION extern void FCUart_DMATxIsr(void);
...
DMA_DATA_SECTION static const Dma_ChannelConfigType DMA_Instance0_ChConfigData[] =
{
  ...
  DmaEnableChannelErrorInterrupt,DmaChannelFlowCtrl,DmaChannelTransferCompleteISRCallout,DmaChannelErrorISRCallout,u8DmaISRRouter,bInnerChannelSelfChain*/
    ...
    {0, 1, 1, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCIIC1_RX, FCIIC1_DMARxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 2, 2, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCIIC1_TX, FCIIC1_DMATxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 3, 3, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_OSPI_RX, OSPI_DMARxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 4, 4, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_OSPI_TX, OSPI_DMATxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 5, 5, (boolean)FALSE, (boolean)FALSE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FLEXCAN8, NULL_PTR, NULL_PTR, 0, (boolean)FALSE},
    {0, 6, 6, (boolean)FALSE, (boolean)FALSE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_DISABLED, NULL_PTR, NULL_PTR, 0, (boolean)FALSE},
    {0, 7, 7, (boolean)FALSE, (boolean)TRUE, (boolean)TRUE, (boolean)FALSE, DMA_REQ_FCUART1_RX, FCUart_DMARxIsr, NULL_PTR, 0, (boolean)FALSE},
    {0, 8, 8, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCUART1_TX, FCUart_DMATxIsr, NULL_PTR, 0, (boolean)FALSE}
};
DMA_DATA_SECTION static const Dma_ChannelConfigType DMA_Instance1_ChConfigData[] =
{
    /*PartitionId, DmaChannelID, DmaChannelPriority,DmaEnablePeriodTriggerMode,DmaEnableChannelCompeletInterrupt,DmaEnableChannelHalfCompeletInterrupt,
  DmaEnableChannelErrorInterrupt,DmaChannelFlowCtrl,DmaChannelTransferCompleteISRCallout,DmaChannelErrorISRCallout,u8DmaISRRouter,bInnerChannelSelfChain*/
    {1, 0, 0, (boolean)FALSE, (boolean)FALSE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_DISABLED, NULL_PTR, NULL_PTR, 1,(boolean)TRUE},
    {1, 1, 1, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCSPI4_RX, SPI_FCSPI4_DMARxIsr, NULL_PTR, 1,(boolean)FALSE},
    {1, 2, 2, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCSPI4_TX, SPI_FCSPI4_DMATxIsr, NULL_PTR, 1,(boolean)FALSE},
    {1, 3, 3, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCSPI5_RX, SPI_FCSPI5_DMARxIsr, NULL_PTR, 1,(boolean)FALSE},
    {1, 4, 4, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCSPI5_TX, SPI_FCSPI5_DMATxIsr, NULL_PTR, 1,(boolean)FALSE},
    {1, 5, 5, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCIIC1_RX, FCIIC1_DMARxIsr, NULL_PTR, 1,(boolean)FALSE},
    {1, 6, 6, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, (boolean)FALSE, DMA_REQ_FCIIC1_TX, FCIIC1_DMATxIsr, NULL_PTR, 1,(boolean)FALSE}
};
