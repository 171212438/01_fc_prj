...
LIN_DATA_SECTION const Lin_ChannelType Lin_LinChannel_2_PC=
{
    (uint8)2U,    /* Lin Channel ID */
    FCUART_17,     /* Lin Hardware channel*/
    (uint8)STD_OFF,    /* Wakeup support disabled */
    LIN_NONE_ECUM_WAKEUP_SOURCE_REF,    /* None Wakeup Source was referred */
    LIN_FCUART_ECUCPARTITION_2_CORE_ID,                /* Core id of channel*/
};
LIN_DATA_SECTION const Lin_ChannelType Lin_LinChannel_3_PC=
{
    (uint8)3U,    /* Lin Channel ID */
    FCUART_7,     /* Lin Hardware channel*/
    (uint8)STD_OFF,    /* Wakeup support disabled */
    LIN_NONE_ECUM_WAKEUP_SOURCE_REF,    /* None Wakeup Source was referred */
