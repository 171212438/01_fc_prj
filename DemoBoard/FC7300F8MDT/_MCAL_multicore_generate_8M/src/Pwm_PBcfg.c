...
PWM_DATA_SECTION static const Pwm_Ftu_ModuleConfigType Pwm_FtuConfigModules[PWM_NUM_CONF_FTU_MODULES] =
{
    /* Ftu Module 0 */
    {
        ...
        ((uint32) 0U|((uint32)FTU_TRIGCONF_RELOADTRIGEN_MASK)),
        {
...
PWM_DATA_SECTION static const Pwm_ChannelType Pwm_FtuHw2LogicChannelMap[PWM_FTU_CHANNELS_NO] =
{
    ...
    0xFF, 0U, 0xFF, 1U, 0xFF, 2U, 0xFF, 0xFF,
    ...
    /* Channels 0-7 -> FTU_8 in the array of logic Pwm channels */
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    /* Channels 0-7 -> FTU_9 in the array of logic Pwm channels */
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    /* Channels 0-7 -> FTU_10 in the array of logic Pwm channels */
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    /* Channels 0-7 -> FTU_11 in the array of logic Pwm channels */
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
};
/**
...
{
    0xFF, 0U, 2U, 0xFF, 0xFF, 0xFF, 0xFF, 1U, 0xFF, 0xFF, 0xFF, 0xFF
};
/**
