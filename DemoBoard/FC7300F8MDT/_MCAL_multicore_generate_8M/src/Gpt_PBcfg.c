...
GPT_DATA_SECTION static const Gpt_ConfigChannelType Gpt_InitChannelPB[MAX_CONFIGURED_CHANNELS_U8] =
{
...

    {
        .tGptChannelCommonConfig = {
            .u8GptChannel = (uint8)(GPT_FTU_CH_0), /* GPT physical channel no. */
            .eGptModule = (Gpt_ModuleType)(GPT_MODULE_FTU_6), /* hardware module ID */
            .eGptChannelMode = (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
            .u32GptChannelTickValueMax = (Gpt_ValueType)(65535U), /* Maximum ticks value*/
            .bGptDebugModeEnable = (boolean)(FALSE), /* Debug Mode Enable/Disable */
            .u32GptWakeupSource = (uint32)0U, /* Wakeup source information */
...
GPT_DATA_SECTION static const Gpt_ChannelType GPT_HW2ChannelMap[MAX_GPT_CHANNEL_NUM] =
{
        ...
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance2, /*mapping of FTU_6_CH_0*/
        GptConf_GptChannelConfiguration_GptChannel_WDGInstance2Condition, /*mapping of FTU_6_CH_1*/
        ...
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_8_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_9_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_10_CH_7*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_0*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_1*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_2*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_3*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_4*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_5*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_6*/
        GPT_HW_CHANNEL_UNUSED, /*mapping of FTU_11_CH_7*/
