...
DIO_DATA_SECTION const Dio_PortLevelType Dio_u32ValidPortPins[DIO_NUM_PORTS_U16] =
{
    ...
    (Dio_PortLevelType)0xFFFFF7FBUL,
...
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_ETH_PMYMODECFG0_CoreInfo[3] = {0x1,0x1,0x1};
/**
...
*/
DIO_DATA_SECTION const uint32 DioConf_DioChannel_ETH_PMYMODECFG2_CoreInfo[3] = {0x1,0x1,0x1};
/**
