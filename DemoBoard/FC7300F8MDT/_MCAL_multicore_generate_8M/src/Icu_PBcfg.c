...
ICU_DATA_SECTION static const Icu_ChannelConfigType Icu_InitChannel[3] =
{
    {
...
ICU_DATA_SECTION static const Icu_ChannelType Icu_HwMap[ICU_HW_CHANNEL_COUNT] =
{
    ...
    ICU_NOICUCHANNEL,/*FTU_8_CH_0*/
    ICU_NOICUCHANNEL,/*FTU_8_CH_1*/
    ICU_NOICUCHANNEL,/*FTU_8_CH_2*/
    ICU_NOICUCHANNEL,/*FTU_8_CH_3*/
    ICU_NOICUCHANNEL,/*FTU_8_CH_4*/
    ICU_NOICUCHANNEL,/*FTU_8_CH_5*/
    ICU_NOICUCHANNEL,/*FTU_8_CH_6*/
    ICU_NOICUCHANNEL,/*FTU_8_CH_7*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_0*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_1*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_2*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_3*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_4*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_5*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_6*/
    ICU_NOICUCHANNEL,/*FTU_9_CH_7*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_0*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_1*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_2*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_3*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_4*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_5*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_6*/
    ICU_NOICUCHANNEL,/*FTU_10_CH_7*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_0*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_1*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_2*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_3*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_4*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_5*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_6*/
    ICU_NOICUCHANNEL,/*FTU_11_CH_7*/
    ...
    ICU_NOICUCHANNEL,/*CMP1*/
    ICU_NOICUCHANNEL,/*CMP2*/
    ...
    ICU_NOICUCHANNEL,/*ISM_CH_8*/
    ICU_NOICUCHANNEL,/*ISM_CH_9*/
    ICU_NOICUCHANNEL,/*ISM_CH_10*/
    ICU_NOICUCHANNEL,/*ISM_CH_11*/
    ICU_NOICUCHANNEL,/*ISM_CH_12*/
    ICU_NOICUCHANNEL,/*ISM_CH_13*/
    ICU_NOICUCHANNEL,/*ISM_CH_14*/
    ICU_NOICUCHANNEL,/*ISM_CH_15*/
