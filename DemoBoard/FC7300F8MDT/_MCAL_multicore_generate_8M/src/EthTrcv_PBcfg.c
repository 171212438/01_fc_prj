...
extern void MiiPinSelect(boolean xBaseT1);
...
{
    {
        ...
        /* .MacLayerSpeed = */ ETHTRCV_BAUD_RATE_1000MBIT,
        /* .PhyIf = */ ETHTRCV_PHYIF_RGMII,
        /* .PhysLayer = */ ETHTRCV_PHYS_LAYER_TYPE_1000BASE_T,
        ...
        /* .TrcvSpeed = */ ETHTRCV_BAUD_RATE_1000MBIT,
