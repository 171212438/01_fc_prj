...
/*==================================================================================================
                               INTERRUPT SERVICE ROUTINES FOR FLEXCAN 6
==================================================================================================*/
#ifdef CAN_CAN6_CONTROLLER_ID

/**
 * @brief CAN 6 Interrupt Routine Service. [SWS_Can_00033]
 * [SWDESG_CAN_179][SWDESG_CAN_180][SWDESG_CAN_182]
 */
/* PRQA S 1503 ++ #Misra-C:2012 Rule-2.1 A project shall not contain unreachable code
    * Reason: The function is not used in this project but it must be applied for user*/
...
/* PRQA S 3006 ++ #Misra-C:2012 Dir-4.3 This function contains a mixture of in-line assembler
    * statements and C statements. Reason: this must call asm */
CAN_TEXT_SECTION ISR(Can_IsrCAN6_All)
{
/* Controller hardware offset on chip. */
#if (CAN_6_RXINT_SUPPORTED == STD_ON) ||                                      \
    (CAN_6_TXINT_SUPPORTED == STD_ON) || (CAN_SUPPORT_MULTICORE == STD_ON) || \
    (CAN_6_ERROR_NOTIFICATION_ENABLE == STD_ON) ||                            \
    (CAN_6_BUSOFFINT_SUPPORTED == STD_ON)
    uint8 u8ControllerId = CAN_CAN6_CONTROLLER_ID;
#endif

#if ((FLEXCAN6_ERROR_ISR == STD_OFF) &&              \
     ((CAN_6_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
      (CAN_6_BUSOFFINT_SUPPORTED == STD_ON))) ||     \
    ((CAN_6_RXINT_SUPPORTED == STD_ON) ||            \
     (CAN_6_TXINT_SUPPORTED == STD_ON))

    uint32 can_status = 0U;
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_6_INDEX);
#endif
...
#if (CAN_ERROR_NOTIFICATION_ENABLE == STD_ON)
/* read err status and process error */
#if (CAN_6_ERROR_NOTIFICATION_ENABLE == STD_ON)
        can_status = Can_Hw_GetErrorStatus(u32CanAddr);
...
#if (CAN_BUSOFFINT_SUPPORTED == STD_ON)
#if (CAN_6_BUSOFFINT_SUPPORTED == STD_ON)
        if (E_OK == Can_Hw_ChkBusOffStatus(u32CanAddr))
        {
            Can_FlexCan_BusOff(u8ControllerId, u32CanAddr);
        }
#endif
#endif /* #if (CAN_BUSOFFINT_SUPPORTED == STD_ON) */
#endif /* FLEXCAN6_ERROR_ISR == STD_OFF */

#if (CAN_TX_RX_INTRRUPT_SUPPORTED == STD_ON)
#if ((CAN_6_RXINT_SUPPORTED == STD_ON) || \
     (CAN_6_TXINT_SUPPORTED == STD_ON))

#if (CAN_6_LEGACY_FIFO_EN == STD_OFF)
...
#if (CAN_6_ENHANCED_FIFO_EN == STD_ON)
        can_status |= Can_Hw_GetEnhancedFifoInterruptStatus(u32CanAddr);
#endif
...
#endif /* #if (CAN_6_LEGACY_FIFO_EN == STD_OFF) */

#endif /* #if ((CAN_6_RXINT_SUPPORTED == STD_ON) || \
          (CAN_6_TXINT_SUPPORTED == STD_ON)) */
...
/**
 * @brief CAN 6 Error Interrupt Routine Service
 *
 */
CAN_TEXT_SECTION ISR(Can_IsrErrorCAN6_All)
{
    /* Controller hardware offset on chip. */
#if (CAN_SUPPORT_MULTICORE == STD_ON) ||                                \
    (CAN_6_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
    ...
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_6_INDEX);
#endif /* #if (CAN_6_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
          (CAN_6_BUSOFFINT_SUPPORTED == STD_ON) */
...
#endif /* FLEXCAN6_ERROR_ISR == STD_ON */

#endif /* CAN_CAN6_CONTROLLER_ID */

       
       
/*==================================================================================================
                               INTERRUPT SERVICE ROUTINES FOR FLEXCAN 7
==================================================================================================*/
#ifdef CAN_CAN7_CONTROLLER_ID

/**
 * @brief CAN 7 Interrupt Routine Service. [SWS_Can_00033]
 * [SWDESG_CAN_179][SWDESG_CAN_180][SWDESG_CAN_182]
 */
/* PRQA S 1503 ++ #Misra-C:2012 Rule-2.1 A project shall not contain unreachable code
    * Reason: The function is not used in this project but it must be applied for user*/
...
/* PRQA S 3006 ++ #Misra-C:2012 Dir-4.3 This function contains a mixture of in-line assembler
    * statements and C statements. Reason: this must call asm */
CAN_TEXT_SECTION ISR(Can_IsrCAN7_All)
{
/* Controller hardware offset on chip. */
#if (CAN_7_RXINT_SUPPORTED == STD_ON) ||                                      \
    (CAN_7_TXINT_SUPPORTED == STD_ON) || (CAN_SUPPORT_MULTICORE == STD_ON) || \
    (CAN_7_ERROR_NOTIFICATION_ENABLE == STD_ON) ||                            \
    (CAN_7_BUSOFFINT_SUPPORTED == STD_ON)
    uint8 u8ControllerId = CAN_CAN7_CONTROLLER_ID;
#endif

#if ((FLEXCAN7_ERROR_ISR == STD_OFF) &&              \
     ((CAN_7_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
      (CAN_7_BUSOFFINT_SUPPORTED == STD_ON))) ||     \
    ((CAN_7_RXINT_SUPPORTED == STD_ON) ||            \
     (CAN_7_TXINT_SUPPORTED == STD_ON))

    uint32 can_status = 0U;
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_7_INDEX);
#endif
...
#if (CAN_ERROR_NOTIFICATION_ENABLE == STD_ON)
/* read err status and process error */
#if (CAN_7_ERROR_NOTIFICATION_ENABLE == STD_ON)
        can_status = Can_Hw_GetErrorStatus(u32CanAddr);
...
#if (CAN_BUSOFFINT_SUPPORTED == STD_ON)
#if (CAN_7_BUSOFFINT_SUPPORTED == STD_ON)
        if (E_OK == Can_Hw_ChkBusOffStatus(u32CanAddr))
        {
            Can_FlexCan_BusOff(u8ControllerId, u32CanAddr);
        }
#endif
#endif /* #if (CAN_BUSOFFINT_SUPPORTED == STD_ON) */
#endif /* FLEXCAN7_ERROR_ISR == STD_OFF */

#if (CAN_TX_RX_INTRRUPT_SUPPORTED == STD_ON)
#if ((CAN_7_RXINT_SUPPORTED == STD_ON) || \
     (CAN_7_TXINT_SUPPORTED == STD_ON))

#if (CAN_7_LEGACY_FIFO_EN == STD_OFF)
...
#if (CAN_7_ENHANCED_FIFO_EN == STD_ON)
        can_status |= Can_Hw_GetEnhancedFifoInterruptStatus(u32CanAddr);
#endif
...
#endif /* #if (CAN_7_LEGACY_FIFO_EN == STD_OFF) */

#endif /* #if ((CAN_7_RXINT_SUPPORTED == STD_ON) || \
          (CAN_7_TXINT_SUPPORTED == STD_ON)) */
...
/**
 * @brief CAN 7 Error Interrupt Routine Service
 *
 */
CAN_TEXT_SECTION ISR(Can_IsrErrorCAN7_All)
{
    /* Controller hardware offset on chip. */
#if (CAN_SUPPORT_MULTICORE == STD_ON) ||                                \
    (CAN_7_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
    ...
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_7_INDEX);
#endif /* #if (CAN_7_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
          (CAN_7_BUSOFFINT_SUPPORTED == STD_ON) */
...
#endif /* FLEXCAN7_ERROR_ISR == STD_ON */

#endif /* CAN_CAN7_CONTROLLER_ID */

       
       
/*==================================================================================================
                               INTERRUPT SERVICE ROUTINES FOR FLEXCAN 8
==================================================================================================*/
#ifdef CAN_CAN8_CONTROLLER_ID

/**
 * @brief CAN 8 Interrupt Routine Service. [SWS_Can_00033]
 * [SWDESG_CAN_179][SWDESG_CAN_180][SWDESG_CAN_182]
 */
/* PRQA S 1503 ++ #Misra-C:2012 Rule-2.1 A project shall not contain unreachable code
    * Reason: The function is not used in this project but it must be applied for user*/
...
/* PRQA S 3006 ++ #Misra-C:2012 Dir-4.3 This function contains a mixture of in-line assembler
    * statements and C statements. Reason: this must call asm */
CAN_TEXT_SECTION ISR(Can_IsrCAN8_All)
{
/* Controller hardware offset on chip. */
#if (CAN_8_RXINT_SUPPORTED == STD_ON) ||                                      \
    (CAN_8_TXINT_SUPPORTED == STD_ON) || (CAN_SUPPORT_MULTICORE == STD_ON) || \
    (CAN_8_ERROR_NOTIFICATION_ENABLE == STD_ON) ||                            \
    (CAN_8_BUSOFFINT_SUPPORTED == STD_ON)
    uint8 u8ControllerId = CAN_CAN8_CONTROLLER_ID;
#endif

#if ((FLEXCAN8_ERROR_ISR == STD_OFF) &&              \
     ((CAN_8_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
      (CAN_8_BUSOFFINT_SUPPORTED == STD_ON))) ||     \
    ((CAN_8_RXINT_SUPPORTED == STD_ON) ||            \
     (CAN_8_TXINT_SUPPORTED == STD_ON))

    uint32 can_status = 0U;
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_8_INDEX);
#endif
...
#if (CAN_ERROR_NOTIFICATION_ENABLE == STD_ON)
/* read err status and process error */
#if (CAN_8_ERROR_NOTIFICATION_ENABLE == STD_ON)
        can_status = Can_Hw_GetErrorStatus(u32CanAddr);
...
#if (CAN_BUSOFFINT_SUPPORTED == STD_ON)
#if (CAN_8_BUSOFFINT_SUPPORTED == STD_ON)
        if (E_OK == Can_Hw_ChkBusOffStatus(u32CanAddr))
        {
            Can_FlexCan_BusOff(u8ControllerId, u32CanAddr);
        }
#endif
#endif /* #if (CAN_BUSOFFINT_SUPPORTED == STD_ON) */
#endif /* FLEXCAN8_ERROR_ISR == STD_OFF */

#if (CAN_TX_RX_INTRRUPT_SUPPORTED == STD_ON)
#if ((CAN_8_RXINT_SUPPORTED == STD_ON) || \
     (CAN_8_TXINT_SUPPORTED == STD_ON))

#if (CAN_8_LEGACY_FIFO_EN == STD_OFF)
...
#if (CAN_8_ENHANCED_FIFO_EN == STD_ON)
        can_status |= Can_Hw_GetEnhancedFifoInterruptStatus(u32CanAddr);
#endif
...
#endif /* #if (CAN_8_LEGACY_FIFO_EN == STD_OFF) */

#endif /* #if ((CAN_8_RXINT_SUPPORTED == STD_ON) || \
          (CAN_8_TXINT_SUPPORTED == STD_ON)) */
...
#if FLEXCAN8_ERROR_ISR == STD_ON
/**
 * @brief CAN 8 Error Interrupt Routine Service
 *
 */
CAN_TEXT_SECTION ISR(Can_IsrErrorCAN8_All)
{
    /* Controller hardware offset on chip. */
#if (CAN_SUPPORT_MULTICORE == STD_ON) ||                                \
    (CAN_8_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
    ...
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_8_INDEX);
#endif /* #if (CAN_8_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
          (CAN_8_BUSOFFINT_SUPPORTED == STD_ON) */
...
#endif /* FLEXCAN8_ERROR_ISR == STD_ON */

#endif /* CAN_CAN8_CONTROLLER_ID */

       
       
/*==================================================================================================
                               INTERRUPT SERVICE ROUTINES FOR FLEXCAN 9
==================================================================================================*/
#ifdef CAN_CAN9_CONTROLLER_ID

/**
 * @brief CAN 9 Interrupt Routine Service. [SWS_Can_00033]
 * [SWDESG_CAN_179][SWDESG_CAN_180][SWDESG_CAN_182]
 */
/* PRQA S 1503 ++ #Misra-C:2012 Rule-2.1 A project shall not contain unreachable code
    * Reason: The function is not used in this project but it must be applied for user*/
...
/* PRQA S 3006 ++ #Misra-C:2012 Dir-4.3 This function contains a mixture of in-line assembler
    * statements and C statements. Reason: this must call asm */
CAN_TEXT_SECTION ISR(Can_IsrCAN9_All)
{
/* Controller hardware offset on chip. */
#if (CAN_9_RXINT_SUPPORTED == STD_ON) ||                                      \
    (CAN_9_TXINT_SUPPORTED == STD_ON) || (CAN_SUPPORT_MULTICORE == STD_ON) || \
    (CAN_9_ERROR_NOTIFICATION_ENABLE == STD_ON) ||                            \
    (CAN_9_BUSOFFINT_SUPPORTED == STD_ON)
    uint8 u8ControllerId = CAN_CAN9_CONTROLLER_ID;
#endif

#if ((FLEXCAN9_ERROR_ISR == STD_OFF) &&              \
     ((CAN_9_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
      (CAN_9_BUSOFFINT_SUPPORTED == STD_ON))) ||     \
    ((CAN_9_RXINT_SUPPORTED == STD_ON) ||            \
     (CAN_9_TXINT_SUPPORTED == STD_ON))

    uint32 can_status = 0U;
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_9_INDEX);
#endif
...
#if (CAN_ERROR_NOTIFICATION_ENABLE == STD_ON)
/* read err status and process error */
#if (CAN_9_ERROR_NOTIFICATION_ENABLE == STD_ON)
        can_status = Can_Hw_GetErrorStatus(u32CanAddr);
...
#if (CAN_BUSOFFINT_SUPPORTED == STD_ON)
#if (CAN_9_BUSOFFINT_SUPPORTED == STD_ON)
        if (E_OK == Can_Hw_ChkBusOffStatus(u32CanAddr))
        {
            Can_FlexCan_BusOff(u8ControllerId, u32CanAddr);
        }
#endif
#endif /* #if (CAN_BUSOFFINT_SUPPORTED == STD_ON) */
#endif /* FLEXCAN9_ERROR_ISR == STD_OFF */

#if (CAN_TX_RX_INTRRUPT_SUPPORTED == STD_ON)
#if ((CAN_9_RXINT_SUPPORTED == STD_ON) || \
     (CAN_9_TXINT_SUPPORTED == STD_ON))

#if (CAN_9_LEGACY_FIFO_EN == STD_OFF)
...
#if (CAN_9_ENHANCED_FIFO_EN == STD_ON)
        can_status |= Can_Hw_GetEnhancedFifoInterruptStatus(u32CanAddr);
#endif
...
#endif /* #if (CAN_9_LEGACY_FIFO_EN == STD_OFF) */

#endif /* #if ((CAN_9_RXINT_SUPPORTED == STD_ON) || \
          (CAN_9_TXINT_SUPPORTED == STD_ON)) */
...
#if FLEXCAN9_ERROR_ISR == STD_ON
/**
 * @brief CAN 9 Error Interrupt Routine Service
 *
 */
CAN_TEXT_SECTION ISR(Can_IsrErrorCAN9_All)
{
    /* Controller hardware offset on chip. */
#if (CAN_SUPPORT_MULTICORE == STD_ON) ||                                \
    (CAN_9_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
    ...
    uint32 u32CanAddr;
    u32CanAddr = Can_Hw_GetCanBaseAddr(FLEXCAN_9_INDEX);
#endif /* #if (CAN_9_ERROR_NOTIFICATION_ENABLE == STD_ON) || \
          (CAN_9_BUSOFFINT_SUPPORTED == STD_ON) */
...
#endif /* FLEXCAN9_ERROR_ISR == STD_ON */

#endif /* CAN_CAN9_CONTROLLER_ID */
