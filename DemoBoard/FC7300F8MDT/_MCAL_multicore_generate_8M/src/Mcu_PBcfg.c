...
MCU_DATA_SECTION static const SCG_ClockType SCG_ClockConfig0 =
{
    ...
    /* PLL0 Configuration */
    {TRUE, FALSE, FALSE, FALSE, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY4, 11U, 299U, SCG_PLLSOURCE_FOSC,SCG_PLLPSTDIV_BY2,NULL_PTR}, 
    /* PLL1 Configuration */
    {TRUE, FALSE, FALSE, FALSE, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY2, SCG_ASYNCCLOCKDIV_BY4, 11U, 249U, SCG_PLLSOURCE_FOSC,SCG_PLLPSTDIV_BY2,NULL_PTR}, 
    /* SOSC Configuration */
...
MCU_DATA_SECTION static const CLOCK_CSC0_ConfigType CLOCK_CSC0_Config0 =
{
    ...
    {FALSE, CSC0_CLKOUT_128K_CLK, CSC0_CLKOUT_DIV_BY1}, 
...
MCU_DATA_SECTION static const PCC_CLKCtrlType PCC_Config0[65U] =
{
    ...
    {(uint32)0x104, (uint32)0x10800000}, /* CMP1 */
    {(uint32)0x108, (uint32)0x10800000}, /* CMP2 */
    ...
    {(uint32)0x180, (uint32)0x10900000}, /* FTU4 */
    {(uint32)0x39C, (uint32)0x10900000}, /* FCUART17 */
    ...
    {(uint32)0x400, (uint32)0x30800000}, /* FTU7 */
    ...
    {(uint32)0x184, (uint32)0x20900000}, /* FTU5 */
    {(uint32)0x3FC, (uint32)0x30900000}, /* FTU6 */
    ...
    {(uint32)0x374, (uint32)0x10800000}, /* OSPI0 */
...
{
    (uint8)65U,          /* Count of PCC peripheral */
