...
#define SpiConf_SpiChannel_SpiChannel_0_Core0    ((Spi_ChannelType)0)
#define SpiConf_SpiChannel_SpiChannel_1_Core0    ((Spi_ChannelType)1)
#define SpiConf_SpiChannel_SpiChannel_2_Core1    ((Spi_ChannelType)2)
#define SpiConf_SpiChannel_SpiChannel_3_Core1    ((Spi_ChannelType)3)
#define SpiConf_SpiChannel_SpiChannel_4_Core1_FIFO_Master    ((Spi_ChannelType)4)
#define SpiConf_SpiChannel_SpiChannel_5_Core1_FIFO_Slave    ((Spi_ChannelType)5)
#define SpiConf_SpiChannel_SpiChannel_6_Core1_Dma_Master    ((Spi_ChannelType)6)
#define SpiConf_SpiChannel_SpiChannel_7_Core1_Dma_Slave    ((Spi_ChannelType)7)
/**
...
*/
#define SPI_CHANNEL_MAX_COUNT  (8u)


#define SpiConf_SpiJob_SpiJob_0_Core0   ((Spi_JobType)0)
#define SpiConf_SpiJob_SpiJob_1_Core1_Flash   ((Spi_JobType)1)
#define SpiConf_SpiJob_SpiJob_2_Core1_FIFO_Master   ((Spi_JobType)2)
#define SpiConf_SpiJob_SpiJob_3_Core1_FIFO_Slave   ((Spi_JobType)3)
#define SpiConf_SpiJob_SpiJob_4_Core1_Dma_Master   ((Spi_JobType)4)
#define SpiConf_SpiJob_SpiJob_5_Core1_Dma_Slave   ((Spi_JobType)5)
...
*     for all the driver configurations.
*/
#define SPI_JOB_MAX_COUNT     (6u)


#define SpiConf_SpiSequence_SpiSequence_0_Core0   ((Spi_SequenceType)0)
#define SpiConf_SpiSequence_SpiSequence_1_Core1_Flash_SPI2   ((Spi_SequenceType)1)
#define SpiConf_SpiSequence_SpiSequence_2_Core1_FIFO_Master_SPI6   ((Spi_SequenceType)2)
#define SpiConf_SpiSequence_SpiSequence_3_Core1_FIFO_Slave_SPI7   ((Spi_SequenceType)3)
#define SpiConf_SpiSequence_SpiSequence_4_Core1_Dma_Master_SPI4   ((Spi_SequenceType)4)
#define SpiConf_SpiSequence_SpiSequence_5_Core1_Dma_Slave_SPI5   ((Spi_SequenceType)5)
...
*     for all the driver configurations.
*/
#define SPI_SEQUENCE_MAX_COUNT  (6u)
...
#define SPI_HW_MODULE_MAX_COUNT   (6u)
...
#define FCSPI_6_HWUNIT   (CSIB2)

#define FCSPI_7_HWUNIT   (CSIB3)

#define FCSPI_4_HWUNIT   (CSIB4)

#define FCSPI_5_HWUNIT   (CSIB5)
 ...
 */
#define FCSPI6_BASEADDR                            (0x40448000U)

/**
 * @brief        Peripheral SPI7 base address
 */
#define FCSPI7_BASEADDR                            (0x40449000U)
...
#define FCSPI_4_ENABLED  (STD_ON)
#define FCSPI_5_ENABLED  (STD_ON)
#define FCSPI_6_ENABLED  (STD_ON)
#define FCSPI_7_ENABLED  (STD_ON)
...
#define FCSPI_6_MODE   SPI_MODE_ASYNC_FIFO
#define FCSPI_7_MODE   SPI_MODE_ASYNC_FIFO
#define FCSPI_4_MODE   SPI_MODE_ASYNC_DMA
#define FCSPI_5_MODE   SPI_MODE_ASYNC_DMA

#define SPI_SLAVE_MODE_SUPPORT  ((STD_ON))
...
#define FCSPI_4_OFFSET  4u

#define FCSPI_5_OFFSET  5u

#define FCSPI_6_OFFSET  6u

#define FCSPI_7_OFFSET  7u
...
#define SPI_SPI7_Slave  ((Spi_ExternalDeviceType)2u)
#define SPI_SPI6_Master  ((Spi_ExternalDeviceType)3u)
#define SPI_SPI5_Slave  ((Spi_ExternalDeviceType)4u)
#define SPI_SPI4_Master  ((Spi_ExternalDeviceType)5u)
...
#define SPI_SUP_CONT_EN_SECOND_EDGE_SAMPLE      (STD_OFF)
/*==================================================================================================
 *                                     DEFINES AND MACROS
==================================================================================================*/
/**
