...
*/
#define  LIN_BRKD_SUPPORT (STD_OFF)
...
#define LIN_PARTIONS_NB     ((uint32)3U)

/**
 * @brief    Init variable driver status
 */
#define LIN_DRIVER_STATUS_UNINIT_ARRAY  {LIN_UNINIT, LIN_UNINIT, LIN_UNINIT}

/**
 * @brief    Init variable Lin_ConfigPtr
 */
#define LIN_CONFIGPTR_UNINIT_ARRAY {NULL_PTR, NULL_PTR, NULL_PTR}
...
*/
#define LIN_CHMAP_UNINT_ARRAY {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
