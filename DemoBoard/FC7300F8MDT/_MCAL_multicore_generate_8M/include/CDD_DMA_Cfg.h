...
*/
#define DMA_MAX_CORE_USED_U8                     (3U)

/**
* @brief define whether the DMA0 have moncheck
*/
#define DMA0_HAVE_LOCKSTEP                       (STD_OFF)

/**
* @brief define whether the DMA1 have moncheck
*/
#define DMA1_HAVE_LOCKSTEP                       (STD_OFF)
...
*/
#define DMA_MULTICORE_ENABLE                  (STD_ON)

/**
* @brief define if enable Dma Multicore Support Error Detect
*/
#define DMA_MULTICORE_ERRDETECT               (STD_ON)
...
*/
#define DMA_0_USED_CHANNEL_NUM   (9U)

#define DMA_1_USED_CHANNEL_NUM   (7U)
/**
...
#define DMA_0_CHANNEL2_USED    STD_ON

#define DMA_0_CHANNEL2_IRQ     STD_ON
...
#define DMA_0_CHANNEL4_USED    STD_ON

#define DMA_0_CHANNEL4_IRQ     STD_ON

#define DMA_0_CHANNEL4_ERROR_IRQ     STD_OFF

#define DMA_0_CHANNEL5_USED    STD_ON

#define DMA_0_CHANNEL5_IRQ     STD_OFF

#define DMA_0_CHANNEL5_ERROR_IRQ     STD_OFF

#define DMA_0_CHANNEL6_USED    STD_ON

#define DMA_0_CHANNEL6_IRQ     STD_OFF

#define DMA_0_CHANNEL6_ERROR_IRQ     STD_OFF

#define DMA_0_CHANNEL7_USED    STD_ON

#define DMA_0_CHANNEL7_IRQ     STD_ON

#define DMA_0_CHANNEL7_ERROR_IRQ     STD_OFF

#define DMA_0_CHANNEL8_USED    STD_ON

#define DMA_0_CHANNEL8_IRQ     STD_ON

#define DMA_0_CHANNEL8_ERROR_IRQ     STD_OFF
...
*/
#define DMA_1_CHANNEL0_USED    STD_ON

#define DMA_1_CHANNEL0_IRQ     STD_OFF

#define DMA_1_CHANNEL0_ERROR_IRQ     STD_OFF

#define DMA_1_CHANNEL1_USED    STD_ON

#define DMA_1_CHANNEL1_IRQ     STD_ON

#define DMA_1_CHANNEL1_ERROR_IRQ     STD_OFF

#define DMA_1_CHANNEL2_USED    STD_ON

#define DMA_1_CHANNEL2_IRQ     STD_ON

#define DMA_1_CHANNEL2_ERROR_IRQ     STD_OFF

#define DMA_1_CHANNEL3_USED    STD_ON

#define DMA_1_CHANNEL3_IRQ     STD_ON

#define DMA_1_CHANNEL3_ERROR_IRQ     STD_OFF

#define DMA_1_CHANNEL4_USED    STD_ON

#define DMA_1_CHANNEL4_IRQ     STD_ON

#define DMA_1_CHANNEL4_ERROR_IRQ     STD_OFF

#define DMA_1_CHANNEL5_USED    STD_ON

#define DMA_1_CHANNEL5_IRQ     STD_ON

#define DMA_1_CHANNEL5_ERROR_IRQ     STD_OFF

#define DMA_1_CHANNEL6_USED    STD_ON

#define DMA_1_CHANNEL6_IRQ     STD_ON

#define DMA_1_CHANNEL6_ERROR_IRQ     STD_OFF
...
#define DMA_MASTERCORE_INSTANCE1   (1U)
#define DMA_SLAVECORE_INSTANCE1    (2U)

/**
* @brief define the max partition numbers
*/
#define DMA_ECUC_PARTITIONS_MAX     (3U)

/**
* @brief The characteristic by different MCU series
*
*/
#define DMA_UMS_OTRGCH_CONFLICT               (STD_ON)

/**
* @brief The SMP/AMP features by different MCU series
*
*/
#define DMA_MCU_HAVE_SMP                      (STD_OFF)
