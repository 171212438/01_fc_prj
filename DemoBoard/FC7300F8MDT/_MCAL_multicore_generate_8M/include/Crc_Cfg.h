...
#define CRC_CRC8_HW_SUPPORT                               (STD_OFF)
...
#define CRC_8BIT_SAE_J1850    CRC_TABLE_CALCULATION
#define CRC_8BIT_H2F          CRC_TABLE_CALCULATION
...
#define CHANNEL_CRC_8BIT_SAE_J1850_LOOKUP_USED      (STD_OFF)
#define CHANNEL_CRC_8BIT_H2F_LOOKUP_USED            (STD_ON)
#define CHANNEL_CRC_16BIT_CCITT_FALSE_LOOKUP_USED   (STD_OFF)
#define CHANNEL_CRC_16BIT_ARC_LOOKUP_USED           (STD_OFF)
#define CHANNEL_CRC_32BIT_ETHERNET_LOOKUP_USED      (STD_OFF)
#define CHANNEL_CRC_32BIT_E2E_P4_LOOKUP_USED        (STD_OFF)
#define CHANNEL_CRC_64BIT_ECMA_LOOKUP_USED          (STD_OFF)
...
#define Crc8InstanceCoreID     4
#define Crc8H2FInstanceCoreID  4
#define Crc16InstanceCoreID    1
#define Crc16ARCInstanceCoreID 0
#define Crc32InstanceCoreID    0
#define Crc32P4InstanceCoreID  1


/*! @brief  Instance maps. */

                
#define Crc8Instance     2
#define Crc8H2FInstance  2
#define Crc16Instance    CRC_HW_INSTANCE_1
#define Crc16ARCInstance CRC_HW_INSTANCE_0
#define Crc32Instance    CRC_HW_INSTANCE_0
#define Crc32P4Instance  CRC_HW_INSTANCE_1




/* Number Of Configured Logic Channel */
#define CRC_NUM_LOGIC_CHANNEL_MAX                   ((uint32)2U)
