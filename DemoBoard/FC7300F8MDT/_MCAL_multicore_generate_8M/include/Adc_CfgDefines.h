 ...
 */
#define ADC_ENABLE_HSADC_SUPPORT            (STD_OFF)
 ...
 */
#define ADC_UNIT_NUM_CHANNELS               {32U, 32U, 32U, 32U}
 ...
 */
#define ADC_RESULT_TYPE                     (ADC_RESULT_U16)
 ...
 *
 */
#define ADC_NUM_USED_INSTANCE_TYPE          (1U)

/**
* @brief         Add/Remove feature to support DMA transfer.
*/
#define ADC_DMA_SUPPORT                     (STD_OFF)
 ...
 */
#define ADC1_BASE                            (0x4003C000)

/**
 * @brief        Peripheral ADC2 base address
 */
#define ADC2_BASE                            (0x40426000)

/**
 * @brief        Peripheral ADC3 base address
 */
#define ADC3_BASE                            (0x40427000)
 ...
 */
#define ADC_PTIMER_CHANNELS_U8              4U
 ...
 */
#define PTIMER0_BASE                         (0x40037000)

/**
 * @brief        Peripheral PTIMER1 base address
 */
#define PTIMER1_BASE                         (0x40038000)

/**
 * @brief        Peripheral PTIMER2 base address
 */
#define PTIMER2_BASE                         (0x40422000)

/**
 * @brief        Peripheral PTIMER3 base address
 */
#define PTIMER3_BASE                         (0x40423000)
 ...
 *                in the same group.
 */
#define ADC_MIXED_DIFF_CHANNEL_SUPPORT      (STD_OFF)
 ...
 */
#define ADC_TMU_SUPPORT_SELF_TRIM           (STD_OFF)

/**
 * @brief         TMU_TOFFSET_TRIM base addresses
 */
#define TMU_TOFFSET_TRIM_ADDR               0x400235FC

/**
 * @brief         TMU_TOFFSET_TSLOPE base addresses
 */
#define TMU_TSLOPE_TRIM_ADDR                0x400236FC
 ...
 */
#define ADC_TMU_SUPPORT_STOP_MODE           (STD_OFF)
 ...
 */
#define ADC_GET_TEMPERATURE_STATUS_API      (STD_OFF)
 ...
 */
#define HSADC_INIT_CALIBRATION              (STD_OFF)
 ...
 */
#define ADC_ISR_PARTITION_CHECK_SUPPORT     (STD_OFF)

/**
 * @brief         Enables or disables spurious IAR check feature in the ADC driver ((STD_ON)/(STD_OFF)).
 */
#define ADC_ISR_SPURIOUS_CHECK_SUPPORT      (STD_OFF)
 ...
 */
#define ADC_SET_ADC_HARDWARE_AVERAGE_ONCE   (STD_OFF)
 ...
 *
 */
#define ADC_PTIMER_CHANNEL01_BTB_FEATURE    (STD_OFF)

/**
 * @brief         Whether the ADC Units support sequence group mode
 *
 */
#define ADC_SEQUENCE_GROUP_SUPPORT          (STD_OFF)
 ...
 *
 */
#define ADC_PERIODIC_TRIGGER_SUPPORT        (STD_OFF)
...
#define AdcChannel_VR1                       1
#define AdcChannel_V15                       1
#define AdcChannel_TMU                       2
#define AdcChannel_VBG                       3
...
#define AdcConf_AdcChannel_AdcChannel_VR1    1
#define AdcConf_AdcChannel_AdcChannel_V15    1
#define AdcConf_AdcChannel_AdcChannel_TMU    2
#define AdcConf_AdcChannel_AdcChannel_VBG    3
