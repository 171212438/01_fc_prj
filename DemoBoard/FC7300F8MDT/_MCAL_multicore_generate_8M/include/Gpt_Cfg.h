...
*/
#define GPT_CFG_FTU12_24_BIT_SUPPORT    (STD_OFF)

/**
 * @brief Support for GPT Tstmp0 Modx ClkSel feature.
*/
#define GPT_CFG_TSTMP0_MODX_CLKSEL_SUPPORT    (STD_OFF)
...
*/
#define GPT_CFG_GTB_MULI_CONTROL_SUPPORT    (STD_OFF)

/**
 * @brief Support for GPT Ptimer debug mode feature.
*/
#define GPT_CFG_PTIMER_DEBUG_MODE_SUPPORT    (STD_OFF)
...
#define GPT_FTU_6_ISR_USED



#define GPT_PRECOMPILE_SUPPORT  (STD_OFF)

#define MAX_CONFIGURED_CHANNELS_U8           ((Gpt_ChannelType)6U)

#define GPT_FCPIT_MODULES_NUM                (0U)

#define GPT_FCPIT_CHANNEL_NUM                (4U)

#define GPT_TSTMP_MODULES_NUM                (4U)
...
#define GPT_FTU_MODULES_NUM_U8               (12U)
...
#define GPT_EFTU_MODULES_NUM                 (0U)
...
*/
#define MAX_GPT_CHANNEL_NUM    (118U)
