...
*/
#define WDG_VARIABLE_STATUS_VALUE      {WDG_UNINIT,WDG_UNINIT,WDG_UNINIT}

/**
* @brief  The initial value of s_WdgTimeout
*/
#define WDG_VARIABLE_TIMEOUT_VALUE      {(uint32)0U,(uint32)0U,(uint32)0U}

/**
* @brief  The initial value of s_WdgGptPeriod
*/
#define WDG_VARIABLE_PERIOD_VALUE      {(uint32)0U,(uint32)0U,(uint32)0U}
...
*/
#define WDG_INTIAL_TIMEOUT      {WDG_INSTANCE0_INITIAL_TIMEOUT_U32,WDG_INSTANCE1_INITIAL_TIMEOUT_U32,WDG_INSTANCE2_INITIAL_TIMEOUT_U32}
...
*/
#define WDG_MAX_TIMEOUT      {WDG_INSTANCE0_MAX_TIMEOUT_VALUE,WDG_INSTANCE1_MAX_TIMEOUT_VALUE,WDG_INSTANCE2_MAX_TIMEOUT_VALUE}
...
*/
#define WDG_FLAG_LOOP_TIMES      {WDG_INSTANCE0_FLAG_LOOP_VALUE,WDG_INSTANCE1_FLAG_LOOP_VALUE,WDG_INSTANCE2_FLAG_LOOP_VALUE}
