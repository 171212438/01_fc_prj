...
*
*/
#define TRGSEL_CONFIG_TRGSEL_API                 (STD_OFF)
...
*   @brief  Enable or disable TRGSEL0, if enabled , the TrgSel0 will be initialized in TrgSel_Init().
*/
#define TRGSEL4_ENABLED                          (STD_OFF)

/**
*   @brief  Enable or disable TRGSEL0, if enabled , the TrgSel0 will be initialized in TrgSel_Init().
*/
#define TRGSEL5_ENABLED                          (STD_OFF)
...
#define TRGSEL_MAX_INSTANCE                    (4)
/**
* @brief define number of trigger mux registers
*/

#define TRGSEL0_NUM_OUTPUTS                    (84U)
#define TRGSEL1_NUM_OUTPUTS                    (41U)
#define TRGSEL2_NUM_OUTPUTS                    (40U)
#define TRGSEL3_NUM_OUTPUTS                    (32U)

#define TRGSEL0_NUM_REGS    (21U)
#define TRGSEL1_NUM_REGS    (11U)
#define TRGSEL2_NUM_REGS    (10U)
#define TRGSEL3_NUM_REGS    (8U)


#define TRGSEL0_NUM_SOURCES                    (128U)
#define TRGSEL1_NUM_SOURCES                    (123U)
#define TRGSEL2_NUM_SOURCES                    (32U)
#define TRGSEL3_NUM_SOURCES                    (90U)





#define TRGSEL0_MAX_OUTPUTS                    (84U)
#define TRGSEL0_1_MAX_OUTPUTS                  (125U)
#define TRGSEL0_2_MAX_OUTPUTS                  (165U)
#define TRGSEL0_3_MAX_OUTPUTS                  (197U)
