 ...
 *
 */
#define PWM_TRIGGER_OUT_API                       (STD_ON)
...
#define RGB1_RED                                 (2U)
#define RGB2_BLUE                                 (3U)
#define RGB2_GREEN                                 (4U)
#define RGB2_RED                                 (5U)
#define Msc_Pwm_0                                 (6U)
#define Msc_Pwm_1                                 (7U)
#define Msc_Pwm_2                                 (8U)
#define Msc_Pwm_3                                 (9U)
#define Msc_Pwm_4                                 (10U)
...
#define  PwmConf_PwmChannel_RGB1_RED             (2U)
#define  PwmConf_PwmChannel_RGB2_BLUE             (3U)
#define  PwmConf_PwmChannel_RGB2_GREEN             (4U)
#define  PwmConf_PwmChannel_RGB2_RED             (5U)
#define  PwmConf_PwmChannel_Msc_Pwm_0             (6U)
#define  PwmConf_PwmChannel_Msc_Pwm_1             (7U)
#define  PwmConf_PwmChannel_Msc_Pwm_2             (8U)
#define  PwmConf_PwmChannel_Msc_Pwm_3             (9U)
#define  PwmConf_PwmChannel_Msc_Pwm_4             (10U)
 ...
 *
 */
#define PWM_EFTU_USED                           (STD_OFF)


/**
 * @brief Number of configured Pwm channels
 */
#define PWM_NUM_CONF_CHANNELS           (14U)
#define PWM_NUM_CONF_FTU_MODULES        (3U)
 ...
 */
#define PWM_CHANNEL_INTIAL_VALUE        {0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U}

/**
 * @brief    Init state of PWM FTU instances
 */
#define PWM_INSTANCE_INTIAL_VALUE       {0U, 0U, 0U}
 ...
 * 
 */
#define PWM_EFTU_MODULE_NO              (0U)

/**
 * @brief maximum number of EFTU TOM modules configurable on this platform 
 * 
 */
#define PWM_TOM_MODULE_CHANNELS_NO      (0U)
 ...
 *
 */
#define PWM_CORE_USED_U8                3U

/**
 * @brief PWM FTU module have 24bit counter
 *
 */
#define PWM_FTU_HAVE_24BIT_CNT          (STD_OFF)

/**
 * @brief PWM FTU module have UPDOWN_DIS
 *
 */
#define PWM_FTU_HAVE_UPDOWNDIS          (STD_OFF)
...
#define PWM_HW_FTU_END                  (PWM_INSTANCE_FTU_11)
