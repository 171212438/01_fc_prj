...
#define DEVICE_TYPE                         FC7300F8MDT2A320T1B
...
#define DEVICE_SERIES                       FC7300F8MDTxxxxT1B
...
*/
#define USE_EFTU_MODULE                     (STD_OFF)
...
*/
#define USE_ETHTRCV_MODULE                  (STD_ON)
...
/**
* @brief The mailbox channel index of the spin lock.
*/
#define SPIN_LOCK_MB_CHANNEL                (15U)
