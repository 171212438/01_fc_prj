 ...
 */
#define MCU_CFG_SCG_SYSCLK_SIRC_SUPPORT (STD_OFF)
 ...
 */
#define MCU_CFG_SCG_SIRC_AUTOTRIM_CTRL_SUPPORT (STD_OFF)

/**
 * @brief    SCG firc autotrim control Support
 */
#define MCU_CFG_SCG_FIRC_AUTOTRIM_CTRL_SUPPORT (STD_OFF)
 ...
 */
#define MCU_CFG_SCG_PLL_LOSS_LOCK_SUPPORT (STD_OFF)
 ...
 */
#define MCU_CFG_CSC0_REG_7300_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_SCM_7300_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_WKU_WAKEUP_DELAY_SUPPORT (STD_OFF)

/**
 * @brief    WKU register 7300 Support
 */
#define MCU_CFG_WKU_REG_7300_SUPPORT (STD_ON)
 ...
 */
#define MCU_CFG_PMC_REG_7300_SUPPORT (STD_ON)
