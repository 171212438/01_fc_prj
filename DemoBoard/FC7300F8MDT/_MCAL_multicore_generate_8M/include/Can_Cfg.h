...
#define CanController8_EFifo0             20U
#define CanController9_EFifo0             21U
#define CanController0_Transmit0             22U
#define CanController1_Transmit0             23U
#define CanController2_Transmit0             24U
#define CanController3_Transmit0             25U
#define CanController4_Transmit0             26U
#define CanController5_Transmit0             27U
#define CanController6_Transmit0             28U
#define CanController7_Transmit0             29U
#define CanController8_Transmit0             30U
#define CanController9_Transmit0             31U
...
#define CAN_HTH_START_ID  22U
#define CAN_HTH_CNT       10U
...
#define CAN_CONTROLLER_8_MAXMB_CONFIGURED  1U

#define CAN_CONTROLLER_9_MAXMB_CONFIGURED  1U

#define CAN_MAXMB_CONFIGURED  32U



#define CAN_MAXCTRL_SUPPORTED 10U
...
#define FLEXCAN4_ERROR_ISR      STD_OFF
#define FLEXCAN5_ERROR_ISR      STD_OFF
#define FLEXCAN6_ERROR_ISR      STD_OFF
#define FLEXCAN7_ERROR_ISR      STD_OFF
#define FLEXCAN8_ERROR_ISR      STD_OFF
#define FLEXCAN9_ERROR_ISR      STD_OFF

#define CAN_MAXCONTROLLERCOUNT_0  10U

#define CAN_MAXCTRL_CONFIGURED 10U
...
#define CAN_CFGSET0_MAX_BAUDRATE_FC_8_8    1U

#define CAN_CFGSET0_MAX_BAUDRATE_FC_9_9    1U
...
#define CAN_ENHANCED_FIFO_MAX_TABLEID_0  16U


#define CAN_ENHANCED_RXFIFO_ENABLE (STD_ON)

#define CAN_ENHANCED_RXFIFO_ERFFEL_LIST {32,32,32,32,32,32,32,32,32,32}
#define CAN_ENHANCED_RXFIFO_ERFFEL_LIST_LEN 10
#define CAN_ENHANCED_RXFIFO_DEPTH_LIST {12,12,12,12,12,12,12,12,12,12}
#define CAN_ENHANCED_RXFIFO_DEPTH_LIST_LEN 10
#define CAN_HW_RAM_INIT_REGION_COUNT 12U
#define CAN_HW_RAM_INIT_WORD_CONFIG_LEN 10U
#define CAN_HW_RAM_INIT_WORD_CONFIG_LIST {{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}},{{128,32,8,4,4,4,4,18,18,18,240,32}}}
...
/*----------------------- CAN8 ---------------------*/
#define CAN_CAN8_CONTROLLER_ID            ((uint8)8U)
#define FLEXCAN_8_INDEX                   ((uint8)8U)
#define CAN_8_LEGACY_FIFO_EN              (STD_OFF)
#define CAN_8_ENHANCED_FIFO_EN            (STD_ON)
#define CAN_8_FD_EN                       (STD_OFF)
#define CAN_8_ISOFD_EN                    (STD_ON)
#define CAN_8_ERROR_NOTIFICATION_ENABLE   (STD_OFF)
#define CAN_8_MB_BUF_SIZE                 8U

#define CAN_8_BUSOFFINT_SUPPORTED         (STD_OFF)
#define CAN_8_TXINT_SUPPORTED             (STD_ON)
#define CAN_8_RXINT_SUPPORTED             (STD_ON)

#ifdef CAN_CAN8_CONTROLLER_ID
    extern ISR(Can_IsrCAN8_All);
    #if FLEXCAN8_ERROR_ISR == STD_ON
        extern ISR(Can_IsrErrorCAN8_All);
    #endif
#endif
...
/*----------------------- CAN9 ---------------------*/
#define CAN_CAN9_CONTROLLER_ID            ((uint8)9U)
#define FLEXCAN_9_INDEX                   ((uint8)9U)
#define CAN_9_LEGACY_FIFO_EN              (STD_OFF)
#define CAN_9_ENHANCED_FIFO_EN            (STD_ON)
#define CAN_9_FD_EN                       (STD_OFF)
#define CAN_9_ISOFD_EN                    (STD_ON)
#define CAN_9_ERROR_NOTIFICATION_ENABLE   (STD_OFF)
#define CAN_9_MB_BUF_SIZE                 8U

#define CAN_9_BUSOFFINT_SUPPORTED         (STD_OFF)
#define CAN_9_TXINT_SUPPORTED             (STD_ON)
#define CAN_9_RXINT_SUPPORTED             (STD_ON)

#ifdef CAN_CAN9_CONTROLLER_ID
    extern ISR(Can_IsrCAN9_All);
    #if FLEXCAN9_ERROR_ISR == STD_ON
        extern ISR(Can_IsrErrorCAN9_All);
    #endif
#endif
...
#define CAN_MAX_OBJECT_ID ((uint32)32U)

#define CAN_ECUC_PARTITIONS_NUM   (3U)

#define CAN_ECUC_CORES_NUM   (3U)
...
#define CAN_CONTROLLER_REFERENCE_COUNTER 10

#define CAN_CTRL_CONFIGURED (10U)
...
#define CAN_MB_CONTROLLER_5     32U
#define CAN_MB_CONTROLLER_6     32U
