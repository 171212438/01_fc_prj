...
/**
* @brief WDG initialization. [SWS_Wdg_00106] [SWDESG_WDG_019]
*
* @param ConfigPtr Pointer to configuration set.
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance1_Init(const Wdg_ConfigType* ConfigPtr)
{
    Wdg_HLD_Init(ConfigPtr, WDG_HWL_INSTANCE1);
}
/* PRQA S 1503 -- */

/**
* @brief Switch the watchdog mode according to the input parameter Mode. [SWS_Wdg_00107] [SWDESG_WDG_021]
*
...
*
*/
WDG_TEXT_SECTION Std_ReturnType Wdg_174_Instance1_SetMode(WdgIf_ModeType Mode)
{
    return Wdg_HLD_SetMode(Mode, WDG_HWL_INSTANCE1);
}


/**
* @brief Reset the watchdog timeout counter according to the parameter timeout. [SWS_Wdg_00155] [SWDESG_WDG_023]
*
* @param timeout value (milliseconds) for setting the trigger counter.
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance1_SetTriggerCondition(uint16 timeout)
{
#if (WDG_DIRECT_SERVICE == STD_OFF)
    Wdg_HLD_SetTriggerCondition(timeout, WDG_HWL_INSTANCE1);
#else
    (void)timeout;
...
/**
* @brief Service the Watchdog directly without using an hardware timer. [FUNC_WDG_0027] [SWDESG_WDG_027]
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance1_Service(void)
{
    Wdg_HLD_Service(WDG_HWL_INSTANCE1);
}
...
/**
* @brief Get WDG module version information. [SWS_Wdg_00109] [SWDESG_WDG_025]
*
* @param versioninfo Pointer to version structure
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance1_GetVersionInfo(Std_VersionInfoType* versioninfo)
{
    Wdg_HLD_GetVersionInfo(versioninfo, WDG_HWL_INSTANCE1);
}
