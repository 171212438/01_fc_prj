...
/**
* @brief WDG initialization. [SWS_Wdg_00106] [SWDESG_WDG_010]
*
* @param ConfigPtr Pointer to configuration set.
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance0_Init(const Wdg_ConfigType* ConfigPtr)
{
    Wdg_HLD_Init(ConfigPtr, WDG_HWL_INSTANCE0);
}
/* PRQA S 1503 -- */

/**
* @brief Switch the watchdog mode according to the input parameter Mode. [SWS_Wdg_00107] [SWDESG_WDG_012]
*
...
*
*/
WDG_TEXT_SECTION Std_ReturnType Wdg_174_Instance0_SetMode(WdgIf_ModeType Mode)
{
    return Wdg_HLD_SetMode(Mode, WDG_HWL_INSTANCE0);
}

/**
* @brief Reset the watchdog timeout counter according to the parameter timeout. [SWS_Wdg_00155] [SWDESG_WDG_014]
*
* @param timeout value (milliseconds) for setting the trigger counter.
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance0_SetTriggerCondition(uint16 timeout)
{
#if (WDG_DIRECT_SERVICE == STD_OFF)
    Wdg_HLD_SetTriggerCondition(timeout, WDG_HWL_INSTANCE0);
#else
    (void)timeout;
#endif
}
...
/**
* @brief Service the Watchdog directly without using an hardware timer. [FUNC_WDG_0027] [SWDESG_WDG_018]
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance0_Service(void)
{
    Wdg_HLD_Service(WDG_HWL_INSTANCE0);
}
...
/**
* @brief Get WDG module version information. [SWS_Wdg_00109] [SWDESG_WDG_016]
*
* @param versioninfo Pointer to version structure
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance0_GetVersionInfo(Std_VersionInfoType* versioninfo)
{
    Wdg_HLD_GetVersionInfo(versioninfo, WDG_HWL_INSTANCE0);
}
