...
/**
* @brief WDG initialization. [SWS_Wdg_00106] [SWDESG_WDG_078]
*
...
{
    Wdg_HLD_Init(ConfigPtr, WDG_HWL_INSTANCE3);
}
/* PRQA S 1503 -- */

/**
* @brief Switch the watchdog mode according to the input parameter Mode. [SWS_Wdg_00107] [SWDESG_WDG_080]
*
...
{
    return Wdg_HLD_SetMode(Mode, WDG_HWL_INSTANCE3);
}


/**
* @brief Reset the watchdog timeout counter according to the parameter timeout. [SWS_Wdg_00155] [SWDESG_WDG_082]
*
...
WDG_TEXT_SECTION void Wdg_174_Instance3_SetTriggerCondition(uint16 timeout)
{
    ...
    Wdg_HLD_SetTriggerCondition(timeout, WDG_HWL_INSTANCE3);
#else
    (void)timeout;
...
/**
* @brief Service the Watchdog directly without using an hardware timer. [FUNC_WDG_0027] [SWDESG_WDG_086]
*
*/
WDG_TEXT_SECTION void Wdg_174_Instance3_Service(void)
{
    Wdg_HLD_Service(WDG_HWL_INSTANCE3);
}
...
/**
* @brief Get WDG module version information. [SWS_Wdg_00109] [SWDESG_WDG_084]
*
...
{
    Wdg_HLD_GetVersionInfo(versioninfo, WDG_HWL_INSTANCE3);
}
