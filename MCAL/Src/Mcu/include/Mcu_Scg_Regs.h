 ...
 *   @version 1.5.1
 *
 *   @brief AUTOSAR Mcu - Scg module register and macro definitions.
 *   @details Scg module registers, and macro definitions used to manipulate the module registers.
 *
 *   @addtogroup MCU
 *   @{
 */
...
typedef struct
{
    ...
    __IO uint32 CFG; /* Configuration Register, offset: 0x8 */
    ...
    __IO uint32 CCR; /* Clock Control Register, offset: 0x14 */

    uint8 RESERVED_3[8];

    __IO uint32 CLKOUTCFG; /* CLKOUT Configuration Register, offset: 0x20 */

#if (MCU_CFG_SCG_SLEEP_WDG_SUPPORT == STD_ON)
    __IO uint32 SLPWDG; /* Low Power Sleep WDOG Register, offset: 0x24 */

    __IO uint32 WKPWDG; /* Low Power Wakeup WDOG Register, offset: 0x28 */
    ...
    __IO uint32 CRCCSR; /* CRC Control Status Register, offset: 0x30 */

    __I uint32 CRCRES; /* CRC Result Register, offset: 0x34 */

#if (MCU_CFG_SCG_PLL_LOSS_LOCK_SUPPORT == STD_ON)
    uint8 RESERVED_6[88];

    __IO uint32 PLL_LOLC; /* PLL Loss of Lock Control Register, offset: 0x90 */

    uint8 RESERVED_7[108];
#else
    uint8 RESERVED_8[200];
#endif /* (MCU_CFG_SCG_REG_7300_SUPPORT == STD_ON) */

    __IO uint32 FOSCCSR; /* Fast OSC Control Status Register, offset: 0x100 */

    __IO uint32 FOSCDIV; /* Fast OSC Divide Register, offset: 0x104 */

    __IO uint32 FOSCCFG; /* Fast OSC Configuration Register, offset: 0x108 */

    uint8 RESERVED_9[244];
    ...
    __IO uint32 SIRCTCFG; /* Slow IRC Auto Trim Configuration Register, offset: 0x20C */

    uint8 RESERVED_11[8];

    __IO uint32 SIRCSTAT; /* Slow IRC Software Trim Status Register, offset: 0x218 */

    uint8 RESERVED_12[228];
    ...
    __IO uint32 FIRCTCFG; /* Fast IRC Auto Trim Configuration Register, offset: 0x30C */

    uint8 RESERVED_13[8];

    __IO uint32 FIRCSTAT; /* Fast IRC Software Trim Status Register, offset: 0x318 */

    uint8 RESERVED_14[228];

    __IO uint32 SOSCCSR; /* Slow OSC Control Status Register, offset: 0x400 */

    __IO uint32 SOSCCFG; /* Slow OSC Configuration Register, offset: 0x404 */

    uint8 RESERVED_15[248];

    __IO uint32 PLL1CSR; /* PLL1 Control Status Register, offset: 0x500 */

    __IO uint32 PLL1DIV; /* PLL1 Divide Register, offset: 0x504 */

    __IO uint32 PLL1CFG; /* PLL1 Configuration Register, offset: 0x508 */
#if (MCU_CFG_SCG_PLL_CLK1_SUPPORT == STD_ON)
    __O uint32 PLL1PDIS; /* PLL11 ClocK Force Off Register, offset: 0x50C */

    uint8 RESERVED_16[240];
#else
    uint8 RESERVED_17[240];

    __IO uint32 PLL1SCFG; /* PLL1 Special Configuration Register, offset: 0x5FC */

#endif /* (MCU_CFG_SCG_PLL_CLK1_SUPPORT == STD_ON) */

    __IO uint32 PLL0CSR; /* PLL0 Control Status Register, offset: 0x600 */

    __IO uint32 PLL0DIV; /* PLL0 Divide Register, offset: 0x604 */

    __IO uint32 PLL0CFG; /* PLL0 Configuration Register, offset: 0x608 */
#if (MCU_CFG_SCG_PLL_CLK1_SUPPORT == STD_ON)
    __O uint32 PLL0PDIS; /* PLL0 ClocK Force Off Register, offset: 0x60C */

#if (MCU_CFG_SCG_PLL0_CLK2_SUPPORT == STD_ON)
    __IO uint32 PLL0ECFG; /* PLL0 Enhanced Configuration Register, offset: 0x610 */
    uint8       RESERVED_18[236];
#else
    uint8 RESERVED_19[240];
#endif /* (MCU_CFG_SCG_PLL0_CLK2_SUPPORT == STD_ON) */
#else
    uint8 RESERVED_20[240];

    __IO uint32 PLL0SCFG; /* PLL0 Special Configuration Register, offset: 0x6FC */

#endif /* (MCU_CFG_SCG_PLL_CLK1_SUPPORT == STD_ON) */

    __IO uint32 SIRC32KCSR; /* 32K Slow IRC Control Status Register, offset: 0x700 */
...
/* ----------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------- */
/* CFG Bit Fields */
#define SCG_CFG_PORT_LOCK_KEY_MASK  0xFFFF0000u

#define SCG_CFG_PORT_LOCK_KEY_SHIFT 16u

#define SCG_CFG_PORT_LOCK_KEY_WIDTH 16u

#define SCG_CFG_PORT_LOCK_KEY(x) \
    (((uint32)(((uint32)(x)) << SCG_CFG_PORT_LOCK_KEY_SHIFT)) & SCG_CFG_PORT_LOCK_KEY_MASK)

#define SCG_CFG_PORT_CFG_EN_MASK  0x1u

#define SCG_CFG_PORT_CFG_EN_SHIFT 0u

#define SCG_CFG_PORT_CFG_EN_WIDTH 1u

#define SCG_CFG_PORT_CFG_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_CFG_PORT_CFG_EN_SHIFT)) & SCG_CFG_PORT_CFG_EN_MASK)
...
#define SCG_CSR_CCR_UPRD(x) \
    (((uint32)(((uint32)(x)) << SCG_CSR_CCR_UPRD_SHIFT)) & SCG_CSR_CCR_UPRD_MASK)
...
#define SCG_CSR_DIVCORE(x) \
    (((uint32)(((uint32)(x)) << SCG_CSR_DIVCORE_SHIFT)) & SCG_CSR_DIVCORE_MASK)
...
#define SCG_CSR_DIVSLOW(x) \
    (((uint32)(((uint32)(x)) << SCG_CSR_DIVSLOW_SHIFT)) & SCG_CSR_DIVSLOW_MASK)
...
#define SCG_CCR_SYSCLK_CME(x) \
    (((uint32)(((uint32)(x)) << SCG_CCR_SYSCLK_CME_SHIFT)) & SCG_CCR_SYSCLK_CME_MASK)
...
#define SCG_CCR_SCS(x)        (((uint32)(((uint32)(x)) << SCG_CCR_SCS_SHIFT)) & SCG_CCR_SCS_MASK)
...
#define SCG_CCR_DIVCORE(x) \
    (((uint32)(((uint32)(x)) << SCG_CCR_DIVCORE_SHIFT)) & SCG_CCR_DIVCORE_MASK)
...
#define SCG_CCR_DIVBUS(x)     (((uint32)(((uint32)(x)) << SCG_CCR_DIVBUS_SHIFT)) & SCG_CCR_DIVBUS_MASK)
...
#define SCG_CCR_DIVSLOW(x) \
    (((uint32)(((uint32)(x)) << SCG_CCR_DIVSLOW_SHIFT)) & SCG_CCR_DIVSLOW_MASK)
...
#define SCG_CLKOUTCFG_NVMCLK_FIRC(x) \
    (((uint32)(((uint32)(x)) << SCG_CLKOUTCFG_NVMCLK_FIRC_SHIFT)) & SCG_CLKOUTCFG_NVMCLK_FIRC_MASK)
...
#define SCG_CLKOUTCFG_NVMCLK_SIRC(x) \
    (((uint32)(((uint32)(x)) << SCG_CLKOUTCFG_NVMCLK_SIRC_SHIFT)) & SCG_CLKOUTCFG_NVMCLK_SIRC_MASK)
...
#define SCG_CLKOUTCFG_CMU4CLK_FOSC(x) \
    (((uint32)(((uint32)(x)) << SCG_CLKOUTCFG_CMU4CLK_FOSC_SHIFT)) & SCG_CLKOUTCFG_CMU4CLK_FOSC_MASK)
...
#define SCG_CLKOUTCFG_CMU4CLK_SIRC(x) \
    (((uint32)(((uint32)(x)) << SCG_CLKOUTCFG_CMU4CLK_SIRC_SHIFT)) & SCG_CLKOUTCFG_CMU4CLK_SIRC_MASK)
...
#define SCG_CLKOUTCFG_CLKOUTSEL(x) \
    (((uint32)(((uint32)(x)) << SCG_CLKOUTCFG_CLKOUTSEL_SHIFT)) & SCG_CLKOUTCFG_CLKOUTSEL_MASK)
...
#define SCG_SLPWDG_EN(x)     (((uint32)(((uint32)(x)) << SCG_SLPWDG_EN_SHIFT)) & SCG_SLPWDG_EN_MASK)
...
#define SCG_SLPWDG_MSB(x)    (((uint32)(((uint32)(x)) << SCG_SLPWDG_MSB_SHIFT)) & SCG_SLPWDG_MSB_MASK)
...
#define SCG_WKPWDG_EN(x)      (((uint32)(((uint32)(x)) << SCG_WKPWDG_EN_SHIFT)) & SCG_WKPWDG_EN_MASK)
...
#define SCG_WKPWDG_MSB(x)     (((uint32)(((uint32)(x)) << SCG_WKPWDG_MSB_SHIFT)) & SCG_WKPWDG_MSB_MASK)
...
#define SCG_CRCCSR_DONE(x) \
    (((uint32)(((uint32)(x)) << SCG_CRCCSR_DONE_SHIFT)) & SCG_CRCCSR_DONE_MASK)
...
#define SCG_CRCCSR_ERR(x)     (((uint32)(((uint32)(x)) << SCG_CRCCSR_ERR_SHIFT)) & SCG_CRCCSR_ERR_MASK)
...
#define SCG_CRCCSR_BUSY(x) \
    (((uint32)(((uint32)(x)) << SCG_CRCCSR_BUSY_SHIFT)) & SCG_CRCCSR_BUSY_MASK)
...
#define SCG_CRCCSR_EOEN(x) \
    (((uint32)(((uint32)(x)) << SCG_CRCCSR_EOEN_SHIFT)) & SCG_CRCCSR_EOEN_MASK)
...
#define SCG_CRCCSR_CHKEN(x) \
    (((uint32)(((uint32)(x)) << SCG_CRCCSR_CHKEN_SHIFT)) & SCG_CRCCSR_CHKEN_MASK)
...
#define SCG_CRCCSR_TRGEN(x) \
    (((uint32)(((uint32)(x)) << SCG_CRCCSR_TRGEN_SHIFT)) & SCG_CRCCSR_TRGEN_MASK)
...
#define SCG_CRCCSR_GEN(x)       (((uint32)(((uint32)(x)) << SCG_CRCCSR_GEN_SHIFT)) & SCG_CRCCSR_GEN_MASK)
...
#define SCG_CRCRES_RESULT(x) \
    (((uint32)(((uint32)(x)) << SCG_CRCRES_RESULT_SHIFT)) & SCG_CRCRES_RESULT_MASK)
...
#define SCG_PLL_LOLC_PLL1_LOLC(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL_LOLC_PLL1_LOLC_SHIFT)) & SCG_PLL_LOLC_PLL1_LOLC_MASK)
...
#define SCG_PLL_LOLC_PLL0_LOLC(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL_LOLC_PLL0_LOLC_SHIFT)) & SCG_PLL_LOLC_PLL0_LOLC_MASK)
...
#define SCG_FOSCCSR_ERR(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCSR_ERR_SHIFT)) & SCG_FOSCCSR_ERR_MASK)
...
#define SCG_FOSCCSR_SEL(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCSR_SEL_SHIFT)) & SCG_FOSCCSR_SEL_MASK)
...
#define SCG_FOSCCSR_VLD(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCSR_VLD_SHIFT)) & SCG_FOSCCSR_VLD_MASK)
...
#define SCG_FOSCCSR_LK(x)      (((uint32)(((uint32)(x)) << SCG_FOSCCSR_LK_SHIFT)) & SCG_FOSCCSR_LK_MASK)
...
#define SCG_FOSCCSR_CMRE(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCSR_CMRE_SHIFT)) & SCG_FOSCCSR_CMRE_MASK)
...
#define SCG_FOSCCSR_CM(x)      (((uint32)(((uint32)(x)) << SCG_FOSCCSR_CM_SHIFT)) & SCG_FOSCCSR_CM_MASK)
...
#define SCG_FOSCCSR_STEN(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCSR_STEN_SHIFT)) & SCG_FOSCCSR_STEN_MASK)
...
#define SCG_FOSCCSR_EN(x)                      (((uint32)(((uint32)(x)) << SCG_FOSCCSR_EN_SHIFT)) & SCG_FOSCCSR_EN_MASK)

/* FOSCCSR Reg All Bit But ERR and LK Mask */

#define SCG_FOSCCSR_All_EXCEPT_ERR_AND_LK_MASK 0x3030003u
...
#define SCG_FOSCDIV_DIVL_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVL_ACK_SHIFT)) & SCG_FOSCDIV_DIVL_ACK_MASK)
...
#define SCG_FOSCDIV_DIVM_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVM_ACK_SHIFT)) & SCG_FOSCDIV_DIVM_ACK_MASK)
...
#define SCG_FOSCDIV_DIVH_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVH_ACK_SHIFT)) & SCG_FOSCDIV_DIVH_ACK_MASK)
...
#define SCG_FOSCDIV_DIVL_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVL_EN_SHIFT)) & SCG_FOSCDIV_DIVL_EN_MASK)
...
#define SCG_FOSCDIV_DIVM_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVM_EN_SHIFT)) & SCG_FOSCDIV_DIVM_EN_MASK)
...
#define SCG_FOSCDIV_DIVH_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVH_EN_SHIFT)) & SCG_FOSCDIV_DIVH_EN_MASK)
...
#define SCG_FOSCDIV_DIVL(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVL_SHIFT)) & SCG_FOSCDIV_DIVL_MASK)
...
#define SCG_FOSCDIV_DIVM(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVM_SHIFT)) & SCG_FOSCDIV_DIVM_MASK)
...
#define SCG_FOSCDIV_DIVH(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCDIV_DIVH_SHIFT)) & SCG_FOSCDIV_DIVH_MASK)
...
#define SCG_FOSCCFG_BYPASS(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCFG_BYPASS_SHIFT)) & SCG_FOSCCFG_BYPASS_MASK)
...
#define SCG_FOSCCFG_COMP_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCFG_COMP_EN_SHIFT)) & SCG_FOSCCFG_COMP_EN_MASK)
...
#define SCG_FOSCCFG_EOCV(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCFG_EOCV_SHIFT)) & SCG_FOSCCFG_EOCV_MASK)
...
#define SCG_FOSCCFG_GM_SEL(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCFG_GM_SEL_SHIFT)) & SCG_FOSCCFG_GM_SEL_MASK)
...
#define SCG_FOSCCFG_ALC_D(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCFG_ALC_D_SHIFT)) & SCG_FOSCCFG_ALC_D_MASK)
...
#define SCG_FOSCCFG_HYST_D(x) \
    (((uint32)(((uint32)(x)) << SCG_FOSCCFG_HYST_D_SHIFT)) & SCG_FOSCCFG_HYST_D_MASK)
...
#define SCG_SIRCCSR_ERR(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCCSR_ERR_SHIFT)) & SCG_SIRCCSR_ERR_MASK)
...
#define SCG_SIRCCSR_VLD(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCCSR_VLD_SHIFT)) & SCG_SIRCCSR_VLD_MASK)
...
#define SCG_SIRCCSR_CM(x)      (((uint32)(((uint32)(x)) << SCG_SIRCCSR_CM_SHIFT)) & SCG_SIRCCSR_CM_MASK)
...
#define SCG_SIRCCSR_TRLK(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCCSR_TRLK_SHIFT)) & SCG_SIRCCSR_TRLK_MASK)
...
#define SCG_SIRCCSR_TRUP(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCCSR_TRUP_SHIFT)) & SCG_SIRCCSR_TRUP_MASK)
...
#define SCG_SIRCCSR_TREN(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCCSR_TREN_SHIFT)) & SCG_SIRCCSR_TREN_MASK)
...
#define SCG_SIRCCSR_LPEN(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCCSR_LPEN_SHIFT)) & SCG_SIRCCSR_LPEN_MASK)
...
#define SCG_SIRCCSR_STEN(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCCSR_STEN_SHIFT)) & SCG_SIRCCSR_STEN_MASK)

/* SIRCCSR Reg All Bit But ERR and LK Mask */

#define SCG_SIRCCSR_All_EXCEPT_ERR_AND_LK_MASK 0x1010706u
...
#define SCG_SIRCDIV_DIVL_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVL_ACK_SHIFT)) & SCG_SIRCDIV_DIVL_ACK_MASK)
...
#define SCG_SIRCDIV_DIVM_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVM_ACK_SHIFT)) & SCG_SIRCDIV_DIVM_ACK_MASK)
...
#define SCG_SIRCDIV_DIVH_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVH_ACK_SHIFT)) & SCG_SIRCDIV_DIVH_ACK_MASK)
...
#define SCG_SIRCDIV_DIVL_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVL_EN_SHIFT)) & SCG_SIRCDIV_DIVL_EN_MASK)
...
#define SCG_SIRCDIV_DIVM_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVM_EN_SHIFT)) & SCG_SIRCDIV_DIVM_EN_MASK)
...
#define SCG_SIRCDIV_DIVH_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVH_EN_SHIFT)) & SCG_SIRCDIV_DIVH_EN_MASK)
...
#define SCG_SIRCDIV_DIVL(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVL_SHIFT)) & SCG_SIRCDIV_DIVL_MASK)
...
#define SCG_SIRCDIV_DIVM(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVM_SHIFT)) & SCG_SIRCDIV_DIVM_MASK)
...
#define SCG_SIRCDIV_DIVH(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCDIV_DIVH_SHIFT)) & SCG_SIRCDIV_DIVH_MASK)
...
#define SCG_SIRCTCFG_TRIMDIV(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCTCFG_TRIMDIV_SHIFT)) & SCG_SIRCTCFG_TRIMDIV_MASK)
...
#define SCG_SIRCTCFG_SAMPLE(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCTCFG_SAMPLE_SHIFT)) & SCG_SIRCTCFG_SAMPLE_MASK)
...
#define SCG_SIRCTCFG_DELAY(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCTCFG_DELAY_SHIFT)) & SCG_SIRCTCFG_DELAY_MASK)
...
#define SCG_SIRCTCFG_TRIMSRC(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCTCFG_TRIMSRC_SHIFT)) & SCG_SIRCTCFG_TRIMSRC_MASK)
...
#define SCG_SIRCSTAT_TRIMFINE(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCSTAT_TRIMFINE_SHIFT)) & SCG_SIRCSTAT_TRIMFINE_MASK)
...
#define SCG_SIRCSTAT_TRIMCOAR(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRCSTAT_TRIMCOAR_SHIFT)) & SCG_SIRCSTAT_TRIMCOAR_MASK)
...
#define SCG_FIRCCSR_ERR(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCSR_ERR_SHIFT)) & SCG_FIRCCSR_ERR_MASK)
...
#define SCG_FIRCCSR_SEL(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCSR_SEL_SHIFT)) & SCG_FIRCCSR_SEL_MASK)
...
#define SCG_FIRCCSR_VLD(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCSR_VLD_SHIFT)) & SCG_FIRCCSR_VLD_MASK)
...
#define SCG_FIRCCSR_CM(x)      (((uint32)(((uint32)(x)) << SCG_FIRCCSR_CM_SHIFT)) & SCG_FIRCCSR_CM_MASK)
...
#define SCG_FIRCCSR_TRLK(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCSR_TRLK_SHIFT)) & SCG_FIRCCSR_TRLK_MASK)
...
#define SCG_FIRCCSR_TRUP(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCSR_TRUP_SHIFT)) & SCG_FIRCCSR_TRUP_MASK)
...
#define SCG_FIRCCSR_TREN(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCSR_TREN_SHIFT)) & SCG_FIRCCSR_TREN_MASK)
...
#define SCG_FIRCCSR_STEN(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCSR_STEN_SHIFT)) & SCG_FIRCCSR_STEN_MASK)
...
#define SCG_FIRCCSR_EN(x)                      (((uint32)(((uint32)(x)) << SCG_FIRCCSR_EN_SHIFT)) & SCG_FIRCCSR_EN_MASK)

/* FIRCCSR Reg All Bit But ERR and LK Mask */

#define SCG_FIRCCSR_All_EXCEPT_ERR_AND_LK_MASK 0x3010703u
...
#define SCG_FIRCDIV_DIVL_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVL_ACK_SHIFT)) & SCG_FIRCDIV_DIVL_ACK_MASK)
...
#define SCG_FIRCDIV_DIVM_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVM_ACK_SHIFT)) & SCG_FIRCDIV_DIVM_ACK_MASK)
...
#define SCG_FIRCDIV_DIVH_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVH_ACK_SHIFT)) & SCG_FIRCDIV_DIVH_ACK_MASK)
...
#define SCG_FIRCDIV_DIVL_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVL_EN_SHIFT)) & SCG_FIRCDIV_DIVL_EN_MASK)
...
#define SCG_FIRCDIV_DIVM_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVM_EN_SHIFT)) & SCG_FIRCDIV_DIVM_EN_MASK)
...
#define SCG_FIRCDIV_DIVH_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVH_EN_SHIFT)) & SCG_FIRCDIV_DIVH_EN_MASK)
...
#define SCG_FIRCDIV_DIVL(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVL_SHIFT)) & SCG_FIRCDIV_DIVL_MASK)
...
#define SCG_FIRCDIV_DIVM(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVM_SHIFT)) & SCG_FIRCDIV_DIVM_MASK)
...
#define SCG_FIRCDIV_DIVH(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCDIV_DIVH_SHIFT)) & SCG_FIRCDIV_DIVH_MASK)
...
#define SCG_FIRCCFG_CLKEN(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCCFG_CLKEN_SHIFT)) & SCG_FIRCCFG_CLKEN_MASK)
...
#define SCG_FIRCTCFG_TRIMDIV(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCTCFG_TRIMDIV_SHIFT)) & SCG_FIRCTCFG_TRIMDIV_MASK)
...
#define SCG_FIRCTCFG_SAMPLE(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCTCFG_SAMPLE_SHIFT)) & SCG_FIRCTCFG_SAMPLE_MASK)
...
#define SCG_FIRCTCFG_DELAY(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCTCFG_DELAY_SHIFT)) & SCG_FIRCTCFG_DELAY_MASK)
...
#define SCG_FIRCTCFG_TRIMSRC(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCTCFG_TRIMSRC_SHIFT)) & SCG_FIRCTCFG_TRIMSRC_MASK)
...
#define SCG_FIRCSTAT_TRIMCOAR(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCSTAT_TRIMCOAR_SHIFT)) & SCG_FIRCSTAT_TRIMCOAR_MASK)
...
#define SCG_FIRCSTAT_TRIMFINE(x) \
    (((uint32)(((uint32)(x)) << SCG_FIRCSTAT_TRIMFINE_SHIFT)) & SCG_FIRCSTAT_TRIMFINE_MASK)
...
#define SCG_SOSCCSR_ERR(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCSR_ERR_SHIFT)) & SCG_SOSCCSR_ERR_MASK)
...
#define SCG_SOSCCSR_VLD(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCSR_VLD_SHIFT)) & SCG_SOSCCSR_VLD_MASK)
...
#define SCG_SOSCCSR_CMRE(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCSR_CMRE_SHIFT)) & SCG_SOSCCSR_CMRE_MASK)
...
#define SCG_SOSCCSR_CM(x)        (((uint32)(((uint32)(x)) << SCG_SOSCCSR_CM_SHIFT)) & SCG_SOSCCSR_CM_MASK)
...
#define SCG_SOSCCSR_BYPASS(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCSR_BYPASS_SHIFT)) & SCG_SOSCCSR_BYPASS_MASK)
...
#define SCG_SOSCCSR_EN(x)                      (((uint32)(((uint32)(x)) << SCG_SOSCCSR_EN_SHIFT)) & SCG_SOSCCSR_EN_MASK)

/* SOSCCSR Reg All Bit But ERR and LK Mask */

#define SCG_SOSCCSR_All_EXCEPT_ERR_AND_LK_MASK 0x1030003u
...
#define SCG_SOSCCFG_CURPRG_SF(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCFG_CURPRG_SF_SHIFT)) & SCG_SOSCCFG_CURPRG_SF_MASK)
...
#define SCG_SOSCCFG_CURPRG_COMP(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCFG_CURPRG_COMP_SHIFT)) & SCG_SOSCCFG_CURPRG_COMP_MASK)
...
#define SCG_SOSCCFG_EOCV(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCFG_EOCV_SHIFT)) & SCG_SOSCCFG_EOCV_MASK)
...
#define SCG_SOSCCFG_GM_SEL(x) \
    (((uint32)(((uint32)(x)) << SCG_SOSCCFG_GM_SEL_SHIFT)) & SCG_SOSCCFG_GM_SEL_MASK)
...
#define SCG_PLL1CSR_PLLLK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CSR_PLLLK_SHIFT)) & SCG_PLL1CSR_PLLLK_MASK)
...
#define SCG_PLL1CSR_ERR(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CSR_ERR_SHIFT)) & SCG_PLL1CSR_ERR_MASK)
...
#define SCG_PLL1CSR_VLD(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CSR_VLD_SHIFT)) & SCG_PLL1CSR_VLD_MASK)
...
#define SCG_PLL1CSR_LK(x)      (((uint32)(((uint32)(x)) << SCG_PLL1CSR_LK_SHIFT)) & SCG_PLL1CSR_LK_MASK)
...
#define SCG_PLL1CSR_CMRE(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CSR_CMRE_SHIFT)) & SCG_PLL1CSR_CMRE_MASK)
...
#define SCG_PLL1CSR_CM(x)       (((uint32)(((uint32)(x)) << SCG_PLL1CSR_CM_SHIFT)) & SCG_PLL1CSR_CM_MASK)
...
#define SCG_PLL1CSR_CK1EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CSR_CK1EN_SHIFT)) & SCG_PLL1CSR_CK1EN_MASK)
...
#define SCG_PLL1CSR_STEN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CSR_STEN_SHIFT)) & SCG_PLL1CSR_STEN_MASK)
...
#define SCG_PLL1CSR_EN(x)                      (((uint32)(((uint32)(x)) << SCG_PLL1CSR_EN_SHIFT)) & SCG_PLL1CSR_EN_MASK)

/* PLL1CSR Reg All Bit But ERR and LK Mask */

#define SCG_PLL1CSR_All_EXCEPT_ERR_AND_LK_MASK 0x9030003u
...
#define SCG_PLL1DIV_DIVL_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVL_ACK_SHIFT)) & SCG_PLL1DIV_DIVL_ACK_MASK)
...
#define SCG_PLL1DIV_DIVM_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVM_ACK_SHIFT)) & SCG_PLL1DIV_DIVM_ACK_MASK)
...
#define SCG_PLL1DIV_DIVH_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVH_ACK_SHIFT)) & SCG_PLL1DIV_DIVH_ACK_MASK)
...
#define SCG_PLL1DIV_DIVL_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVL_EN_SHIFT)) & SCG_PLL1DIV_DIVL_EN_MASK)
...
#define SCG_PLL1DIV_DIVM_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVM_EN_SHIFT)) & SCG_PLL1DIV_DIVM_EN_MASK)
...
#define SCG_PLL1DIV_DIVH_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVH_EN_SHIFT)) & SCG_PLL1DIV_DIVH_EN_MASK)
...
#define SCG_PLL1DIV_DIVL(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVL_SHIFT)) & SCG_PLL1DIV_DIVL_MASK)
...
#define SCG_PLL1DIV_DIVM(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVM_SHIFT)) & SCG_PLL1DIV_DIVM_MASK)
...
#define SCG_PLL1DIV_DIVH(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1DIV_DIVH_SHIFT)) & SCG_PLL1DIV_DIVH_MASK)
...
#define SCG_PLL1CFG_MULT(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CFG_MULT_SHIFT)) & SCG_PLL1CFG_MULT_MASK)
...
#define SCG_PLL1CFG_PREDIV(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CFG_PREDIV_SHIFT)) & SCG_PLL1CFG_PREDIV_MASK)
...
#define SCG_PLL1CFG_PSTDIV(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CFG_PSTDIV_SHIFT)) & SCG_PLL1CFG_PSTDIV_MASK)
...
#define SCG_PLL1CFG_PSTDIV1(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CFG_PSTDIV1_SHIFT)) & SCG_PLL1CFG_PSTDIV1_MASK)
...
#define SCG_PLL1CFG_SOURCE(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1CFG_SOURCE_SHIFT)) & SCG_PLL1CFG_SOURCE_MASK)
...
#define SCG_PLL1SCFG_FS_EN_MASK  0x1u

#define SCG_PLL1SCFG_FS_EN_SHIFT 0u

#define SCG_PLL1SCFG_FS_EN_WIDTH 1u

#define SCG_PLL1SCFG_FS_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL1SCFG_FS_EN_SHIFT)) & SCG_PLL1SCFG_FS_EN_MASK)
...
#define SCG_PLL0CSR_PLLLK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_PLLLK_SHIFT)) & SCG_PLL0CSR_PLLLK_MASK)
...
#define SCG_PLL0CSR_ERR(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_ERR_SHIFT)) & SCG_PLL0CSR_ERR_MASK)
...
#define SCG_PLL0CSR_SEL(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_SEL_SHIFT)) & SCG_PLL0CSR_SEL_MASK)
...
#define SCG_PLL0CSR_VLD(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_VLD_SHIFT)) & SCG_PLL0CSR_VLD_MASK)
...
#define SCG_PLL0CSR_LK(x)      (((uint32)(((uint32)(x)) << SCG_PLL0CSR_LK_SHIFT)) & SCG_PLL0CSR_LK_MASK)
...
#define SCG_PLL0CSR_CMRE(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_CMRE_SHIFT)) & SCG_PLL0CSR_CMRE_MASK)
...
#define SCG_PLL0CSR_CK2EN_MASK  0x20u

#define SCG_PLL0CSR_CK2EN_SHIFT 5u

#define SCG_PLL0CSR_CK2EN_WIDTH 1u

#define SCG_PLL0CSR_CK2EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_CK2EN_SHIFT)) & SCG_PLL0CSR_CK2EN_MASK)
...
#define SCG_PLL0CSR_CK1EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_CK1EN_SHIFT)) & SCG_PLL0CSR_CK1EN_MASK)

#define SCG_PLL0CSR_CM(x)      (((uint32)(((uint32)(x)) << SCG_PLL0CSR_CM_SHIFT)) & SCG_PLL0CSR_CM_MASK)
...
#define SCG_PLL0CSR_STEN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CSR_STEN_SHIFT)) & SCG_PLL0CSR_STEN_MASK)
...
#define SCG_PLL0CSR_EN(x)                      (((uint32)(((uint32)(x)) << SCG_PLL0CSR_EN_SHIFT)) & SCG_PLL0CSR_EN_MASK)

/* PLL0CSR Reg All Bit But ERR and LK Mask */

#define SCG_PLL0CSR_All_EXCEPT_ERR_AND_LK_MASK 0xB030003u
...
#define SCG_PLL0DIV_DIVL_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVL_ACK_SHIFT)) & SCG_PLL0DIV_DIVL_ACK_MASK)
...
#define SCG_PLL0DIV_DIVM_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVM_ACK_SHIFT)) & SCG_PLL0DIV_DIVM_ACK_MASK)
...
#define SCG_PLL0DIV_DIVH_ACK(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVH_ACK_SHIFT)) & SCG_PLL0DIV_DIVH_ACK_MASK)
...
#define SCG_PLL0DIV_DIVL_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVL_EN_SHIFT)) & SCG_PLL0DIV_DIVL_EN_MASK)
...
#define SCG_PLL0DIV_DIVM_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVM_EN_SHIFT)) & SCG_PLL0DIV_DIVM_EN_MASK)
...
#define SCG_PLL0DIV_DIVH_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVH_EN_SHIFT)) & SCG_PLL0DIV_DIVH_EN_MASK)
...
#define SCG_PLL0DIV_DIVL(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVL_SHIFT)) & SCG_PLL0DIV_DIVL_MASK)
...
#define SCG_PLL0DIV_DIVM(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVM_SHIFT)) & SCG_PLL0DIV_DIVM_MASK)
...
#define SCG_PLL0DIV_DIVH(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0DIV_DIVH_SHIFT)) & SCG_PLL0DIV_DIVH_MASK)
...
/* PLL0CFG Bit Fields */
#if (MCU_CFG_SCG_PLL0_CLK2_SUPPORT == STD_ON)
#define SCG_PLL0CFG_MULT_MASK  0x3FF0000u

#define SCG_PLL0CFG_MULT_SHIFT 16u

#define SCG_PLL0CFG_MULT_WIDTH 10u
#else
...
#define SCG_PLL0CFG_MULT(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CFG_MULT_SHIFT)) & SCG_PLL0CFG_MULT_MASK)
...
#define SCG_PLL0CFG_PREDIV(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CFG_PREDIV_SHIFT)) & SCG_PLL0CFG_PREDIV_MASK)
...
#define SCG_PLL0CFG_PSTDIV(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CFG_PSTDIV_SHIFT)) & SCG_PLL0CFG_PSTDIV_MASK)
...
#define SCG_PLL0CFG_PSTDIV1(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CFG_PSTDIV1_SHIFT)) & SCG_PLL0CFG_PSTDIV1_MASK)
...
#define SCG_PLL0CFG_SOURCE(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0CFG_SOURCE_SHIFT)) & SCG_PLL0CFG_SOURCE_MASK)
...
/* PLL0ECFG Bit Fields */
#define SCG_PLL0ECFG_MULT_MUX_MASK  0xC0u

#define SCG_PLL0ECFG_MULT_MUX_SHIFT 6u

#define SCG_PLL0ECFG_MULT_MUX_WIDTH 2u

#define SCG_PLL0ECFG_MULT_MUX(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0ECFG_MULT_MUX_SHIFT)) & SCG_PLL0ECFG_MULT_MUX_MASK)

#define SCG_PLL0ECFG_CLK1_MUX_MASK  0x20u

#define SCG_PLL0ECFG_CLK1_MUX_SHIFT 5u

#define SCG_PLL0ECFG_CLK1_MUX_WIDTH 1u

#define SCG_PLL0ECFG_CLK1_MUX(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0ECFG_CLK1_MUX_SHIFT)) & SCG_PLL0ECFG_CLK1_MUX_MASK)

#define SCG_PLL0ECFG_CLK_MUX_MASK  0x10u

#define SCG_PLL0ECFG_CLK_MUX_SHIFT 4u

#define SCG_PLL0ECFG_CLK_MUX_WIDTH 1u

#define SCG_PLL0ECFG_CLK_MUX(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0ECFG_CLK_MUX_SHIFT)) & SCG_PLL0ECFG_CLK_MUX_MASK)

/* PLL0ECFG Reg Mask */
#define SCG_PLL0ECFG_MASK        0x000000F0u

/* PLL0SCFG Bit Fields */

#define SCG_PLL0SCFG_FS_EN_MASK  0x1u

#define SCG_PLL0SCFG_FS_EN_SHIFT 0u

#define SCG_PLL0SCFG_FS_EN_WIDTH 1u

#define SCG_PLL0SCFG_FS_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_PLL0SCFG_FS_EN_SHIFT)) & SCG_PLL0SCFG_FS_EN_MASK)
...
#define SCG_SIRC32KCSR_VLD(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRC32KCSR_VLD_SHIFT)) & SCG_SIRC32KCSR_VLD_MASK)
...
#define SCG_SIRC32KCSR_LK(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRC32KCSR_LK_SHIFT)) & SCG_SIRC32KCSR_LK_MASK)
...
#define SCG_SIRC32KCSR_EN(x) \
    (((uint32)(((uint32)(x)) << SCG_SIRC32KCSR_EN_SHIFT)) & SCG_SIRC32KCSR_EN_MASK)
