...
*   ---------   ----------    ------------- ----------   ---------------
*   0.1.0       20/60/2023    QXW0054       N/A          Pfls Initial Version
...
==================================================================================================*/
#ifndef PFLS_FLASH_TYPES_H
#define PFLS_FLASH_TYPES_H
...
==================================================================================================*/
/**
 * @brief          Return value for Pfls_DsiHandler and Pfls_MciHandler.
...
} Pfls_Flash_InternalSectorInfoType;

typedef uint32 Pfls_Flash_DataBusWidthType;

#ifdef __cplusplus
}
#endif

#endif /* PFLS_FLASH_TYPES_H */
