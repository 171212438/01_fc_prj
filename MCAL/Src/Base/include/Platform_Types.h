...
*   @details This file contains AUTOSAR Platform Types.
*
*   @addtogroup Common
*   @{
*/
...
#define PLATFORM_SW_MINOR_VERSION            5
 ...
 * @implements TRUE_FALSE_enumeration
 */
/*PRQA S 4600 ++ #Misra-C:2012 Rule-21.1 #define and #undef shall not be used on a reserved identifier or reserved macro name
        Reason:The macros defined here is used for the static code  */
#define true 1U
#endif
#ifndef false
/**
...
/**
 * @brief Unsigned 64 bit integer with range of 0..18446744073709551615
