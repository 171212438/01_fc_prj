 ...
 *   @version 1.5.1
 *
 *   @brief   AUTOSAR Ocu - memory map header file.
 *   @details OCU memory map definition.
 *
 *   @addtogroup Base
 *   @{
 *
...
#define MEMMAP_ERROR
    ...
    #undef MEMMAP_ERROR
        ...
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_const_cfg")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_const_cfg"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section rodata=".ocu_mcal_const_cfg"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .rodata=".ocu_mcal_const_cfg"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section rodata=".ocu_mcal_const_cfg"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_rodata")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_rodata"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section rodata=".ocu_mcal_rodata"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .rodata=".ocu_mcal_rodata"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  rodata=".ocu_mcal_rodata"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
    #if defined(_GCC_C_FC7XXX_)
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION __attribute__((section(".ocu_mcal_text")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_function_attributes = @ ".ocu_mcal_text"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section text=".ocu_mcal_text"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .text=".ocu_mcal_text"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  text=".ocu_mcal_text"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION __attribute__((section(".ocu_mcal_ramcode")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_function_attributes = @ ".ocu_mcal_ramcode"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section text=".ocu_mcal_ramcode"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .text=".ocu_mcal_ramcode"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  text=".ocu_mcal_ramcode"
        #ifdef OCU_TEXT_SECTION
            #undef OCU_TEXT_SECTION
        #endif
        #define OCU_TEXT_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_bss")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section bss=".ocu_mcal_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .bss=".ocu_mcal_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  bss=".ocu_mcal_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_data")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_data"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section data=".ocu_mcal_data" bss=".ocu_mcal_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .data=".ocu_mcal_data",.bss=".ocu_mcal_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  data=".ocu_mcal_data" bss=".ocu_mcal_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_nocacheable_bss")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_nocacheable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section bss=".ocu_mcal_nocacheable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .bss=".ocu_mcal_nocacheable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  bss=".ocu_mcal_nocacheable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_nocacheable_data")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_nocacheable_data"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section data=".ocu_mcal_nocacheable_data" bss=".ocu_mcal_nocacheable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .data=".ocu_mcal_nocacheable_data",.bss=".ocu_mcal_nocacheable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  data=".ocu_mcal_nocacheable_data" bss=".ocu_mcal_nocacheable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
...
#ifdef OCU_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #undef OCU_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #define INSIDE_OCU_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef OCU_STOP_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
        #error "MemMap.h, no valid matching start-stop section defined."
        #endif
    #endif
    #undef MEMMAP_ERROR
            ...
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_shareable_bss")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_shareable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section bss=".ocu_mcal_shareable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .bss=".ocu_mcal_shareable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  bss=".ocu_mcal_shareable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
...
#ifdef OCU_STOP_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #ifdef INSIDE_OCU_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
        #undef INSIDE_OCU_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef OCU_STOP_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #undef MEMMAP_ERROR
    #if defined(_GCC_C_FC7XXX_)
        #undef OCU_DATA_SECTION
    #elif defined(_IAR_C_FC7XXX_)
...
#ifdef OCU_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #undef OCU_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #define INSIDE_OCU_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef OCU_STOP_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
        #error "MemMap.h, no valid matching start-stop section defined."
        #endif
    #endif
    #undef MEMMAP_ERROR
            ...
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION __attribute__((section(".ocu_mcal_shareable_data")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".ocu_mcal_shareable_data"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section data=".ocu_mcal_shareable_data" bss=".ocu_mcal_shareable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .data=".ocu_mcal_shareable_data",.bss=".ocu_mcal_shareable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  data=".ocu_mcal_shareable_data" bss=".ocu_mcal_shareable_bss"
        #ifdef OCU_DATA_SECTION
            #undef OCU_DATA_SECTION
        #endif
        #define OCU_DATA_SECTION
...
#ifdef OCU_STOP_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #ifdef INSIDE_OCU_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
        #undef INSIDE_OCU_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef OCU_STOP_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #undef MEMMAP_ERROR
    #if defined(_GCC_C_FC7XXX_)
        #undef OCU_DATA_SECTION
    #elif defined(_IAR_C_FC7XXX_)
