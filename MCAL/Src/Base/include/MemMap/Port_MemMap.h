 ...
 *   @version 1.5.1
 *
 *   @brief   AUTOSAR Port - memory map header file.
 *   @details PORT memory map definition.
 *
 *   @addtogroup Base
 *   @{
 *
...
#define MEMMAP_ERROR
    ...
    #undef MEMMAP_ERROR
        ...
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_const_cfg")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_const_cfg"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section rodata=".port_mcal_const_cfg"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .rodata=".port_mcal_const_cfg"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section rodata=".port_mcal_const_cfg"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_rodata")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_rodata"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section rodata=".port_mcal_rodata"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .rodata=".port_mcal_rodata"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  rodata=".port_mcal_rodata"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
    #if defined(_GCC_C_FC7XXX_)
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION __attribute__((section(".port_mcal_text")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_function_attributes = @ ".port_mcal_text"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section text=".port_mcal_text"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .text=".port_mcal_text"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  text=".port_mcal_text"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION __attribute__((section(".port_mcal_ramcode")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_function_attributes = @ ".port_mcal_ramcode"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section text=".port_mcal_ramcode"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .text=".port_mcal_ramcode"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  text=".port_mcal_ramcode"
        #ifdef PORT_TEXT_SECTION
            #undef PORT_TEXT_SECTION
        #endif
        #define PORT_TEXT_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_bss")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section bss=".port_mcal_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .bss=".port_mcal_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  bss=".port_mcal_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_data")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_data"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section data=".port_mcal_data" bss=".port_mcal_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .data=".port_mcal_data",.bss=".port_mcal_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  data=".port_mcal_data" bss=".port_mcal_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_nocacheable_bss")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_nocacheable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section bss=".port_mcal_nocacheable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .bss=".port_mcal_nocacheable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  bss=".port_mcal_nocacheable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    ...
    #undef MEMMAP_ERROR
            ...
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_nocacheable_data")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_nocacheable_data"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section data=".port_mcal_nocacheable_data" bss=".port_mcal_nocacheable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .data=".port_mcal_nocacheable_data",.bss=".port_mcal_nocacheable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  data=".port_mcal_nocacheable_data" bss=".port_mcal_nocacheable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
...
#ifdef PORT_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #undef PORT_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #define INSIDE_PORT_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef PORT_STOP_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
        #error "MemMap.h, no valid matching start-stop section defined."
        #endif
    #endif
    #undef MEMMAP_ERROR
            ...
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_shareable_bss")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_shareable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section bss=".port_mcal_shareable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .bss=".port_mcal_shareable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  bss=".port_mcal_shareable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
...
#ifdef PORT_STOP_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #ifdef INSIDE_PORT_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
        #undef INSIDE_PORT_START_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef PORT_STOP_SEC_VAR_NO_INIT_SHAREABLE_NO_CACHEABLE
    #undef MEMMAP_ERROR
    #if defined(_GCC_C_FC7XXX_)
        #undef PORT_DATA_SECTION
    #elif defined(_IAR_C_FC7XXX_)
...
#ifdef PORT_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #undef PORT_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #define INSIDE_PORT_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef PORT_STOP_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
        #error "MemMap.h, no valid matching start-stop section defined."
        #endif
    #endif
    #undef MEMMAP_ERROR
            ...
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION __attribute__((section(".port_mcal_shareable_data")))
    #elif defined(_IAR_C_FC7XXX_)
        #pragma default_variable_attributes = @ ".port_mcal_shareable_data"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_LLVM_C_FC7XXX_)
        #pragma clang section data=".port_mcal_shareable_data" bss=".port_mcal_shareable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_TASKING_C_FC7XXX_)
        #pragma section .data=".port_mcal_shareable_data",.bss=".port_mcal_shareable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
    #elif defined(_GREENHILLS_C_FC7XXX_)
        #pragma ghs section  data=".port_mcal_shareable_data" bss=".port_mcal_shareable_bss"
        #ifdef PORT_DATA_SECTION
            #undef PORT_DATA_SECTION
        #endif
        #define PORT_DATA_SECTION
...
#ifdef PORT_STOP_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #ifdef INSIDE_PORT_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
        #undef INSIDE_PORT_START_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef PORT_STOP_SEC_VAR_INIT_SHAREABLE_NO_CACHEABLE
    #undef MEMMAP_ERROR
    #if defined(_GCC_C_FC7XXX_)
        #undef PORT_DATA_SECTION
    #elif defined(_IAR_C_FC7XXX_)
