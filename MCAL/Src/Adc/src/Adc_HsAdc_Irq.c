/**
 *   @file    Adc_HsAdc_Irq.c
 *   @version 1.5.1
 *
 *   @brief   AUTOSAR Adc - HSADC Interrupt source file.
 *   @details  Autosar HSADC Interrupt source file.
 *
 *   @addtogroup ADC
 *   @{
 */
...
#ifdef HSADC_UNIT_0_ISR_USED
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit0);
#endif

#ifdef HSADC_UNIT_1_ISR_USED
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit1);
#endif

#ifdef HSADC_UNIT_2_ISR_USED
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit2);
#endif

#ifdef HSADC_UNIT_3_ISR_USED
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit3);
#endif
...
ADC_TEXT_SECTION LOCAL_INLINE void HsAdc_ISR_EndPartialConversion(const Adc_HwUnitType Unit,
...
#if ((defined(HSADC_UNIT_0_ISR_USED)) || (defined(HSADC_UNIT_1_ISR_USED)) || \
     (defined(HSADC_UNIT_2_ISR_USED)) || (defined(HSADC_UNIT_3_ISR_USED)))
ADC_TEXT_SECTION LOCAL_INLINE void HsAdc_ISR_EndGroupConversion(const Adc_HwUnitType Unit);
#endif /* (defined(HSADC_UNIT_0_ISR_USED)) || (defined(HSADC_UNIT_1_ISR_USED)) ... */

#if (STD_ON == ADC_DMA_SUPPORT)
#ifdef HSADC_UNIT_0
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit0(void);
#endif

#ifdef HSADC_UNIT_1
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit1(void);
#endif

#ifdef HSADC_UNIT_2
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit2(void);
#endif

#ifdef HSADC_UNIT_3
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit3(void);
#endif

ADC_TEXT_SECTION LOCAL_INLINE void HsAdc_DMA_EndGroupConversion(const Adc_HwUnitType Unit);
#endif /* STD_ON == ADC_DMA_SUPPORT */
                                                                  ...
                                                                  const uint8          CoreId)
{
    ...
    Adc_HwUnitType                    HwIndex   = Adc_Cfg_Ptr[CoreId]->HsAdcIndex[Unit];
        ...
        (pGroupPtr->eTransferType == ADC_TRANSFER_TYPE_POLLING))
    {
        ...
        eRet = Adc_HsAdc_GetSequenceResults(Unit, pGroupPtr, CoreId, pResult);
#if (ADC_HW_TRIGGER_API == STD_ON)
        if (pGroupPtr->eTriggerSource == ADC_TRIGG_SRC_HW)
        {
            (void)Adc_HsAdc_CheckOverrun(Unit, pGroupPtr);
        }
#endif
    }
    ...
    else
    {
        if (ADC_TRIGG_SRC_SW == pGroupPtr->eTriggerSource)
        {
            ...
            if (
#if (ADC_PERIODIC_TRIGGER_SUPPORT == STD_ON)
                ...
                (ADC_CONV_MODE_CONTINUOUS == pGroupPtr->eMode))
            {
                ...
                Adc_HsAdc_RestartContinuousConversion(Unit, pGroupPtr, CoreId);
                /* PRQA S 4461 -- */
            }
            /* SWS_Adc_00449 */
 ...
 *                 It's used on all HSADC Hardware units.
 *
 * @param[in]      Unit        The hardware Unit.
 *
 * @return         void
...
ADC_TEXT_SECTION LOCAL_INLINE void HsAdc_ISR_EndGroupConversion(const Adc_HwUnitType Unit)
{
    ...
    {
        HwIndex = Adc_Cfg_Ptr[CoreId]->HsAdcIndex[Unit];
        if (HwIndex != ADC_UNIT_INVALID)
        {
            ...
            if (pConfig->bUseHwGroup == TRUE)
            {
                ...
                {
                    if (E_OK == Adc_HsAdc_CheckHwGroupStatus(Unit, HwGroupIdx))
                    {
                        HsAdc_ISR_EndPartialConversion(Unit, pConfig->pGroupId[HwGroupIdx], CoreId);
                    }
                }
            }
            else
#endif /* ADC_ENABLE_HWGROUP_SUPPORT == STD_ON */
            {
                ...
                if (Adc_aUnitStatus[HwIndex].HwNormalQueueIndex > (Adc_QueueIndexType)0U)
                {
                    ...
                    if (E_OK == Adc_HsAdc_CheckSequenceStatus(Unit, CurrentGroup, CoreId))
                    {
                ...
                if ((boolean)FALSE == bIsSpurious)
                {
                    ...
                    HsAdc_ISR_EndPartialConversion(Unit, CurrentGroup, CoreId);
                    /* PRQA S 2962 -- */
                }
                else
                {
                    /* Spurious interrupt, read out all data to clear interrupt flag */
                    Adc_HsAdc_DropConvResults(Unit, HSADC_NUM_SC_REGISTER);
                }
            }
        }
    }
...
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit0(void)
{
    HsAdc_DMA_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_0);
}
#endif
...
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit1(void)
{
    HsAdc_DMA_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_1);
}
#endif
...
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit2(void)
{
    HsAdc_DMA_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_2);
}
#endif
...
ADC_TEXT_SECTION void HsAdc_DMA_EndGroupConvUnit3(void)
{
    HsAdc_DMA_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_3);
}
#endif
 ...
 *                 the HSADC Hardware Unit 0.
 * @details        The function handles the ISR for the HSADC Hardware Unit 0.
 *
 * @return         void
 *
 * @isr
...
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit0)
{
    HsAdc_ISR_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_0);

    EXIT_INTERRUPT();
}
#endif /* HSADC_UNIT_0_ISR_USED */
...
/**
 * @brief          This function handles the ISR for the conversion done of
 *                 the HSADC Hardware Unit 1
 * @details        The function handles the ISR for the HSADC Hardware Unit 1.
 *
 * @return         void
 *
 * @isr
...
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit1)
{
    HsAdc_ISR_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_1);

    EXIT_INTERRUPT();
}
#endif /* HSADC_UNIT_1_ISR_USED */
...
/**
 * @brief          This function handles the ISR for the conversion done of
 *                 the HSADC Hardware Unit 2.
 * @details        The function handles the ISR for the HSADC Hardware Unit 2.
 *
 * @return         void
 *
 * @isr
...
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit2)
{
    HsAdc_ISR_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_2);

    EXIT_INTERRUPT();
}
#endif /* HSADC_UNIT_2_ISR_USED */
...
/**
 * @brief          This function handles the ISR for the conversion done of
 *                 the HSADC Hardware Unit 3
 * @details        The function handles the ISR for the HSADC Hardware Unit 3.
 *
 * @return         void
 *
 * @isr
...
ADC_TEXT_SECTION ISR(HsAdc_ISR_EndGroupConvUnit3)
{
    HsAdc_ISR_EndGroupConversion((Adc_HwUnitType)HSADC_UNIT_3);

    EXIT_INTERRUPT();
}
#endif /* HSADC_UNIT_3_ISR_USED */
