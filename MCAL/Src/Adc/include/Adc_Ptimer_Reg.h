/**
*   @file    Adc_Ptimer_Reg.h
*   @version 1.5.1
*
*   @brief   AUTOSAR Adc - Ptimer module register and macro definitions.
*   @details Ptimer module registers, and macro definitions used to manipulate the module registers.
*
*   @addtogroup ADC
*   @{
*/
...
#ifndef ADC_PTIMER_REG_H
#define ADC_PTIMER_REG_H
