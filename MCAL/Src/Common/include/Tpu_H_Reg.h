...
*   @details  TPU host side registers, and macrodefinitions used to manipulate the module registers.
*
*   @addtogroup Common
*   @{
*/
...
==================================================================================================*/
 ...
 /** Number of TPU host side channels. */
#define TPU_H_CH_COUNT                32
 ...
 #define TPU_H_GCR_VSR_SR(x)            (((uint32)(((uint32)(x))<<TPU_H_GCR_VSR_SR_SHIFT))&TPU_H_GCR_VSR_SR_MASK)
 ...
 #define TPU_H_GCR_VIR_PSTI(x)          (((uint32)(((uint32)(x))<<TPU_H_GCR_VIR_PSTI_SHIFT))&TPU_H_GCR_VIR_PSTI_MASK)
 ...
 #define TPU_H_GCR_VOR_PSTO(x)          (((uint32)(((uint32)(x))<<TPU_H_GCR_VOR_PSTO_SHIFT))&TPU_H_GCR_VOR_PSTO_MASK)
 ...
 #define TPU_H_GCR_VOBR_PSTOE(x)        (((uint32)(((uint32)(x))<<TPU_H_GCR_VOBR_PSTOE_SHIFT))&TPU_H_GCR_VOBR_PSTOE_MASK)
 ...
 #define TPU_H_GCR_VM1R_M1R(x)          (((uint32)(((uint32)(x))<<TPU_H_GCR_VM1R_M1R_SHIFT))&TPU_H_GCR_VM1R_M1R_MASK)
 ...
 #define TPU_H_GCR_VM2R_M2R(x)          (((uint32)(((uint32)(x))<<TPU_H_GCR_VM2R_M2R_SHIFT))&TPU_H_GCR_VM2R_M2R_MASK)
 ...
 #define TPU_H_GCR_VT1R_T1R(x)          (((uint32)(((uint32)(x))<<TPU_H_GCR_VT1R_T1R_SHIFT))&TPU_H_GCR_VT1R_T1R_MASK)
 ...
 #define TPU_H_GCR_VT2R_T2R(x)          (((uint32)(((uint32)(x))<<TPU_H_GCR_VT2R_T2R_SHIFT))&TPU_H_GCR_VT2R_T2R_MASK)
 ...
 #define TPU_H_GCR_EM1R_EM1R(x)         (((uint32)(((uint32)(x))<<TPU_H_GCR_EM1R_EM1R_SHIFT))&TPU_H_GCR_EM1R_EM1R_MASK)
 ...
 #define TPU_H_GCR_EM2R_EM2R(x)         (((uint32)(((uint32)(x))<<TPU_H_GCR_EM2R_EM2R_SHIFT))&TPU_H_GCR_EM2R_EM2R_MASK)
 ...
 #define TPU_H_GCR_ET1R_ET1R(x)         (((uint32)(((uint32)(x))<<TPU_H_GCR_ET1R_ET1R_SHIFT))&TPU_H_GCR_ET1R_ET1R_MASK)
 ...
 #define TPU_H_GCR_ET2R_ET2R(x)         (((uint32)(((uint32)(x))<<TPU_H_GCR_ET2R_ET2R_SHIFT))&TPU_H_GCR_ET2R_ET2R_MASK)
 ...
 #define TPU_H_GCR_VHSR_HAS(x)          (((uint32)(((uint32)(x))<<TPU_H_GCR_VHSR_HAS_SHIFT))&TPU_H_GCR_VHSR_HAS_MASK)
 ...
 #define TPU_H_TBR_CR_TCR1P(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_CR_TCR1P_SHIFT))&TPU_H_TBR_CR_TCR1P_MASK)
 ...
 #define TPU_H_TBR_CR_TCR1CTL(x)        (((uint32)(((uint32)(x))<<TPU_H_TBR_CR_TCR1CTL_SHIFT))&TPU_H_TBR_CR_TCR1CTL_MASK)
 ...
 #define TPU_H_TBR_CR_TCR2P(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_CR_TCR2P_SHIFT))&TPU_H_TBR_CR_TCR2P_MASK)
 ...
 #define TPU_H_TBR_CR_ATGC(x)           (((uint32)(((uint32)(x))<<TPU_H_TBR_CR_ATGC_SHIFT))&TPU_H_TBR_CR_ATGC_MASK)
 ...
 #define TPU_H_TBR_CR_AM(x)             (((uint32)(((uint32)(x))<<TPU_H_TBR_CR_AM_SHIFT))&TPU_H_TBR_CR_AM_MASK)
 ...
 #define TPU_H_TBR_CR_TCRCF(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_CR_TCRCF_SHIFT))&TPU_H_TBR_CR_TCRCF_MASK)
 ...
 #define TPU_H_TBR_CR_TCR2CTL(x)        (((uint32)(((uint32)(x))<<TPU_H_TBR_CR_TCR2CTL_SHIFT))&TPU_H_TBR_CR_TCR2CTL_MASK)
 ...
 #define TPU_H_TBR_T1R_TCR1(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_T1R_TCR1_SHIFT))&TPU_H_TBR_T1R_TCR1_MASK)
 ...
 #define TPU_H_TBR_T2R_TCR2(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_T2R_TCR2_SHIFT))&TPU_H_TBR_T2R_TCR2_MASK)
 ...
 #define TPU_H_TBR_TPR_LAST(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_TPR_LAST_SHIFT))&TPU_H_TBR_TPR_LAST_MASK)
 ...
 #define TPU_H_TBR_TPR_MISSCNT(x)       (((uint32)(((uint32)(x))<<TPU_H_TBR_TPR_MISSCNT_SHIFT))&TPU_H_TBR_TPR_MISSCNT_MASK)
 ...
 #define TPU_H_TBR_TPR_IPH(x)           (((uint32)(((uint32)(x))<<TPU_H_TBR_TPR_IPH_SHIFT))&TPU_H_TBR_TPR_IPH_MASK)
 ...
 #define TPU_H_TBR_TPR_HOLD(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_TPR_HOLD_SHIFT))&TPU_H_TBR_TPR_HOLD_MASK)
 ...
 #define TPU_H_TBR_TPR_TPR10(x)         (((uint32)(((uint32)(x))<<TPU_H_TBR_TPR_TPR10_SHIFT))&TPU_H_TBR_TPR_TPR10_MASK)
 ...
 #define TPU_H_TBR_TPR_TICKS(x)         (((uint32)(((uint32)(x))<<TPU_H_TBR_TPR_TICKS_SHIFT))&TPU_H_TBR_TPR_TICKS_MASK)
 ...
 #define TPU_H_TBR_TRR_INTEGER(x)       (((uint32)(((uint32)(x))<<TPU_H_TBR_TRR_INTEGER_SHIFT))&TPU_H_TBR_TRR_INTEGER_MASK)
 ...
 #define TPU_H_TBR_TRR_FRACTION(x)      (((uint32)(((uint32)(x))<<TPU_H_TBR_TRR_FRACTION_SHIFT))&TPU_H_TBR_TRR_FRACTION_MASK)
 ...
 #define TPU_H_TBR_T1MR_OVF(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_T1MR_OVF_SHIFT))&TPU_H_TBR_T1MR_OVF_MASK)
 ...
 #define TPU_H_TBR_T1MR_IRQ_EN(x)       (((uint32)(((uint32)(x))<<TPU_H_TBR_T1MR_IRQ_EN_SHIFT))&TPU_H_TBR_T1MR_IRQ_EN_MASK)
 ...
 #define TPU_H_TBR_T1MR_MAX(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_T1MR_MAX_SHIFT))&TPU_H_TBR_T1MR_MAX_MASK)
 ...
 #define TPU_H_TBR_T2MR_OVF(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_T2MR_OVF_SHIFT))&TPU_H_TBR_T2MR_OVF_MASK)
 ...
 #define TPU_H_TBR_T2MR_IRQ_EN(x)       (((uint32)(((uint32)(x))<<TPU_H_TBR_T2MR_IRQ_EN_SHIFT))&TPU_H_TBR_T2MR_IRQ_EN_MASK)
 ...
 #define TPU_H_TBR_T2MR_MAX(x)          (((uint32)(((uint32)(x))<<TPU_H_TBR_T2MR_MAX_SHIFT))&TPU_H_TBR_T2MR_MAX_MASK)
 ...
 #define TPU_H_CHn_CR_CHAE(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_CR_CHAE_SHIFT))&TPU_H_CHn_CR_CHAE_MASK)
 ...
 #define TPU_H_CHn_CR_CHDE(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_CR_CHDE_SHIFT))&TPU_H_CHn_CR_CHDE_MASK)
 ...
 #define TPU_H_CHn_CR_CHEE(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_CR_CHEE_SHIFT))&TPU_H_CHn_CR_CHEE_MASK)
 ...
 #define TPU_H_CHn_CR_CTC(x)            (((uint32)(((uint32)(x))<<TPU_H_CHn_CR_CTC_SHIFT))&TPU_H_CHn_CR_CTC_MASK)
 ...
 #define TPU_H_CHn_CR_CDFD(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_CR_CDFD_SHIFT))&TPU_H_CHn_CR_CDFD_MASK)
 ...
 #define TPU_H_CHn_CR_CHSR(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_CR_CHSR_SHIFT))&TPU_H_CHn_CR_CHSR_MASK)
 ...
 #define TPU_H_CHn_SR_CIS(x)            (((uint32)(((uint32)(x))<<TPU_H_CHn_SR_CIS_SHIFT))&TPU_H_CHn_SR_CIS_MASK)
 ...
 #define TPU_H_CHn_SR_CHRS(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_SR_CHRS_SHIFT))&TPU_H_CHn_SR_CHRS_MASK)
 ...
 #define TPU_H_CHn_SR_CHRI(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_SR_CHRI_SHIFT))&TPU_H_CHn_SR_CHRI_MASK)
 ...
 #define TPU_H_CHn_SR_CEIS(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_SR_CEIS_SHIFT))&TPU_H_CHn_SR_CEIS_MASK)
 ...
 #define TPU_H_CHn_SR_CHDS(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_SR_CHDS_SHIFT))&TPU_H_CHn_SR_CHDS_MASK)
 ...
 #define TPU_H_CHn_SR_CTS(x)            (((uint32)(((uint32)(x))<<TPU_H_CHn_SR_CTS_SHIFT))&TPU_H_CHn_SR_CTS_MASK)
 ...
 #define TPU_H_CHn_SR_CHAS(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_SR_CHAS_SHIFT))&TPU_H_CHn_SR_CHAS_MASK)
 ...
 #define TPU_H_CHn_SCR_CEIC(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_SCR_CEIC_SHIFT))&TPU_H_CHn_SCR_CEIC_MASK)
 ...
 #define TPU_H_CHn_SCR_CHAC(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_SCR_CHAC_SHIFT))&TPU_H_CHn_SCR_CHAC_MASK)
 ...
 #define TPU_H_CHn_SCR_CHRT(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_SCR_CHRT_SHIFT))&TPU_H_CHn_SCR_CHRT_MASK)
 ...
 #define TPU_H_CHn_EFR_CSR(x)           (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_CSR_SHIFT))&TPU_H_CHn_EFR_CSR_MASK)
 ...
 #define TPU_H_CHn_EFR_CHSR(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_CHSR_SHIFT))&TPU_H_CHn_EFR_CHSR_MASK)
 ...
 #define TPU_H_CHn_EFR_EMRL1(x)         (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_EMRL1_SHIFT))&TPU_H_CHn_EFR_EMRL1_MASK)
 ...
 #define TPU_H_CHn_EFR_EMRL2(x)         (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_EMRL2_SHIFT))&TPU_H_CHn_EFR_EMRL2_MASK)
 ...
 #define TPU_H_CHn_EFR_ETDL1(x)         (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_ETDL1_SHIFT))&TPU_H_CHn_EFR_ETDL1_MASK)
 ...
 #define TPU_H_CHn_EFR_ETDL2(x)         (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_ETDL2_SHIFT))&TPU_H_CHn_EFR_ETDL2_MASK)
 ...
 #define TPU_H_CHn_EFR_MRLE1(x)         (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_MRLE1_SHIFT))&TPU_H_CHn_EFR_MRLE1_MASK)
 ...
 #define TPU_H_CHn_EFR_MRLE2(x)         (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_MRLE2_SHIFT))&TPU_H_CHn_EFR_MRLE2_MASK)
 ...
 #define TPU_H_CHn_EFR_MRL1(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_MRL1_SHIFT))&TPU_H_CHn_EFR_MRL1_MASK)
 ...
 #define TPU_H_CHn_EFR_MRL2(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_MRL2_SHIFT))&TPU_H_CHn_EFR_MRL2_MASK)
 ...
 #define TPU_H_CHn_EFR_TDL1(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_TDL1_SHIFT))&TPU_H_CHn_EFR_TDL1_MASK)
 ...
 #define TPU_H_CHn_EFR_TDL2(x)          (((uint32)(((uint32)(x))<<TPU_H_CHn_EFR_TDL2_SHIFT))&TPU_H_CHn_EFR_TDL2_MASK)
...
typedef struct {
  ...
  __I  uint32 GCR_VHSR                      ; /* Global Control Region - Visible Host Acknowledge Register, offset: 0x40 */

       uint8  RESERVED_1[188];

  __I  uint32 TBR_CR                        ; /* Time Bases Region - Control Register, offset: 0x100 */
  ...
  __I  uint32 TBR_TPR                       ; /* Time Base Region - Tooth Program Register, offset: 0x110 */
