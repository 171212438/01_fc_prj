...
*   @version 1.5.1
*
*   @brief   AUTOSAR TPU - module register and macro definitions.
*   @details  TPU engine side registers, and macrodefinitions used to manipulate the module registers.
*
*   @addtogroup Common
*   @{
*/
...
typedef struct {
  ...
  __IO uint32 GCR_CR                        ; /* Global Control Region - Control Register, offset: 0x0 */

       uint8  RESERVED_0[4];

  __IO uint32 GCR_SRR                       ; /* Global Control Region - Software Reset Register, offset: 0x8 */

       uint8  RESERVED_1[4];

  __I  uint32 GCR_VSR                       ; /* Global Control Region - Visible Status Register, offset: 0x10 */

  __I  uint32 GCR_VIR                       ; /* Global Control Region - Visible Input Status Register, offset: 0x14 */

  __I  uint32 GCR_VOR                       ; /* Global Control Region -Visible Output Status Register, offset: 0x18 */

  __I  uint32 GCR_VOBR                      ; /* Global Control Region - Visible Output Enable Status Register, offset: 0x1C */

  __I  uint32 GCR_VM1R                      ; /* Global Control Region - Visible MRL1 Register, offset: 0x20 */

  __I  uint32 GCR_VM2R                      ; /* Global Control Region - Visible MRL2 Register, offset: 0x24 */

  __I  uint32 GCR_VT1R                      ; /* Global Control Region - Visible TDL1 Register, offset: 0x28 */

  __I  uint32 GCR_VT2R                      ; /* Global Control Region - Visible TDL2 Register, offset: 0x2C */

  __I  uint32 GCR_EM1R                      ; /* Global Control Region - Visible Event by MRL1 Register, offset: 0x30 */

  __I  uint32 GCR_EM2R                      ; /* Global Control Region - Visible Event by MRL2 Register, offset: 0x34 */

  __I  uint32 GCR_ET1R                      ; /* Global Control Region - Visible Event by TDL1 Register, offset: 0x38 */

  __I  uint32 GCR_ET2R                      ; /* Global Control Region - Visible Event by TDL2 Register, offset: 0x3C */

  __I  uint32 GCR_VHSR                      ; /* Global Control Region - Visible Host Request Register, offset: 0x40 */

       uint8  RESERVED_2[172];

  __IO uint32 GCR_AFGR                      ; /* Global Control Region - Interrupt Arbiter Fliter Grade Register, offset: 0xF0 */

  __IO uint32 GCR_ASR                       ; /* Global Control Region - Interrupt Arbiter Status Register, offset: 0xF4 */

  __IO uint32 GCR_AID                       ; /* Global Control Region - Interrupt Arbiter ID Register, offset: 0xF8 */

       uint8  RESERVED_3[4];

  __IO uint32 TBR_CR                        ; /* Time Bases Region - Control Register, offset: 0x100 */

  __IO uint32 TBR_T1R                       ; /* Time Base Region - TCR1 Value Register, offset: 0x104 */

  __IO uint32 TBR_T2R                       ; /* Time Base Region - TCR2 Value Register, offset: 0x108 */

       uint8  RESERVED_4[4];

  __IO uint32 TBR_TPR                       ; /* Time Base Region - Tooth Program Register, offset: 0x110 */

  __IO uint32 TBR_TRR                       ; /* Time Base Region - Tick Rate Register, offset: 0x114 */

  __IO uint32 TBR_T1MR                      ; /* Time Base Region - TCR1 Maximum Register, offset: 0x118 */

  __IO uint32 TBR_T2MR                      ; /* Time Base Region - TCR2 Maximum Register, offset: 0x11C */

  uint8  RESERVED_5[1760];
  struct{                                    /* offset: 0x800, array step: 0x40 */
    __IO uint32 CR                        ; /* Channel N Control Register, offset: 0x800 */
    __I  uint32 SR                        ; /* Channel N Status Register, offset: 0x804 */
    __IO uint32 SCR                       ; /* Channel N Status Control Register, offset: 0x808 */
    __I  uint32 EFR                       ; /* Channel N Event and Flag Register, offset: 0x80c */
    __IO uint32 CR2                       ; /* Channel N Control Register 2, offset: 0x810 */
    __IO uint32 MR                        ; /* Channel N Mode configuration visible Register, offset: 0x814 */
    __IO uint32 ER1                       ; /* Channel N Event Control Register or Part 1, offset: 0x818 */
    __IO uint32 ER2                       ; /* Channel N Event Control Register or Part 2, offset: 0x81c */
    __IO uint32 ECR                       ; /* Channel N Event Clear Register, offset: 0x820 */
    __IO uint32 OCR                       ; /* Channel N Output User Control Register, offset: 0x824 */
         uint8  RESERVED_6[24];
       }  CH[TPU_E_CH_COUNT];
...
#define TPU_E_GCR_CR_CDFC(x)           (((uint32)(((uint32)(x))<<TPU_E_GCR_CR_CDFC_SHIFT))&TPU_E_GCR_CR_CDFC_MASK)
...
#define TPU_E_GCR_CR_FCSS(x)           (((uint32)(((uint32)(x))<<TPU_E_GCR_CR_FCSS_SHIFT))&TPU_E_GCR_CR_FCSS_MASK)
...
#define TPU_E_GCR_CR_FPSCK(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_CR_FPSCK_SHIFT))&TPU_E_GCR_CR_FPSCK_MASK)
...
#define TPU_E_GCR_CR_HALT_CH(x)        (((uint32)(((uint32)(x))<<TPU_E_GCR_CR_HALT_CH_SHIFT))&TPU_E_GCR_CR_HALT_CH_MASK)
...
#define TPU_E_GCR_CR_HALT_TB(x)        (((uint32)(((uint32)(x))<<TPU_E_GCR_CR_HALT_TB_SHIFT))&TPU_E_GCR_CR_HALT_TB_MASK)

#define TPU_E_GCR_CR_HALT_MASK      	0x600u

#define TPU_E_GCR_CR_HALT_SHIFT     	9u

#define TPU_E_GCR_CR_HALT_WIDTH     	2u

#define TPU_E_GCR_CR_HALT(x)        	(((uint32)(((uint32)(x))<<TPU_E_GCR_CR_HALT_SHIFT))&TPU_E_GCR_CR_HALT_MASK)
...
#define TPU_E_GCR_SRR_SW_RST(x)        (((uint32)(((uint32)(x))<<TPU_E_GCR_SRR_SW_RST_SHIFT))&TPU_E_GCR_SRR_SW_RST_MASK)
...
#define TPU_E_GCR_VSR_SR(x)            (((uint32)(((uint32)(x))<<TPU_E_GCR_VSR_SR_SHIFT))&TPU_E_GCR_VSR_SR_MASK)
...
#define TPU_E_GCR_VIR_PSTI(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_VIR_PSTI_SHIFT))&TPU_E_GCR_VIR_PSTI_MASK)
...
#define TPU_E_GCR_VOR_PSTO(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_VOR_PSTO_SHIFT))&TPU_E_GCR_VOR_PSTO_MASK)
...
#define TPU_E_GCR_VOBR_PSTOE(x)        (((uint32)(((uint32)(x))<<TPU_E_GCR_VOBR_PSTOE_SHIFT))&TPU_E_GCR_VOBR_PSTOE_MASK)
...
#define TPU_E_GCR_VM1R_M1R(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_VM1R_M1R_SHIFT))&TPU_E_GCR_VM1R_M1R_MASK)
...
#define TPU_E_GCR_VM2R_M2R(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_VM2R_M2R_SHIFT))&TPU_E_GCR_VM2R_M2R_MASK)
...
#define TPU_E_GCR_VT1R_T1R(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_VT1R_T1R_SHIFT))&TPU_E_GCR_VT1R_T1R_MASK)
...
#define TPU_E_GCR_VT2R_T2R(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_VT2R_T2R_SHIFT))&TPU_E_GCR_VT2R_T2R_MASK)
...
#define TPU_E_GCR_EM1R_EM1R(x)         (((uint32)(((uint32)(x))<<TPU_E_GCR_EM1R_EM1R_SHIFT))&TPU_E_GCR_EM1R_EM1R_MASK)
...
#define TPU_E_GCR_EM2R_EM2R(x)         (((uint32)(((uint32)(x))<<TPU_E_GCR_EM2R_EM2R_SHIFT))&TPU_E_GCR_EM2R_EM2R_MASK)
...
#define TPU_E_GCR_ET1R_ET1R(x)         (((uint32)(((uint32)(x))<<TPU_E_GCR_ET1R_ET1R_SHIFT))&TPU_E_GCR_ET1R_ET1R_MASK)
...
#define TPU_E_GCR_ET2R_ET2R(x)         (((uint32)(((uint32)(x))<<TPU_E_GCR_ET2R_ET2R_SHIFT))&TPU_E_GCR_ET2R_ET2R_MASK)
...
#define TPU_E_GCR_VHSR_HSR(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_VHSR_HSR_SHIFT))&TPU_E_GCR_VHSR_HSR_MASK)
...
#define TPU_E_GCR_AFGR_FLT_GRD(x)      (((uint32)(((uint32)(x))<<TPU_E_GCR_AFGR_FLT_GRD_SHIFT))&TPU_E_GCR_AFGR_FLT_GRD_MASK)
...
#define TPU_E_GCR_ASR_ERROR(x)         (((uint32)(((uint32)(x))<<TPU_E_GCR_ASR_ERROR_SHIFT))&TPU_E_GCR_ASR_ERROR_MASK)
...
#define TPU_E_GCR_ASR_ENDIAN(x)        (((uint32)(((uint32)(x))<<TPU_E_GCR_ASR_ENDIAN_SHIFT))&TPU_E_GCR_ASR_ENDIAN_MASK)
...
#define TPU_E_GCR_AID_ETCS(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_AID_ETCS_SHIFT))&TPU_E_GCR_AID_ETCS_MASK)
...
#define TPU_E_GCR_AID_COND(x)          (((uint32)(((uint32)(x))<<TPU_E_GCR_AID_COND_SHIFT))&TPU_E_GCR_AID_COND_MASK)
...
#define TPU_E_GCR_AID_ID(x)            (((uint32)(((uint32)(x))<<TPU_E_GCR_AID_ID_SHIFT))&TPU_E_GCR_AID_ID_MASK)
...
#define TPU_E_TBR_CR_TCR1P(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_CR_TCR1P_SHIFT))&TPU_E_TBR_CR_TCR1P_MASK)
...
#define TPU_E_TBR_CR_TCR1CTL(x)        (((uint32)(((uint32)(x))<<TPU_E_TBR_CR_TCR1CTL_SHIFT))&TPU_E_TBR_CR_TCR1CTL_MASK)
...
#define TPU_E_TBR_CR_TCR2P(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_CR_TCR2P_SHIFT))&TPU_E_TBR_CR_TCR2P_MASK)
...
#define TPU_E_TBR_CR_ATGC(x)           (((uint32)(((uint32)(x))<<TPU_E_TBR_CR_ATGC_SHIFT))&TPU_E_TBR_CR_ATGC_MASK)
...
#define TPU_E_TBR_CR_AM(x)             (((uint32)(((uint32)(x))<<TPU_E_TBR_CR_AM_SHIFT))&TPU_E_TBR_CR_AM_MASK)
...
#define TPU_E_TBR_CR_TCRCF(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_CR_TCRCF_SHIFT))&TPU_E_TBR_CR_TCRCF_MASK)
...
#define TPU_E_TBR_CR_TCR2CTL(x)        (((uint32)(((uint32)(x))<<TPU_E_TBR_CR_TCR2CTL_SHIFT))&TPU_E_TBR_CR_TCR2CTL_MASK)
...
#define TPU_E_TBR_T1R_TCR1(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_T1R_TCR1_SHIFT))&TPU_E_TBR_T1R_TCR1_MASK)
...
#define TPU_E_TBR_T2R_TCR2(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_T2R_TCR2_SHIFT))&TPU_E_TBR_T2R_TCR2_MASK)
...
#define TPU_E_TBR_TPR_LAST(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_TPR_LAST_SHIFT))&TPU_E_TBR_TPR_LAST_MASK)
...
#define TPU_E_TBR_TPR_MISSCNT(x)       (((uint32)(((uint32)(x))<<TPU_E_TBR_TPR_MISSCNT_SHIFT))&TPU_E_TBR_TPR_MISSCNT_MASK)
...
#define TPU_E_TBR_TPR_IPH(x)           (((uint32)(((uint32)(x))<<TPU_E_TBR_TPR_IPH_SHIFT))&TPU_E_TBR_TPR_IPH_MASK)
...
#define TPU_E_TBR_TPR_HOLD(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_TPR_HOLD_SHIFT))&TPU_E_TBR_TPR_HOLD_MASK)
...
#define TPU_E_TBR_TPR_TPR10(x)         (((uint32)(((uint32)(x))<<TPU_E_TBR_TPR_TPR10_SHIFT))&TPU_E_TBR_TPR_TPR10_MASK)
...
#define TPU_E_TBR_TPR_TICKS(x)         (((uint32)(((uint32)(x))<<TPU_E_TBR_TPR_TICKS_SHIFT))&TPU_E_TBR_TPR_TICKS_MASK)
...
#define TPU_E_TBR_TRR_INTEGER(x)       (((uint32)(((uint32)(x))<<TPU_E_TBR_TRR_INTEGER_SHIFT))&TPU_E_TBR_TRR_INTEGER_MASK)
...
#define TPU_E_TBR_TRR_FRACTION(x)      (((uint32)(((uint32)(x))<<TPU_E_TBR_TRR_FRACTION_SHIFT))&TPU_E_TBR_TRR_FRACTION_MASK)
...
#define TPU_E_TBR_T1MR_OVF(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_T1MR_OVF_SHIFT))&TPU_E_TBR_T1MR_OVF_MASK)
...
#define TPU_E_TBR_T1MR_IRQ_EN(x)       (((uint32)(((uint32)(x))<<TPU_E_TBR_T1MR_IRQ_EN_SHIFT))&TPU_E_TBR_T1MR_IRQ_EN_MASK)
...
#define TPU_E_TBR_T1MR_MAX(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_T1MR_MAX_SHIFT))&TPU_E_TBR_T1MR_MAX_MASK)
...
#define TPU_E_TBR_T2MR_OVF(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_T2MR_OVF_SHIFT))&TPU_E_TBR_T2MR_OVF_MASK)
...
#define TPU_E_TBR_T2MR_IRQ_EN(x)       (((uint32)(((uint32)(x))<<TPU_E_TBR_T2MR_IRQ_EN_SHIFT))&TPU_E_TBR_T2MR_IRQ_EN_MASK)
...
#define TPU_E_TBR_T2MR_MAX(x)          (((uint32)(((uint32)(x))<<TPU_E_TBR_T2MR_MAX_SHIFT))&TPU_E_TBR_T2MR_MAX_MASK)
...
#define TPU_E_CHn_CR_CIE(x)            (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_CIE_SHIFT))&TPU_E_CHn_CR_CIE_MASK)
...
#define TPU_E_CHn_CR_CPR(x)            (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_CPR_SHIFT))&TPU_E_CHn_CR_CPR_MASK)
...
#define TPU_E_CHn_CR_CFB(x)            (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_CFB_SHIFT))&TPU_E_CHn_CR_CFB_MASK)
...
#define TPU_E_CHn_CR_CFS(x)            (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_CFS_SHIFT))&TPU_E_CHn_CR_CFS_MASK)
...
#define TPU_E_CHn_CR_ETPD(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_ETPD_SHIFT))&TPU_E_CHn_CR_ETPD_MASK)
...
#define TPU_E_CHn_CR_ECTS(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_ECTS_SHIFT))&TPU_E_CHn_CR_ECTS_MASK)
...
#define TPU_E_CHn_CR_FLG1(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_FLG1_SHIFT))&TPU_E_CHn_CR_FLG1_MASK)
...
#define TPU_E_CHn_CR_FLG0(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_FLG0_SHIFT))&TPU_E_CHn_CR_FLG0_MASK)
...
#define TPU_E_CHn_CR_OPOL(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_OPOL_SHIFT))&TPU_E_CHn_CR_OPOL_MASK)
...
#define TPU_E_CHn_CR_ODIS(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_ODIS_SHIFT))&TPU_E_CHn_CR_ODIS_MASK)
...
#define TPU_E_CHn_CR_CHSA(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR_CHSA_SHIFT))&TPU_E_CHn_CR_CHSA_MASK)
...
#define TPU_E_CHn_SR_CIS(x)            (((uint32)(((uint32)(x))<<TPU_E_CHn_SR_CIS_SHIFT))&TPU_E_CHn_SR_CIS_MASK)
...
#define TPU_E_CHn_SR_CHRS(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_SR_CHRS_SHIFT))&TPU_E_CHn_SR_CHRS_MASK)
...
#define TPU_E_CHn_SR_CHRI(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_SR_CHRI_SHIFT))&TPU_E_CHn_SR_CHRI_MASK)
...
#define TPU_E_CHn_SR_CEIS(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_SR_CEIS_SHIFT))&TPU_E_CHn_SR_CEIS_MASK)
...
#define TPU_E_CHn_SR_CHDS(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_SR_CHDS_SHIFT))&TPU_E_CHn_SR_CHDS_MASK)
...
#define TPU_E_CHn_SR_CTS(x)            (((uint32)(((uint32)(x))<<TPU_E_CHn_SR_CTS_SHIFT))&TPU_E_CHn_SR_CTS_MASK)
...
#define TPU_E_CHn_SR_CHAS(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_SR_CHAS_SHIFT))&TPU_E_CHn_SR_CHAS_MASK)
...
#define TPU_E_CHn_SCR_CISC(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_SCR_CISC_SHIFT))&TPU_E_CHn_SCR_CISC_MASK)
...
#define TPU_E_CHn_SCR_CHDT(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_SCR_CHDT_SHIFT))&TPU_E_CHn_SCR_CHDT_MASK)
...
#define TPU_E_CHn_SCR_CHRC(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_SCR_CHRC_SHIFT))&TPU_E_CHn_SCR_CHRC_MASK)
...
#define TPU_E_CHn_SCR_CHAT(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_SCR_CHAT_SHIFT))&TPU_E_CHn_SCR_CHAT_MASK)
...
#define TPU_E_CHn_EFR_CSR(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_CSR_SHIFT))&TPU_E_CHn_EFR_CSR_MASK)
...
#define TPU_E_CHn_EFR_CHSR(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_CHSR_SHIFT))&TPU_E_CHn_EFR_CHSR_MASK)
...
#define TPU_E_CHn_EFR_EMRL1(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_EMRL1_SHIFT))&TPU_E_CHn_EFR_EMRL1_MASK)
...
#define TPU_E_CHn_EFR_EMRL2(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_EMRL2_SHIFT))&TPU_E_CHn_EFR_EMRL2_MASK)
...
#define TPU_E_CHn_EFR_ETDL1(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_ETDL1_SHIFT))&TPU_E_CHn_EFR_ETDL1_MASK)
...
#define TPU_E_CHn_EFR_ETDL2(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_ETDL2_SHIFT))&TPU_E_CHn_EFR_ETDL2_MASK)
...
#define TPU_E_CHn_EFR_MRLE1(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_MRLE1_SHIFT))&TPU_E_CHn_EFR_MRLE1_MASK)
...
#define TPU_E_CHn_EFR_MRLE2(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_MRLE2_SHIFT))&TPU_E_CHn_EFR_MRLE2_MASK)
...
#define TPU_E_CHn_EFR_MRL1(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_MRL1_SHIFT))&TPU_E_CHn_EFR_MRL1_MASK)
...
#define TPU_E_CHn_EFR_MRL2(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_MRL2_SHIFT))&TPU_E_CHn_EFR_MRL2_MASK)
...
#define TPU_E_CHn_EFR_TDL1(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_TDL1_SHIFT))&TPU_E_CHn_EFR_TDL1_MASK)
...
#define TPU_E_CHn_EFR_TDL2(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_EFR_TDL2_SHIFT))&TPU_E_CHn_EFR_TDL2_MASK)
...
#define TPU_E_CHn_CR2_TBS1(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_TBS1_SHIFT))&TPU_E_CHn_CR2_TBS1_MASK)
...
#define TPU_E_CHn_CR2_PSTI(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_PSTI_SHIFT))&TPU_E_CHn_CR2_PSTI_MASK)
...
#define TPU_E_CHn_CR2_PSTO(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_PSTO_SHIFT))&TPU_E_CHn_CR2_PSTO_MASK)
...
#define TPU_E_CHn_CR2_PRSS(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_PRSS_SHIFT))&TPU_E_CHn_CR2_PRSS_MASK)
...
#define TPU_E_CHn_CR2_IPAC1(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_IPAC1_SHIFT))&TPU_E_CHn_CR2_IPAC1_MASK)
...
#define TPU_E_CHn_CR2_OBE(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_OBE_SHIFT))&TPU_E_CHn_CR2_OBE_MASK)
...
#define TPU_E_CHn_CR2_OPAC1(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_OPAC1_SHIFT))&TPU_E_CHn_CR2_OPAC1_MASK)
...
#define TPU_E_CHn_CR2_TBS2(x)          (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_TBS2_SHIFT))&TPU_E_CHn_CR2_TBS2_MASK)
...
#define TPU_E_CHn_CR2_IPAC2(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_IPAC2_SHIFT))&TPU_E_CHn_CR2_IPAC2_MASK)
...
#define TPU_E_CHn_CR2_OPAC2(x)         (((uint32)(((uint32)(x))<<TPU_E_CHn_CR2_OPAC2_SHIFT))&TPU_E_CHn_CR2_OPAC2_MASK)
...
#define TPU_E_CHn_MR_SRIE(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_MR_SRIE_SHIFT))&TPU_E_CHn_MR_SRIE_MASK)
...
#define TPU_E_CHn_MR_SRI(x)            (((uint32)(((uint32)(x))<<TPU_E_CHn_MR_SRI_SHIFT))&TPU_E_CHn_MR_SRI_MASK)
...
#define TPU_E_CHn_MR_PDME(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_MR_PDME_SHIFT))&TPU_E_CHn_MR_PDME_MASK)
...
#define TPU_E_CHn_MR_PDCM(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_MR_PDCM_SHIFT))&TPU_E_CHn_MR_PDCM_MASK)
...
#define TPU_E_CHn_MR_TCCE(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_MR_TCCE_SHIFT))&TPU_E_CHn_MR_TCCE_MASK)
...
#define TPU_E_CHn_MR_UDME(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_MR_UDME_SHIFT))&TPU_E_CHn_MR_UDME_MASK)
...
#define TPU_E_CHn_MR_UDCM(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_MR_UDCM_SHIFT))&TPU_E_CHn_MR_UDCM_MASK)
...
#define TPU_E_CHn_ER1_ERW(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_ER1_ERW_SHIFT))&TPU_E_CHn_ER1_ERW_MASK)
...
#define TPU_E_CHn_ER1_MEF(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_ER1_MEF_SHIFT))&TPU_E_CHn_ER1_MEF_MASK)
...
#define TPU_E_CHn_ER1_ERS(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_ER1_ERS_SHIFT))&TPU_E_CHn_ER1_ERS_MASK)
...
#define TPU_E_CHn_ER1_ER1(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_ER1_ER1_SHIFT))&TPU_E_CHn_ER1_ER1_MASK)
...
#define TPU_E_CHn_ER2_ERW(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_ER2_ERW_SHIFT))&TPU_E_CHn_ER2_ERW_MASK)
...
#define TPU_E_CHn_ER2_ER2(x)           (((uint32)(((uint32)(x))<<TPU_E_CHn_ER2_ER2_SHIFT))&TPU_E_CHn_ER2_ER2_MASK)
...
#define TPU_E_CHn_ECR_MRE1_CLR(x)      (((uint32)(((uint32)(x))<<TPU_E_CHn_ECR_MRE1_CLR_SHIFT))&TPU_E_CHn_ECR_MRE1_CLR_MASK)
...
#define TPU_E_CHn_ECR_MRL1_CLR(x)      (((uint32)(((uint32)(x))<<TPU_E_CHn_ECR_MRL1_CLR_SHIFT))&TPU_E_CHn_ECR_MRL1_CLR_MASK)
...
#define TPU_E_CHn_ECR_TDL1_CLR(x)      (((uint32)(((uint32)(x))<<TPU_E_CHn_ECR_TDL1_CLR_SHIFT))&TPU_E_CHn_ECR_TDL1_CLR_MASK)
...
#define TPU_E_CHn_ECR_MRE2_CLR(x)      (((uint32)(((uint32)(x))<<TPU_E_CHn_ECR_MRE2_CLR_SHIFT))&TPU_E_CHn_ECR_MRE2_CLR_MASK)
...
#define TPU_E_CHn_ECR_MRL2_CLR(x)      (((uint32)(((uint32)(x))<<TPU_E_CHn_ECR_MRL2_CLR_SHIFT))&TPU_E_CHn_ECR_MRL2_CLR_MASK)
...
#define TPU_E_CHn_ECR_TDL2_CLR(x)      (((uint32)(((uint32)(x))<<TPU_E_CHn_ECR_TDL2_CLR_SHIFT))&TPU_E_CHn_ECR_TDL2_CLR_MASK)
...
#define TPU_E_CHn_OCR_OUT_HIS(x)       (((uint32)(((uint32)(x))<<TPU_E_CHn_OCR_OUT_HIS_SHIFT))&TPU_E_CHn_OCR_OUT_HIS_MASK)
