...
*   @version 1.5.1
*
*   @brief   AUTOSAR Stardard Register Macros.
*   @details This file contains AUTOSAR Stardard Register Macros.
*
*   @addtogroup Common
*   @{
*
...
==================================================================================================*/
#define STDREGMACROS_VENDOR_ID                    174
#define STDREGMACROS_MODULE_ID                    0
#define STDREGMACROS_AR_RELEASE_MAJOR_VERSION     4
#define STDREGMACROS_AR_RELEASE_MINOR_VERSION     6
#define STDREGMACROS_AR_RELEASE_REVISION_VERSION  0
#define STDREGMACROS_SW_MAJOR_VERSION             1
#define STDREGMACROS_SW_MINOR_VERSION             5
