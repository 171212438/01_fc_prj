...
==================================================================================================*/
#ifndef CDD_MSC_REG_H_
#define CDD_MSC_REG_H_
#ifdef __cplusplus
 extern "C" {
#endif
 ...
 * Reason: This type may be used in some cases*/
typedef struct {



  __IO uint32 GCR                           ; /* Global Control Register, offset: 0x00 */

  __O  uint32 CCULR                         ; /* Channel Control Unlock Register, offset: 0x04 */

       uint8  RESERVED_0[8];

  __IO uint32 RCCSR                         ; /* Reception Channel Control and Status Register, offset: 0x10 */

  __IO uint32 TCCTR                         ; /* Transmitting Channel Control Register, offset: 0x14 */

  __IO uint32 TCSTR                         ; /* Transmitting Channel Status Register, offset: 0x18 */

  __IO uint32 TCDAR                         ; /* Transmitting Channel Data Register, offset: 0x1c */

  __IO uint32 TCCOR                         ; /* Transmitting Channel Command Register, offset: 0x20 */

  __IO uint32 TCSLR                         ; /* Transmitting Channel Source Selection Low Register, offset: 0x24 */

  __IO uint32 TCSHR                         ; /* Transmitting Channel Source Selection High Register, offset: 0x28 */

  __IO uint32 TCELR                         ; /* Transmitting Channel Emergency Load Register, offset: 0x2c */

  __IO uint32 RDR0                          ; /* Reception Data Register0, offset: 0x30 */

  __IO uint32 RDR1                          ; /* Reception Data Register1, offset: 0x34 */

  __IO uint32 RDR2                          ; /* Reception Data Register2, offset: 0x38 */

  __IO uint32 RDR3                          ; /* Reception Data Register3, offset: 0x3c */

  __IO uint32 INCR                          ; /* Interrupt Control Register, offset: 0x40 */

  __I  uint32 INSR                          ; /* Interrupt Status Register, offset: 0x44 */

  __O  uint32 ISCR                          ; /* Interrupt Set/Clear Register, offset: 0x48 */

  __IO uint32 IOCR                          ; /* Input/Output Control Register, offset: 0x4c */

       uint8  RESERVED_1[8];

  __IO uint32 TCCTR1                        ; /* Transmitting Channel Control Register1, offset: 0x58 */

  __IO uint32 RTOR                          ; /* Reception time-out register, offset: 0x5c */

       uint8  RESERVED_2[140];

  __IO uint32 SRCR                          ; /* Software Reset Clear Register, offset: 0xec */

       uint8  RESERVED_3[4];

  __IO uint32 MSR                           ; /* MSC Software Reset Register, offset: 0xf4 */
...
#define MSC_BASE_ADDRS                           {MSC0_BASE, MSC1_BASE}

/** Array initializer of MSC peripheral base pointers */

#define MSC_BASE_PTRS                            {MSC0, MSC1}

#define MSC_RDRx_PTRS                            {{&MSC0->RDR0, &MSC0->RDR1, &MSC0->RDR2, &MSC0->RDR3},{&MSC1->RDR0, &MSC1->RDR1, &MSC1->RDR2, &MSC1->RDR3}}
...
#define MSC_TCCTR_PL(x)                (((uint32)(((uint32)(x))<<MSC_TCCTR_PL_SHIFT))&MSC_TCCTR_PL_MASK)
...
#define MSC_TCCTR_NBS(x)               (((uint32)(((uint32)(x))<<MSC_TCCTR_NBS_SHIFT))&MSC_TCCTR_NBS_MASK)
...
#define MSC_TCCTR_TCDIS(x)             (((uint32)(((uint32)(x))<<MSC_TCCTR_TCDIS_SHIFT))&MSC_TCCTR_TCDIS_MASK)
...
#define MSC_TCCTR_SELH(x)              (((uint32)(((uint32)(x))<<MSC_TCCTR_SELH_SHIFT))&MSC_TCCTR_SELH_MASK)
...
#define MSC_TCCTR_SELL(x)              (((uint32)(((uint32)(x))<<MSC_TCCTR_SELL_SHIFT))&MSC_TCCTR_SELL_MASK)
...
#define MSC_TCCTR_NHBS(x)              (((uint32)(((uint32)(x))<<MSC_TCCTR_NHBS_SHIFT))&MSC_TCCTR_NHBS_MASK)
...
#define MSC_TCCTR_NLBS(x)              (((uint32)(((uint32)(x))<<MSC_TCCTR_NLBS_SHIFT))&MSC_TCCTR_NLBS_MASK)
...
#define MSC_TCCTR_DTS(x)               (((uint32)(((uint32)(x))<<MSC_TCCTR_DTS_SHIFT))&MSC_TCCTR_DTS_MASK)
...
#define MSC_TCCTR_CTS(x)               (((uint32)(((uint32)(x))<<MSC_TCCTR_CTS_SHIFT))&MSC_TCCTR_CTS_MASK)
...
#define MSC_TCCTR_WM(x)                (((uint32)(((uint32)(x))<<MSC_TCCTR_WM_SHIFT))&MSC_TCCTR_WM_MASK)
...
#define MSC_TCSTR_CFB(x)               (((uint32)(((uint32)(x))<<MSC_TCSTR_CFB_SHIFT))&MSC_TCSTR_CFB_MASK)
...
#define MSC_TCSTR_DFB(x)               (((uint32)(((uint32)(x))<<MSC_TCSTR_DFB_SHIFT))&MSC_TCSTR_DFB_MASK)

#define MSC_TCSTR_TCSC_MASK            0xFF0000u

#define MSC_TCSTR_TCSC_SHIFT           16u

#define MSC_TCSTR_TCSC_WIDTH           8u

#define MSC_TCSTR_TCSC(x)              (((uint32)(((uint32)(x))<<MSC_TCSTR_TCSC_SHIFT))&MSC_TCSTR_TCSC_MASK)
...
#define MSC_TCSTR_NP(x)                (((uint32)(((uint32)(x))<<MSC_TCSTR_NP_SHIFT))&MSC_TCSTR_NP_MASK)

#define MSC_TCSTR_PTFC_MASK            0xFu

#define MSC_TCSTR_PTFC_SHIFT           0u

#define MSC_TCSTR_PTFC_WIDTH           4u

#define MSC_TCSTR_PTFC(x)              (((uint32)(((uint32)(x))<<MSC_TCSTR_PTFC_SHIFT))&MSC_TCSTR_PTFC_MASK)

/* TCSTR Reg Mask */

#define MSC_TCSTR_MASK                 0x03FF0F0Fu
...
#define MSC_TCDAR_TDH(x)               (((uint32)(((uint32)(x))<<MSC_TCDAR_TDH_SHIFT))&MSC_TCDAR_TDH_MASK)
...
#define MSC_TCDAR_TDL(x)               (((uint32)(((uint32)(x))<<MSC_TCDAR_TDL_SHIFT))&MSC_TCDAR_TDL_MASK)
...
#define MSC_TCCOR_TCH(x)               (((uint32)(((uint32)(x))<<MSC_TCCOR_TCH_SHIFT))&MSC_TCCOR_TCH_MASK)
...
#define MSC_TCCOR_TCL(x)               (((uint32)(((uint32)(x))<<MSC_TCCOR_TCL_SHIFT))&MSC_TCCOR_TCL_MASK)
...
#define MSC_TCSLR_SSL15(x)             (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL15_SHIFT))&MSC_TCSLR_SSL15_MASK)
...
#define MSC_TCSLR_SSL14(x)             (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL14_SHIFT))&MSC_TCSLR_SSL14_MASK)
...
#define MSC_TCSLR_SSL13(x)             (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL13_SHIFT))&MSC_TCSLR_SSL13_MASK)
...
#define MSC_TCSLR_SSL12(x)             (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL12_SHIFT))&MSC_TCSLR_SSL12_MASK)
...
#define MSC_TCSLR_SSL11(x)             (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL11_SHIFT))&MSC_TCSLR_SSL11_MASK)
...
#define MSC_TCSLR_SSL10(x)             (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL10_SHIFT))&MSC_TCSLR_SSL10_MASK)
...
#define MSC_TCSLR_SSL9(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL9_SHIFT))&MSC_TCSLR_SSL9_MASK)
...
#define MSC_TCSLR_SSL8(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL8_SHIFT))&MSC_TCSLR_SSL8_MASK)
...
#define MSC_TCSLR_SSL7(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL7_SHIFT))&MSC_TCSLR_SSL7_MASK)
...
#define MSC_TCSLR_SSL6(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL6_SHIFT))&MSC_TCSLR_SSL6_MASK)
...
#define MSC_TCSLR_SSL5(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL5_SHIFT))&MSC_TCSLR_SSL5_MASK)
...
#define MSC_TCSLR_SSL4(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL4_SHIFT))&MSC_TCSLR_SSL4_MASK)
...
#define MSC_TCSLR_SSL3(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL3_SHIFT))&MSC_TCSLR_SSL3_MASK)
...
#define MSC_TCSLR_SSL2(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL2_SHIFT))&MSC_TCSLR_SSL2_MASK)
...
#define MSC_TCSLR_SSL1(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL1_SHIFT))&MSC_TCSLR_SSL1_MASK)
...
#define MSC_TCSLR_SSL0(x)              (((uint32)(((uint32)(x))<<MSC_TCSLR_SSL0_SHIFT))&MSC_TCSLR_SSL0_MASK)
...
#define MSC_TCSHR_SSH15(x)             (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH15_SHIFT))&MSC_TCSHR_SSH15_MASK)
...
#define MSC_TCSHR_SSH14(x)             (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH14_SHIFT))&MSC_TCSHR_SSH14_MASK)
...
#define MSC_TCSHR_SSH13(x)             (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH13_SHIFT))&MSC_TCSHR_SSH13_MASK)
...
#define MSC_TCSHR_SSH12(x)             (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH12_SHIFT))&MSC_TCSHR_SSH12_MASK)
...
#define MSC_TCSHR_SSH11(x)             (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH11_SHIFT))&MSC_TCSHR_SSH11_MASK)
...
#define MSC_TCSHR_SSH10(x)             (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH10_SHIFT))&MSC_TCSHR_SSH10_MASK)
...
#define MSC_TCSHR_SSH9(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH9_SHIFT))&MSC_TCSHR_SSH9_MASK)
...
#define MSC_TCSHR_SSH8(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH8_SHIFT))&MSC_TCSHR_SSH8_MASK)
...
#define MSC_TCSHR_SSH7(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH7_SHIFT))&MSC_TCSHR_SSH7_MASK)
...
#define MSC_TCSHR_SSH6(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH6_SHIFT))&MSC_TCSHR_SSH6_MASK)
...
#define MSC_TCSHR_SSH5(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH5_SHIFT))&MSC_TCSHR_SSH5_MASK)
...
#define MSC_TCSHR_SSH4(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH4_SHIFT))&MSC_TCSHR_SSH4_MASK)
...
#define MSC_TCSHR_SSH3(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH3_SHIFT))&MSC_TCSHR_SSH3_MASK)
...
#define MSC_TCSHR_SSH2(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH2_SHIFT))&MSC_TCSHR_SSH2_MASK)
...
#define MSC_TCSHR_SSH1(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH1_SHIFT))&MSC_TCSHR_SSH1_MASK)
...
#define MSC_TCSHR_SSH0(x)              (((uint32)(((uint32)(x))<<MSC_TCSHR_SSH0_SHIFT))&MSC_TCSHR_SSH0_MASK)
...
#define MSC_TCELR_EHE15(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_EHE15_SHIFT))&MSC_TCELR_EHE15_MASK)
...
#define MSC_TCELR_EHE14(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_EHE14_SHIFT))&MSC_TCELR_EHE14_MASK)
...
#define MSC_TCELR_EHE13(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_EHE13_SHIFT))&MSC_TCELR_EHE13_MASK)
...
#define MSC_TCELR_EHE12(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_EHE12_SHIFT))&MSC_TCELR_EHE12_MASK)
...
#define MSC_TCELR_EHE11(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_EHE11_SHIFT))&MSC_TCELR_EHE11_MASK)
...
#define MSC_TCELR_EHE10(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_EHE10_SHIFT))&MSC_TCELR_EHE10_MASK)
...
#define MSC_TCELR_EHE9(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE9_SHIFT))&MSC_TCELR_EHE9_MASK)
...
#define MSC_TCELR_EHE8(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE8_SHIFT))&MSC_TCELR_EHE8_MASK)
...
#define MSC_TCELR_EHE7(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE7_SHIFT))&MSC_TCELR_EHE7_MASK)
...
#define MSC_TCELR_EHE6(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE6_SHIFT))&MSC_TCELR_EHE6_MASK)
...
#define MSC_TCELR_EHE5(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE5_SHIFT))&MSC_TCELR_EHE5_MASK)
...
#define MSC_TCELR_EHE4(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE4_SHIFT))&MSC_TCELR_EHE4_MASK)
...
#define MSC_TCELR_EHE3(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE3_SHIFT))&MSC_TCELR_EHE3_MASK)
...
#define MSC_TCELR_EHE2(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE2_SHIFT))&MSC_TCELR_EHE2_MASK)
...
#define MSC_TCELR_EHE1(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE1_SHIFT))&MSC_TCELR_EHE1_MASK)
...
#define MSC_TCELR_EHE0(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_EHE0_SHIFT))&MSC_TCELR_EHE0_MASK)
...
#define MSC_TCELR_ELE15(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_ELE15_SHIFT))&MSC_TCELR_ELE15_MASK)
...
#define MSC_TCELR_ELE14(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_ELE14_SHIFT))&MSC_TCELR_ELE14_MASK)
...
#define MSC_TCELR_ELE13(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_ELE13_SHIFT))&MSC_TCELR_ELE13_MASK)
...
#define MSC_TCELR_ELE12(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_ELE12_SHIFT))&MSC_TCELR_ELE12_MASK)
...
#define MSC_TCELR_ELE11(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_ELE11_SHIFT))&MSC_TCELR_ELE11_MASK)
...
#define MSC_TCELR_ELE10(x)             (((uint32)(((uint32)(x))<<MSC_TCELR_ELE10_SHIFT))&MSC_TCELR_ELE10_MASK)
...
#define MSC_TCELR_ELE9(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE9_SHIFT))&MSC_TCELR_ELE9_MASK)
...
#define MSC_TCELR_ELE8(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE8_SHIFT))&MSC_TCELR_ELE8_MASK)
...
#define MSC_TCELR_ELE7(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE7_SHIFT))&MSC_TCELR_ELE7_MASK)
...
#define MSC_TCELR_ELE6(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE6_SHIFT))&MSC_TCELR_ELE6_MASK)
...
#define MSC_TCELR_ELE5(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE5_SHIFT))&MSC_TCELR_ELE5_MASK)
...
#define MSC_TCELR_ELE4(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE4_SHIFT))&MSC_TCELR_ELE4_MASK)
...
#define MSC_TCELR_ELE3(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE3_SHIFT))&MSC_TCELR_ELE3_MASK)
...
#define MSC_TCELR_ELE2(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE2_SHIFT))&MSC_TCELR_ELE2_MASK)
...
#define MSC_TCELR_ELE1(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE1_SHIFT))&MSC_TCELR_ELE1_MASK)
...
#define MSC_TCELR_ELE0(x)              (((uint32)(((uint32)(x))<<MSC_TCELR_ELE0_SHIFT))&MSC_TCELR_ELE0_MASK)
...
#define MSC_IOCR_IDS(x)                (((uint32)(((uint32)(x))<<MSC_IOCR_IDS_SHIFT))&MSC_IOCR_IDS_MASK)
...
#define MSC_IOCR_ESC(x)                (((uint32)(((uint32)(x))<<MSC_IOCR_ESC_SHIFT))&MSC_IOCR_ESC_MASK)
...
#define MSC_IOCR_ESH(x)                (((uint32)(((uint32)(x))<<MSC_IOCR_ESH_SHIFT))&MSC_IOCR_ESH_MASK)
...
#define MSC_IOCR_ESL(x)                (((uint32)(((uint32)(x))<<MSC_IOCR_ESL_SHIFT))&MSC_IOCR_ESL_MASK)
...
#define MSC_IOCR_FCLCTRL(x)            (((uint32)(((uint32)(x))<<MSC_IOCR_FCLCTRL_SHIFT))&MSC_IOCR_FCLCTRL_MASK)
...
#define MSC_IOCR_IPS(x)                (((uint32)(((uint32)(x))<<MSC_IOCR_IPS_SHIFT))&MSC_IOCR_IPS_MASK)
...
#define MSC_IOCR_ENP(x)                (((uint32)(((uint32)(x))<<MSC_IOCR_ENP_SHIFT))&MSC_IOCR_ENP_MASK)
...
#define MSC_IOCR_SOP(x)                (((uint32)(((uint32)(x))<<MSC_IOCR_SOP_SHIFT))&MSC_IOCR_SOP_MASK)
...
#define MSC_IOCR_FCLP(x)               (((uint32)(((uint32)(x))<<MSC_IOCR_FCLP_SHIFT))&MSC_IOCR_FCLP_MASK)
...
#define MSC_ISCR_SDIS(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_SDIS_SHIFT))&MSC_ISCR_SDIS_MASK)
...
#define MSC_ISCR_SDTS(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_SDTS_SHIFT))&MSC_ISCR_SDTS_MASK)
...
#define MSC_ISCR_SRFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_SRFI_SHIFT))&MSC_ISCR_SRFI_MASK)
...
#define MSC_ISCR_STFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_STFI_SHIFT))&MSC_ISCR_STFI_MASK)
...
#define MSC_ISCR_SCFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_SCFI_SHIFT))&MSC_ISCR_SCFI_MASK)
...
#define MSC_ISCR_SDFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_SDFI_SHIFT))&MSC_ISCR_SDFI_MASK)
...
#define MSC_ISCR_CDIS(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_CDIS_SHIFT))&MSC_ISCR_CDIS_MASK)
...
#define MSC_ISCR_CCTS(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_CCTS_SHIFT))&MSC_ISCR_CCTS_MASK)
...
#define MSC_ISCR_CDTS(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_CDTS_SHIFT))&MSC_ISCR_CDTS_MASK)
...
#define MSC_ISCR_CRFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_CRFI_SHIFT))&MSC_ISCR_CRFI_MASK)
...
#define MSC_ISCR_CTFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_CTFI_SHIFT))&MSC_ISCR_CTFI_MASK)
...
#define MSC_ISCR_CCFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_CCFI_SHIFT))&MSC_ISCR_CCFI_MASK)
...
#define MSC_ISCR_CDFI(x)               (((uint32)(((uint32)(x))<<MSC_ISCR_CDFI_SHIFT))&MSC_ISCR_CDFI_MASK)
...
#define MSC_INSR_RFI(x)                (((uint32)(((uint32)(x))<<MSC_INSR_RFI_SHIFT))&MSC_INSR_RFI_MASK)
...
#define MSC_INSR_TFI(x)                (((uint32)(((uint32)(x))<<MSC_INSR_TFI_SHIFT))&MSC_INSR_TFI_MASK)
...
#define MSC_INSR_CFI(x)                (((uint32)(((uint32)(x))<<MSC_INSR_CFI_SHIFT))&MSC_INSR_CFI_MASK)
...
#define MSC_INSR_DFI(x)                (((uint32)(((uint32)(x))<<MSC_INSR_DFI_SHIFT))&MSC_INSR_DFI_MASK)
...
#define MSC_INCR_RFIE(x)               (((uint32)(((uint32)(x))<<MSC_INCR_RFIE_SHIFT))&MSC_INCR_RFIE_MASK)
...
#define MSC_INCR_TFIE(x)               (((uint32)(((uint32)(x))<<MSC_INCR_TFIE_SHIFT))&MSC_INCR_TFIE_MASK)
...
#define MSC_INCR_CFIE(x)               (((uint32)(((uint32)(x))<<MSC_INCR_CFIE_SHIFT))&MSC_INCR_CFIE_MASK)
...
#define MSC_INCR_DFIE(x)               (((uint32)(((uint32)(x))<<MSC_INCR_DFIE_SHIFT))&MSC_INCR_DFIE_MASK)
...
#define MSC_RCCSR_RX_BUSY(x)           (((uint32)(((uint32)(x))<<MSC_RCCSR_RX_BUSY_SHIFT))&MSC_RCCSR_RX_BUSY_MASK)
...
#define MSC_RCCSR_RC(x)                (((uint32)(((uint32)(x))<<MSC_RCCSR_RC_SHIFT))&MSC_RCCSR_RC_MASK)
...
#define MSC_RCCSR_HIDC(x)              (((uint32)(((uint32)(x))<<MSC_RCCSR_HIDC_SHIFT))&MSC_RCCSR_HIDC_MASK)
...
#define MSC_RCCSR_PCTL(x)              (((uint32)(((uint32)(x))<<MSC_RCCSR_PCTL_SHIFT))&MSC_RCCSR_PCTL_MASK)
...
#define MSC_RCCSR_RBR(x)               (((uint32)(((uint32)(x))<<MSC_RCCSR_RBR_SHIFT))&MSC_RCCSR_RBR_MASK)
...
#define MSC_RCCSR_RFT(x)               (((uint32)(((uint32)(x))<<MSC_RCCSR_RFT_SHIFT))&MSC_RCCSR_RFT_MASK)

/* RCCSR Reg Mask */

#define MSC_RCCSR_MASK                 0x801F003Fu
...
#define MSC_RDR0_RERR(x)               (((uint32)(((uint32)(x))<<MSC_RDR0_RERR_SHIFT))&MSC_RDR0_RERR_MASK)
...
#define MSC_RDR0_PF(x)                 (((uint32)(((uint32)(x))<<MSC_RDR0_PF_SHIFT))&MSC_RDR0_PF_MASK)
...
#define MSC_RDR0_LAF(x)                (((uint32)(((uint32)(x))<<MSC_RDR0_LAF_SHIFT))&MSC_RDR0_LAF_MASK)
...
#define MSC_RDR0_CLR(x)                (((uint32)(((uint32)(x))<<MSC_RDR0_CLR_SHIFT))&MSC_RDR0_CLR_MASK)
...
#define MSC_RDR0_PB(x)                 (((uint32)(((uint32)(x))<<MSC_RDR0_PB_SHIFT))&MSC_RDR0_PB_MASK)
...
#define MSC_RDR0_VLD(x)                (((uint32)(((uint32)(x))<<MSC_RDR0_VLD_SHIFT))&MSC_RDR0_VLD_MASK)
...
#define MSC_RDR0_RDATA(x)              (((uint32)(((uint32)(x))<<MSC_RDR0_RDATA_SHIFT))&MSC_RDR0_RDATA_MASK)
...
#define MSC_RDR1_RERR(x)               (((uint32)(((uint32)(x))<<MSC_RDR1_RERR_SHIFT))&MSC_RDR1_RERR_MASK)
...
#define MSC_RDR1_PF(x)                 (((uint32)(((uint32)(x))<<MSC_RDR1_PF_SHIFT))&MSC_RDR1_PF_MASK)
...
#define MSC_RDR1_LAF(x)                (((uint32)(((uint32)(x))<<MSC_RDR1_LAF_SHIFT))&MSC_RDR1_LAF_MASK)
...
#define MSC_RDR1_CLR(x)                (((uint32)(((uint32)(x))<<MSC_RDR1_CLR_SHIFT))&MSC_RDR1_CLR_MASK)
...
#define MSC_RDR1_PB(x)                 (((uint32)(((uint32)(x))<<MSC_RDR1_PB_SHIFT))&MSC_RDR1_PB_MASK)
...
#define MSC_RDR1_VLD(x)                (((uint32)(((uint32)(x))<<MSC_RDR1_VLD_SHIFT))&MSC_RDR1_VLD_MASK)
...
#define MSC_RDR1_RDATA(x)              (((uint32)(((uint32)(x))<<MSC_RDR1_RDATA_SHIFT))&MSC_RDR1_RDATA_MASK)
...
#define MSC_RDR2_RERR(x)               (((uint32)(((uint32)(x))<<MSC_RDR2_RERR_SHIFT))&MSC_RDR2_RERR_MASK)
...
#define MSC_RDR2_PF(x)                 (((uint32)(((uint32)(x))<<MSC_RDR2_PF_SHIFT))&MSC_RDR2_PF_MASK)
...
#define MSC_RDR2_LAF(x)                (((uint32)(((uint32)(x))<<MSC_RDR2_LAF_SHIFT))&MSC_RDR2_LAF_MASK)
...
#define MSC_RDR2_CLR(x)                (((uint32)(((uint32)(x))<<MSC_RDR2_CLR_SHIFT))&MSC_RDR2_CLR_MASK)
...
#define MSC_RDR2_PB(x)                 (((uint32)(((uint32)(x))<<MSC_RDR2_PB_SHIFT))&MSC_RDR2_PB_MASK)
...
#define MSC_RDR2_VLD(x)                (((uint32)(((uint32)(x))<<MSC_RDR2_VLD_SHIFT))&MSC_RDR2_VLD_MASK)
...
#define MSC_RDR2_RDATA(x)              (((uint32)(((uint32)(x))<<MSC_RDR2_RDATA_SHIFT))&MSC_RDR2_RDATA_MASK)
...
#define MSC_RDR3_RERR(x)               (((uint32)(((uint32)(x))<<MSC_RDR3_RERR_SHIFT))&MSC_RDR3_RERR_MASK)
...
#define MSC_RDR3_PF(x)                 (((uint32)(((uint32)(x))<<MSC_RDR3_PF_SHIFT))&MSC_RDR3_PF_MASK)
...
#define MSC_RDR3_LAF(x)                (((uint32)(((uint32)(x))<<MSC_RDR3_LAF_SHIFT))&MSC_RDR3_LAF_MASK)
...
#define MSC_RDR3_CLR(x)                (((uint32)(((uint32)(x))<<MSC_RDR3_CLR_SHIFT))&MSC_RDR3_CLR_MASK)
...
#define MSC_RDR3_PB(x)                 (((uint32)(((uint32)(x))<<MSC_RDR3_PB_SHIFT))&MSC_RDR3_PB_MASK)
...
#define MSC_RDR3_VLD(x)                (((uint32)(((uint32)(x))<<MSC_RDR3_VLD_SHIFT))&MSC_RDR3_VLD_MASK)
...
#define MSC_RDR3_RDATA(x)              (((uint32)(((uint32)(x))<<MSC_RDR3_RDATA_SHIFT))&MSC_RDR3_RDATA_MASK)
...
#define MSC_MSR_RDONE(x)               (((uint32)(((uint32)(x))<<MSC_MSR_RDONE_SHIFT))&MSC_MSR_RDONE_MASK)
...
#define MSC_MSR_RST(x)                 (((uint32)(((uint32)(x))<<MSC_MSR_RST_SHIFT))&MSC_MSR_RST_MASK)
...
#define MSC_SRCR_RCLR(x)               (((uint32)(((uint32)(x))<<MSC_SRCR_RCLR_SHIFT))&MSC_SRCR_RCLR_MASK)
...
#define MSC_RTOR_TOFC(x)               (((uint32)(((uint32)(x))<<MSC_RTOR_TOFC_SHIFT))&MSC_RTOR_TOFC_MASK)
...
#define MSC_RTOR_TOFS(x)               (((uint32)(((uint32)(x))<<MSC_RTOR_TOFS_SHIFT))&MSC_RTOR_TOFS_MASK)
...
#define MSC_RTOR_TOF(x)                (((uint32)(((uint32)(x))<<MSC_RTOR_TOF_SHIFT))&MSC_RTOR_TOF_MASK)
...
#define MSC_RTOR_TOIE(x)               (((uint32)(((uint32)(x))<<MSC_RTOR_TOIE_SHIFT))&MSC_RTOR_TOIE_MASK)
...
#define MSC_RTOR_TOV(x)                (((uint32)(((uint32)(x))<<MSC_RTOR_TOV_SHIFT))&MSC_RTOR_TOV_MASK)
...
#define MSC_TCCTR1_INJP1(x)            (((uint32)(((uint32)(x))<<MSC_TCCTR1_INJP1_SHIFT))&MSC_TCCTR1_INJP1_MASK)
...
#define MSC_TCCTR1_INJE1(x)            (((uint32)(((uint32)(x))<<MSC_TCCTR1_INJE1_SHIFT))&MSC_TCCTR1_INJE1_MASK)
...
#define MSC_TCCTR1_INJP0(x)            (((uint32)(((uint32)(x))<<MSC_TCCTR1_INJP0_SHIFT))&MSC_TCCTR1_INJP0_MASK)
...
#define MSC_TCCTR1_INJE0(x)            (((uint32)(((uint32)(x))<<MSC_TCCTR1_INJE0_SHIFT))&MSC_TCCTR1_INJE0_MASK)
...
#define MSC_GCR_WP_EN(x)               (((uint32)(((uint32)(x))<<MSC_GCR_WP_EN_SHIFT))&MSC_GCR_WP_EN_MASK)
...
#define MSC_GCR_EN(x)                  (((uint32)(((uint32)(x))<<MSC_GCR_EN_SHIFT))&MSC_GCR_EN_MASK)
...
#define MSC_CCULR_SEQ(x)               (((uint32)(((uint32)(x))<<MSC_CCULR_SEQ_SHIFT))&MSC_CCULR_SEQ_MASK)
