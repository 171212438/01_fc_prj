...
==================================================================================================*/
#ifndef PWM_EFTU_TOM_REGOPS_H
#define PWM_EFTU_TOM_REGOPS_H
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetHostTriggerRequest(EFTU_TOM_Type *const pTOM)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableGlobalTimeBase(EFTU_TOM_Type *const pTOM)
{
 ...
 * @param pTOM Base address pointer to the EFTU_TOM module, used to access the module's registers
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableGlobalTimeBase(EFTU_TOM_Type *const pTOM)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_ResetChannel(EFTU_TOM_Type *const pTOM, uint8 u8ChannelMask)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableChannelUpdate(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 * @param u8Channel The channel number to enable for updates
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableChannelUpdate(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->TGC_GLB_CTRL = (pTOM->TGC_GLB_CTRL & (~(((uint32)EFTU_TOM_TGC_GLB_CTRL_UPEN_CTRL0_MASK)
                                                  << ((uint32)u8Channel << 1U)))) |
 ...
 * @return uint32 The current value of the TGC global control register
 */
LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_GetGlobalControl(EFTU_TOM_Type *const pTOM)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetGlobalControl(EFTU_TOM_Type *const pTOM, uint32 u32Value)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableChannelOnUpdateTrig(EFTU_TOM_Type *const pTOM,
                                                             uint8                u8Channel)
{
    pTOM->TGC_ENDIS_CTRL =
        (pTOM->TGC_ENDIS_CTRL &
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableChannelOnUpdateTrig(EFTU_TOM_Type *const pTOM,
                                                              uint8                u8Channel)
{
    pTOM->TGC_ENDIS_CTRL =
        (pTOM->TGC_ENDIS_CTRL &
...
/**
 * Enable or disable the channel on update trigger.
 *
 * @param pTOM Base address pointer of the EFTU_TOM peripheral to access its registers.
 * @param u32Value Value to write to the TGC_ENDIS_CTRL register. 0x2 to enable, 0x1 to disable.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetChannelEnDisOnUpdateTrig(EFTU_TOM_Type *const pTOM,
                                                               uint32               u32Value)
{
    /* Write the value to the TGC_ENDIS_CTRL register to enable or disable the channel on update trig */
    pTOM->TGC_ENDIS_CTRL = u32Value;
}
 ...
 * @param u8Channel The channel number to enable.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableChannel(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->TGC_ENDIS_STAT =
        (pTOM->TGC_ENDIS_STAT &
 ...
 * @param u8Channel The channel number to disable.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableChannel(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->TGC_ENDIS_STAT =
        (pTOM->TGC_ENDIS_STAT &
         (~((uint32)EFTU_TOM_TGC_ENDIS_STAT_ENDIS_STAT0_MASK << ((uint32)u8Channel << 1U)))) |
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetTimeBaseValue(EFTU_TOM_Type *const pTOM, uint32 u32Value)
{
 ...
 * @param pTOM Base address pointer of the EFTU_TOM peripheral to access its registers.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetTimeBaseTrigger(EFTU_TOM_Type *const pTOM)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SelectTimeBase(EFTU_TOM_Type *const           pTOM,
                                                  EFTU_TOM_TimeBaseSelectionType eSelection)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableChannelOutputOnUpdateTrig(EFTU_TOM_Type *const pTOM,
                                                                   uint8                u8Channel)
{
    pTOM->TGC_OUTEN_CTRL =
        (pTOM->TGC_OUTEN_CTRL &
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableChannelOutputOnUpdateTrig(EFTU_TOM_Type *const pTOM,
                                                                    uint8                u8Channel)
{
    pTOM->TGC_OUTEN_CTRL =
        (pTOM->TGC_OUTEN_CTRL &
...
/**
 * Enable or disable the output on update trigger.
 *
 * @param pTOM Pointer to the base address of the EFTU_TOM module, used to access the module's
 * registers.
 * @param u32Value Value to write to the TGC_OUTEN_CTRL register. 0x2 to enable, 0x1 to disable.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetChannelOutputEnDisOnUpdateTrig(EFTU_TOM_Type *const pTOM,
                                                                     uint32               u32Value)
{
    /* Write the value to the TGC_OUTEN_CTRL register to enable or disable the output on update trig */
    pTOM->TGC_OUTEN_CTRL = u32Value;
}
 ...
 * @param u8Channel The channel number to enable output.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableChannelOutput(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->TGC_OUTEN_STAT =
        (pTOM->TGC_OUTEN_STAT &
 ...
 * @param u8Channel The channel number to enable output.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableChannelOutput(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->TGC_OUTEN_STAT =
        (pTOM->TGC_OUTEN_STAT &
         (~(((uint32)EFTU_TOM_TGC_OUTEN_STAT_OUTEN_STAT0_MASK) << ((uint32)u8Channel << 1U)))) |
...
LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_ReadChannelOutput(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableForceUpdate(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableForceUpdate(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->TGC_FUPD_CTRL = (pTOM->TGC_FUPD_CTRL & (~(((uint32)EFTU_TOM_TGC_FUPD_CTRL_FUPD_CTRL0_MASK)
                                                    << ((uint32)u8Channel << 1U)))) |
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableForceUpdateResetCN0(EFTU_TOM_Type *const pTOM,
                                                             uint8                u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableForceUpdateResetCN0(EFTU_TOM_Type *const pTOM,
                                                              uint8                u8Channel)
{
    pTOM->TGC_FUPD_CTRL = (pTOM->TGC_FUPD_CTRL & (~(((uint32)EFTU_TOM_TGC_FUPD_CTRL_RSTCN0_CH0_MASK)
                                                    << ((uint32)u8Channel << 1U)))) |
...
/**
 * Enable or disable the force update.
 *
 * @param pTOM Pointer to the base address of the EFTU_TOM module, used to access the module's
 * registers.
 * @param u32Value Value to write to the TGC_FUPD_CTRL register. 0x2 to enable, 0x1 to disable.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnDisForceUpdate(EFTU_TOM_Type *const pTOM, uint32 u32Value)
{
    /* Write the value to the TGC_FUPD_CTRL register to enable or disable the force update */
    pTOM->TGC_FUPD_CTRL = u32Value;
}
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableInternalTrigger(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 * @param u8Channel Channel number of the EFTU_TOM module, specifying which channel to configure
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableInternalTrigger(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->TGC_INT_TRIG = (pTOM->TGC_INT_TRIG & (~(((uint32)EFTU_TOM_TGC_INT_TRIG_INT_TRIG0_MASK)
                                                  << ((uint32)u8Channel << 1U)))) |
 ...
 * the module.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_LockSpecialLock(EFTU_TOM_Type *const pTOM)
{
 ...
 * the module.
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_UnlockSpecialLock(EFTU_TOM_Type *const pTOM)
{
    pTOM->TGC_SPEC_LOCK = 0xBEEFCAFEu;
}

LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetChannelConfiguration(EFTU_TOM_Type *const pTOM,
                                                           uint8                u8Channel,
                                                           uint32               u32RegValue)
{
...
LOCAL_INLINE void PWM_EFTU_TOM_HWA_ResetChannelConfiguration(EFTU_TOM_Type *const pTOM,
                                                             uint8                u8Channel,
                                                             uint32               u32RegValue)
{
    pTOM->Channel[u8Channel].CH_CTRL = u32RegValue;
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetChannelMode(EFTU_TOM_Type *const     pTOM,
                                                  uint8                    u8Channel,
                                                  EFTU_TOM_ChannelModeType eChannelMode)
{
 ...
 *
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetTomModeCtrl(EFTU_TOM_Type *const pTOM,
                                                  uint8                u8Channel,
                                                  uint8                u8TomModeCtrl)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 * update mode for
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableExtendUpdateMode(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableExtendUpdateMode(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL &= ~EFTU_TOM_CHn_CTRL_EUPM_MASK;
}
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetInitialSignalLevel(EFTU_TOM_Type *const pTOM,
                                                         uint8                u8Channel,
                                                         EFTU_TOM_SignalLevelType eInitialSignalLevel)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 *                      -> SOMB Mode: Reserved
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetClockSource(EFTU_TOM_Type *const pTOM,
                                                  uint8                u8Channel,
                                                  uint8                u8ClockSrc)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetTriggerPulse(EFTU_TOM_Type *const      pTOM,
                                                   uint8                     u8Channel,
                                                   EFTU_TOM_TriggerPulseType eTrigPulse)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetUpDownMode(EFTU_TOM_Type *const    pTOM,
                                                 uint8                   u8Channel,
                                                 EFTU_TOM_UpDownModeType eUpDownMode)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetCCU0ResetSource(EFTU_TOM_Type *const         pTOM,
                                                      uint8                        u8Channel,
                                                      EFTU_TOM_CCO0ResetSourceType eResetSource)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 *
 * This function enables the pre-channel to trigger OSM channel.
 * In this mode, the channel will generate a single pulse after a trigger event.
 *
 * @param pTOM Pointer to the base address of the EFTU TOM module
 * @param u8Channel The channel number to configure
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableOneShotPulseTrig(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL |= EFTU_TOM_CHn_CTRL_OSM_TRIG_MASK;
}

/**
 * @brief Enable trigger of one-shot pulse mode.
 *
 ...
 * @param u8Channel The channel number to configure
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableOneShotPulse(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL |= EFTU_TOM_CHn_CTRL_OSM_MASK;
}
 ...
 * @param u8Channel The channel number to configure
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableOneShotPulseTrig(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL &= ~EFTU_TOM_CHn_CTRL_OSM_TRIG_MASK;
}

/**
 * @brief Disable one-shot pulse by trigger mode.
 *
 * This function disables the one-shot pulse mode by setting the corresponding bit in the channel
 * control register.
 *
 * @param pTOM Pointer to the base address of the EFTU TOM module
 * @param u8Channel The channel number to configure
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableOneShotPulse(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL &= ~EFTU_TOM_CHn_CTRL_OSM_MASK;
}
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetTriggerOut(EFTU_TOM_Type *const          pTOM,
                                                 uint8                         u8Channel,
                                                 EFTU_TOM_TrigOutSelectionType eSelection)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableHRPWMMux(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 * @param u8Channel The channel number to operate on
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableHRPWMMux(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL &= ~EFTU_TOM_CHn_CTRL_HRPWM_MUX_MASK;
}
 ...
 * enabled
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableTrigInUseExt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 * enabled
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableTrigInUseExt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL &= ~EFTU_TOM_CHn_CTRL_TRIG_IN_USE_EXT_MASK;
}
 ...
 * enabled
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableTrigOutUseExt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 * enabled
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableTrigOutUseExt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_CTRL &= ~EFTU_TOM_CHn_CTRL_TRIG_OUT_USE_EXT_MASK;
}
 ...
 *                              1b - use external trigger to force update
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetExtForcedUpdate(EFTU_TOM_Type *const pTOM,
                                                      uint8                u8Channel,
...
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SelectTimeBaseValue(EFTU_TOM_Type *const          pTOM,
                                                       uint8                         u8Channel,
                                                       EFTU_TOM_TBValueSelectionType eTimeBaseSel)
{
    pTOM->Channel[u8Channel].CH_CTRL = (pTOM->Channel[u8Channel].CH_CTRL &
 ...
 * @param eInitialSignalLevel The initial signal level as an enumerated value
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetShadowInitialSignalLevel(
 ...
 *                      -> SOMB Mode: Reserved
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetShadowClockSource(EFTU_TOM_Type *const pTOM,
                                                        uint8                u8Channel,
                                                        uint8                u8ClockSrc)
{
    pTOM->Channel[u8Channel].CH_CTRL_SR = (pTOM->Channel[u8Channel].CH_CTRL_SR &
 ...
 * @param bSupport A boolean value indicating whether to enable HRPWM support. True to enable, False
 * to disable
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetHRPWMSupport(EFTU_TOM_Type *const pTOM,
                                                   uint8                u8Channel,
                                                   boolean              bSupport)
{
 ...
 */
LOCAL_INLINE uint8 PWM_EFTU_TOM_HWA_GetOutputLevel(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE uint8 PWM_EFTU_TOM_HWA_GetCcuMatch(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_GetCCU0Counter(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetCCU0Counter(EFTU_TOM_Type *const pTOM,
                                                  uint8                u8Channel,
                                                  uint32               u32Value)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetCCU0Compare(EFTU_TOM_Type *const pTOM,
                                                  uint8                u8Channel,
                                                  uint32               u32Value)
{
...
/**
 * @brief Get the CCU0 compare value
 *
 * @param pTOM Base address pointer of the EFTU TOM module, used to access the module's registers
 * @param u8Channel Channel number, indicating the channel for which the compare value needs to be set
 */
LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_GetCCU0Compare(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    return (uint32)(pTOM->Channel[u8Channel].CH_CM0 & EFTU_TOM_CHn_CM0_CM0_MASK);
}

/**
 * @brief Get the CCU1 compare value
 *
 * @param pTOM Base address pointer of the EFTU TOM module, used to access the module's registers
 * @param u8Channel Channel number, indicating the channel for which the compare value needs to be set
 */
LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_GetCCU1Compare(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    return (uint32)(pTOM->Channel[u8Channel].CH_CM1 & EFTU_TOM_CHn_CM1_CM1_MASK);
}
/**
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetShadowValue0(EFTU_TOM_Type *const pTOM,
                                                   uint8                u8Channel,
                                                   uint32               u32Value)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetCCU1Compare(EFTU_TOM_Type *const pTOM,
                                                  uint8                u8Channel,
                                                  uint32               u32Value)
{
 ...
 * behavior of the channel
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_SetShadowValue1(EFTU_TOM_Type *const pTOM,
                                                   uint8                u8Channel,
                                                   uint32               u32Value)
{
...
LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_ReadShadowValue0(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    return pTOM->Channel[u8Channel].CH_SR0;
}

LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_ReadShadowValue1(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE uint32 PWM_EFTU_TOM_HWA_GetInterruptFlag(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    return pTOM->Channel[u8Channel].CH_IRQ_ST;
}

LOCAL_INLINE void PWM_EFTU_TOM_HWA_ClearCCU0Flag(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_IRQ_ST &= EFTU_TOM_CHn_IRQ_ST_CCU0TC_MASK;
}

LOCAL_INLINE void PWM_EFTU_TOM_HWA_ClearCCU1Flag(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableCCU0Interrupt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_EnableCCU1Interrupt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableCCU0Interrupt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_IRQ_EN &= ~EFTU_TOM_CHn_IRQ_EN_CCU0TC_IRQ_EN_MASK;
}
 ...
 */
LOCAL_INLINE void PWM_EFTU_TOM_HWA_DisableCCU1Interrupt(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    pTOM->Channel[u8Channel].CH_IRQ_EN &= ~EFTU_TOM_CHn_IRQ_EN_CCU1TC_IRQ_EN_MASK;
}
 ...
 */
LOCAL_INLINE boolean PWM_EFTU_TOM_HWA_GetCCU0InterruptEnable(EFTU_TOM_Type *const pTOM,
                                                             uint8                u8Channel)
{
    uint32 u32TmpVal;
...
/**
 * @brief Get CCU0 Interrupt Flag
 *
 * This function checks if the CCU0 interrupt flag is set in the specified channel of the EFTU TOM
 * module.
 *
 * @param pTOM Pointer to the base address of the EFTU TOM module, used to access the TOM registers.
 * @param u8Channel The channel number to check, specifying the particular TOM channel.
 * @return boolean Returns the status of the CCU0 interrupt flag. If the flag is set, returns TRUE;
 * otherwise, returns FALSE.
 */
LOCAL_INLINE boolean PWM_EFTU_TOM_HWA_GetCCU0InterruptFlag(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    uint32 u32TmpVal;
 ...
 */
LOCAL_INLINE boolean PWM_EFTU_TOM_HWA_GetCCU1InterruptEnable(EFTU_TOM_Type *const pTOM,
                                                             uint8                u8Channel)
{
    uint32 u32TmpVal;
...
/**
 * @brief Get CCU1 Interrupt Flag
 *
 * This function checks if the CCU1 interrupt flag is set in the specified channel of the EFTU TOM
 * module.
 *
 * @param pTOM Pointer to the base address of the EFTU TOM module, used to access the TOM registers.
 * @param u8Channel The channel number to check, specifying the particular TOM channel.
 * @return boolean Returns the status of the CCU1 interrupt flag. If the flag is set, returns TRUE;
 * otherwise, returns FALSE.
 */
LOCAL_INLINE boolean PWM_EFTU_TOM_HWA_GetCCU1InterruptFlag(EFTU_TOM_Type *const pTOM, uint8 u8Channel)
{
    uint32 u32TmpVal;
...
#endif /* #ifndef Pwm_EFTU_TOM_REGOPS_H */
/** @} */
