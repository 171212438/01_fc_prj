...
*   0.9.0       05/12/2024    QXW0099       N/A          Adapt to FC7300GT
==================================================================================================*/
...
typedef struct {
  ...
  __I  uint32 HRS                           ; /* Hardware Request Status Register, offset: 0x34 */
       uint8  RESERVED_5[16];
  __IO uint32 DUME[DMA_DUME_COUNT]          ; /* DMA Unalign Modulo Enable Register n, array offset: 0x48, array step: 0x4 */
  ...
  __I  uint32 MON_ERR_STATUS                ; /* Monitor Error Status Register, offset: 0x1480 */
  __IO uint32 MON_FAKE_SRC_ADDR             ; /* Monitor Fake Source Address Register, offset: 0x1484 */
  __IO uint32 MON_FAKE_DST_ADDR             ; /* Monitor Fake Destination Address Register, offset: 0x1488 */
  __IO uint32 MON_CTRL                      ; /* Monitor Control Register, offset: 0x148C */
...
#define DMA_ES_GPE(x)                  (((uint32)(((uint32)(x))<<DMA_ES_GPE_SHIFT))&DMA_ES_GPE_MASK)
